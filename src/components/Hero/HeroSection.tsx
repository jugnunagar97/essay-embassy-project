        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 lg:pt-6">
            <div className="space-y-5">
              ...
              >
                Have a native essay writer do your task from scratch for a student-friendly price of just $12 per page. Free edits and originality reports.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full px-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-left flex items-center justify-between hover:border-gray-400 transition-colors"
                  >
                ...
                <div className="relative">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-3 pr-10 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white hover:border-gray-400 transition-colors"
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <button
                    ...
                    className="w-10 h-10 border-2 border-gray-300 rounded-xl flex items-center justify-center hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="flex-1 text-center">
                    <input
                      ...
                      className="w-full px-3 py-3 border border-gray-300 rounded-xl text-center focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white font-semibold text-lg hover:border-gray-400 transition-colors"
                      min="1"
                    />
                  ...
                  <button
                    ...
                    className="w-10 h-10 border-2 border-gray-300 rounded-xl flex items-center justify-center hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                  >
