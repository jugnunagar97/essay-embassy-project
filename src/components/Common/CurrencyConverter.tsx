  ...
  const getVariantStyles = () => {
    switch (variant) {
      case 'header':
        return {
          container: 'relative',
          button: 'flex items-center gap-2 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-white border border-white/20',
      ...
      case 'card':
        return {
          container: 'relative',
          button: 'flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors text-gray-700 border border-gray-200',
      ...
      case 'widget':
        return {
          container: 'relative',
          button: 'flex items-center gap-2 px-4 py-3 rounded-lg bg-primary-50 hover:bg-primary-100 transition-colors text-primary-700 border border-primary-200',
