...
const priceConfig: PriceConfig = {
  "High School": { "3 hours": { base: 15, urgent: 1.8 }, "6 hours": { base: 13, urgent: 1.6 }, "12 hours": { base: 12, urgent: 1.4 }, "24 hours": { base: 10, urgent: 1.2 }, "48 hours": { base: 10, urgent: 1.0 }, "3 days": { base: 10, urgent: 1.0 }, "5 days": { base: 10, urgent: 1.0 }, "7 days": { base: 10, urgent: 1.0 }, "10 days": { base: 10, urgent: 1.0 }, "14 days": { base: 10, urgent: 1.0 } },
  "Undergraduate": { "3 hours": { base: 20, urgent: 1.8 }, "6 hours": { base: 18, urgent: 1.6 }, "12 hours": { base: 15, urgent: 1.4 }, "24 hours": { base: 12, urgent: 1.2 }, "48 hours": { base: 12, urgent: 1.0 }, "3 days": { base: 12, urgent: 1.0 }, "5 days": { base: 12, urgent: 1.0 }, "7 days": { base: 12, urgent: 1.0 }, "10 days": { base: 12, urgent: 1.0 }, "14 days": { base: 12, urgent: 1.0 } },
  "Masters": { "3 hours": { base: 25, urgent: 1.8 }, "6 hours": { base: 22, urgent: 1.6 }, "12 hours": { base: 20, urgent: 1.4 }, "24 hours": { base: 16, urgent: 1.2 }, "48 hours": { base: 16, urgent: 1.0 }, "3 days": { base: 16, urgent: 1.0 }, "5 days": { base: 16, urgent: 1.0 }, "7 days": { base: 16, urgent: 1.0 }, "10 days": { base: 16, urgent: 1.0 }, "14 days": { base: 16, urgent: 1.0 } },
  "PhD": { "3 hours": { base: 32, urgent: 1.8 }, "6 hours": { base: 28, urgent: 1.6 }, "12 hours": { base: 25, urgent: 1.4 }, "24 hours": { base: 20, urgent: 1.2 }, "48 hours": { base: 20, urgent: 1.0 }, "3 days": { base: 20, urgent: 1.0 }, "5 days": { base: 20, urgent: 1.0 }, "7 days": { base: 20, urgent: 1.0 }, "10 days": { base: 20, urgent: 1.0 }, "14 days": { base: 20, urgent: 1.0 } }
};
