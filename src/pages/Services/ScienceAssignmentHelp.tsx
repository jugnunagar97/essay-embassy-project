...
const PriceCalculator = () => {
  ...
  const calculatePrice = () => {
    const base = baseRates[academicLevel] || 13.99;
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm">Expert science assignment help starting at just $10.99/page. Pricing updates in real time — zero hidden fees.</p>
      </div>
      <div className="space-y-6">
        ...
        <div className="bg-[#0B1F42]/5 rounded-2xl p-6 border border-[#0B1F42]/10">
          ...
          >
            Do My Science Assignment <ArrowRight className="w-5 h-5" />
          </Link>
          <div className="flex flex-wrap justify-center gap-3 mt-4 text-xs font-medium text-gray-600">
            ...
            <span className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#10B981]" /> Peer-Reviewed Citations</span>
          </div>
        </div>
      </div>
    </div>
...
const ScienceServicesGrid = () => {
  const services = [
    {
      emoji: '🍎',
      title: 'Physics Assignment Help',
      description: 'We make hard physics problems easy. If you need a physics assignment writing service, we are here. Get help with physics assignment topics like speed, heat, and light from a physics assignment expert.',
      features: ['Physics assignment expert help', 'Simple math steps', 'Force and motion', 'Energy and light'],
      cta: 'Get Physics Help',
      slug: '/assignment-help/science/physics',
      popular: true,
    },
    {
      emoji: '🧪',
      title: 'Chemistry Assignment Help',
      description: 'Stop asking, "Do my chemistry assignment." We offer chemistry assignment writing help for mixing liquids and learning about atoms. Our chemistry assignment solver makes science fun and clear.',
      features: ['Chemistry assignment solver', 'Do my chemistry assignment', 'Mixing chemicals', 'Atom structures'],
      cta: 'Get Chemistry Help',
      slug: '/assignment-help/science/chemistry',
      popular: false,
    },
    {
      emoji: '🧬',
      title: 'Biology Assignment Help',
      description: 'Our biology assignment writing service helps you learn about plants, animals, and the human body. Get help with biology assignment tasks and find the right biology assignment answers every time.',
      features: ['Biology assignment answers', 'Plant and animal life', 'Human body parts', 'Biology writing service'],
      cta: 'Get Biology Help',
      slug: '/assignment-help/science/biology',
      popular: false,
    },
    {
      emoji: '🔬',
      title: 'Organic Chemistry Help',
      description: 'Carbon science is tricky, but our organic chemistry assignment solver makes it simple. Get organic chemistry assignment help online for lab reports or just say, "Do my organic chemistry assignment."',
      features: ['Organic chemistry help online', 'Carbon and bonds', 'Lab report help', 'Easy-to-follow steps'],
      cta: 'Get Org-Chem Help',
      slug: '/assignment-help/science/organic-chemistry',
      popular: false,
    },
    {
      emoji: '⚗️',
      title: 'Biochemistry Help',
      description: 'Need a biochemistry assignment writing service? Talk to a biochemistry assignment expert who knows how life and chemistry work together. We provide fast help with biochemistry assignment questions.',
      features: ['Biochemistry assignment expert', 'DNA and proteins', 'Cell chemistry', 'Help with assignments'],
      cta: 'Get Biochem Help',
      slug: '/assignment-help/science/biochemistry',
      popular: false,
    },
    {
      emoji: '🌱',
      title: 'Environmental Science Help',
      description: 'Get environmental science assignment help online to learn about nature and the earth. If you want us to "Do my environmental science assignment," we can handle your environmental science assignment writing today.',
      features: ['Nature and earth help', 'Pollution and weather', 'Do my science assignment', 'Online writing help'],
      cta: 'Get Eco Help',
      slug: '/assignment-help/science/environmental',
      popular: false,
    },
    {
      emoji: '🪐',
      title: 'Astronomy Help',
      description: 'Look at the stars with our astronomy assignment writing service. Get help with astronomy assignment topics like planets and space. Work with an astronomy assignment expert to finish your work.',
      features: ['Astronomy assignment expert', 'Space and stars', 'Planet facts', 'Writing service help'],
      cta: 'Get Astronomy Help',
      slug: '/assignment-help/science/astronomy',
      popular: false,
    },
    {
      emoji: '🦠',
      title: 'Microbiology Help',
      description: 'Find microbiology assignment help online for tiny germs and cells. Tell us to "Do my microbiology assignment" and let our microbiology assignment solver explain how bacteria grow and change.',
      features: ['Microbiology solver', 'Germs and bacteria', 'Microscope studies', 'Help with online work'],
      cta: 'Get Micro-Bio Help',
      slug: '/assignment-help/science/microbiology',
      popular: false,
    },
    {
      emoji: '🧬',
      title: 'Genetics Help',
      description: 'Learn how DNA works with our genetics assignment writing service. Get help with genetics assignment tasks about family traits. A genetics assignment expert will guide you through the hard parts.',
      features: ['Genetics writing service', 'DNA and genes', 'Family traits', 'Expert science help'],
      cta: 'Get Genetics Help',
      slug: '/assignment-help/science/genetics',
      popular: false,
    },
    {
      emoji: '🧠',
      title: 'Neuroscience Help',
      description: 'Our neuroscience assignment help online explains how the brain works. Say "Do my neuroscience assignment" for clear neuroscience assignment writing about nerves, thoughts, and how we feel.',
      features: ['Neuroscience writing', 'Brain and nerves', 'How we think', 'Online assignment help'],
      cta: 'Get Brain Help',
      slug: '/assignment-help/science/neuroscience',
      popular: false,
    },
    {
      emoji: '🌍',
      title: 'Earth Science Help',
      description: 'Get earth science assignment help for rocks, weather, and the ground. If you need assignment help with earth science, we have every earth science assignment solved and ready for you to read.',
      features: ['Earth science solved', 'Rocks and soil', 'Weather patterns', 'Ground and water'],
      cta: 'Get Earth Help',
      slug: '/assignment-help/science/earth',
      popular: false,
    },
  ];
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function ScienceAssignmentHelp() {
  return (
    <>
      <Helmet>
        <title>Best Science Assignment Help for University Students</title>
        <meta name="description" content="Need science homework help? Pay someone to do science assignment tasks today. Hire the best science assignment writing service online for top grades." />
        <meta name="keywords" content="science assignment help, science homework help, do my science assignment, science assignment writing service, biology assignment help, chemistry assignment help, physics assignment help" />
      </Helmet>
      <div className="min-h-screen bg-white font-sans">
            ...
            <div className="max-w-5xl mx-auto text-center mb-10">
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  ...
                  <span className="text-sm font-bold text-gray-700">Plagiarism-Free Science Answers</span>
                </div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  <Microscope className="w-4 h-4 text-yellow-500" />
                  <span className="text-sm font-bold text-gray-700">Expert Scientists</span>
                </div>
              ...
              <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-[#0B1F42] mb-10 leading-[1.2] tracking-tight">
                Professional Science Assignment Help Online
              </h1>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                  Why Choose Our Science Assignment Help Service?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  We offer the best science assignment help for university students navigating complex research and lab work. Here is why students worldwide trust us to help them get better grades.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-gradient-to-br from-[#0B1F42] to-[#1652A0] p-10 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-3xl font-black mb-4">Plagiarism-Free Science Answers + Free Turnitin Report</h3>
                    <p className="text-gray-300 text-lg mb-6 leading-loose">
                      We offer strict guarantees for original work on every paper. You get <span className="text-white font-bold">custom papers built completely from scratch</span> using peer-reviewed scientific sources. Every order includes a <span className="text-white font-bold">free originality report</span> to prove your work is unique, safe to submit, and guarantees <span className="text-white font-bold">zero AI involvement</span> in your tasks.
                    </p>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      {[
                        ...
                        { icon: TestTube, color: 'text-yellow-300', title: 'Built From Scratch', sub: 'Peer-reviewed sources only' },
                    ...
                    <div className="bg-green-500 text-white px-6 py-3 rounded-xl inline-flex items-center gap-2 font-bold text-lg shadow-xl">
                      <Trophy className="w-6 h-6" /> Your Research, Perfectly Written
                    </div>
                  </div>
                </div>

                {/* Card 2 — Qualified Scientists */}
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-[#1652A0]">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Qualified Academic Scientists</h3>
                  <p className="text-gray-600 leading-loose mb-6">
                    We hire writers with advanced Master's and PhD degrees in subjects like biology, chemistry, and physics. They know exactly how to execute a proper scientific method application for your homework.
                  </p>
                  <ul className="space-y-3">
                    {['Master\'s & PhD scientists', 'Scientific method expertise', 'Biology, chemistry, physics', 'All science subjects covered'].map((item, i) => (
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-orange-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Need science assignment help right now? Our customer support team works around the clock. You can chat with your science assignment helper online directly to share ideas and ask questions at any stage.
                  </p>
                  <ul className="space-y-3">
                    {['24/7 customer support', 'Direct scientist chat', 'Share your rubric & notes', 'Instant responses'].map((item, i) => (
                      <li key={i} className="flex items-center text-gray-700 font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-red-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Your happiness is our main goal. We offer a free revision period so your paper turns out exactly as you want. We will keep refining every section until your results and conclusions are absolutely perfect.
                  </p>
                  <ul className="space-y-3">
                    {['Free revision window', 'Results & conclusions refined', 'Citations corrected freely', 'Zero additional costs'].map((item, i) => (
                      <li key={i} className="flex items-center text-gray-700 font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-indigo-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Your personal details are completely safe with us. We protect your academic data with strong encryption when you pay for science assignment help in Canada, the UK, the US, or anywhere else.
                  </p>
                  <ul className="space-y-3">
              ...
              <div className="mt-16 text-center">
                ...
                >
                  Get My Science Assignment Done Today <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                  Science Assignment Help & Other Academic Services We Offer
                </h2>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8]">
                  At EssayEmbassy, we specialize in providing top-quality university science assignment help. Science classes require you to understand many different topics and conduct deep research. When you find yourself thinking, "I need to pay someone to do science assignment tasks," we are here for you — offering the best science assignment help for university students worldwide.
                </p>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8] mt-4">
                  Whether you need science assignment help in the UK, Australia, Canada, or the US, our experts can assist. Our team handles everything from a complex scientific research project to simple worksheet questions — delivering accurate scientific formatting and reliable citations from peer-reviewed journals.
                </p>
              </div>
              <ScienceServicesGrid />
              <div className="mt-12 bg-gray-50 rounded-2xl p-10 text-center border border-gray-200">
                <h3 className="text-2xl font-bold text-[#0B1F42] mb-3">Ready to Get Top Grades on Your Science Assignment?</h3>
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Every solution is backed by peer-reviewed research, accurate scientific formatting, and reliable citations from trusted journals.
                </p>
                <Link
                  to="/order-now"
                ...
                >
                  Order Science Assignment Help Now <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  A streamlined four-step process designed to get your science assignment researched and submitted on time. Get started in minutes.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Upload your instructions and tell us your deadline. Provide your grading rubric and course notes. Let us know if you need help with science lab report writing or hypothesis testing and we will take it from there.',
                    highlight: 'Takes 2 minutes',
                    features: ['Secure upload form', 'Share your rubric', 'Set your deadline', 'Request lab report help'],
                  },
                  {
                    step: '2', icon: Users,
                    ...
                    desc: 'We match you with science homework helpers who understand your exact subject. Your writer will have the right academic background and subject-area expertise to help you succeed.',
                    highlight: 'Subject-matched scientist',
                    features: ['Expert scientist profiles', 'Subject-area match', 'Verified PhD credentials', 'Choose your expert'],
                  },
                  {
                    step: '3', icon: Microscope,
                    ...
                    desc: 'Stay in touch with your writer throughout the process. You can monitor the progress of your empirical data analysis and ask questions at any time to ensure the assignment meets your exact needs.',
                    highlight: 'Full transparency guaranteed',
                    features: ['24/7 access', 'Live tracking', 'Direct scientist chat', 'Ask questions anytime'],
                  },
                  {
                    step: '4', icon: Trophy,
                    ...
                    desc: 'Receive your completed task by the deadline. Download your finished files featuring accurate scientific formatting and reliable citations from peer-reviewed scientific journals, and submit with total confidence.',
                    highlight: 'On-time guarantee',
                    features: ['Instant download', 'Peer-reviewed citations', 'Free revisions', 'Submit with confidence'],
                  },
                ].map((item, i) => (
              ...
              <div className="text-center bg-[#0B1F42] rounded-2xl p-10">
                <h3 className="text-2xl font-bold text-white mb-3">Ready to Get Top Grades on Your Science Assignment?</h3>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Your expertly researched, submission-ready paper is just one step away.</p>
                <Link
                  to="/order-now"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
                    Affordable Science Assignment Help Pricing
                  </h2>
                  <p className="text-lg text-gray-600 mb-8 leading-loose">
                    Our rates start at just $10.99 per page. Pricing updates in real time with no surprises — making professional science homework help accessible for every student.
                  </p>
                  <div className="space-y-4">
                    {[
                      { icon: DollarSign, title: 'Starting at $10.99/page', desc: 'Transparent pricing with zero hidden costs.' },
                      { icon: FileCheck, title: 'No Hidden Fees', desc: 'Pay only for the text you need. Pricing updates in real time.' },
                      { icon: Award, title: 'Free Features Included', desc: 'Free formatting, referencing, and title pages with every order.' },
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-[1.8]">
                  Commitments we take seriously with every science assignment we write and deliver.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Our experts write perfectly structured papers. We make sure your lab results are completely accurate and your conclusions are backed by credible scientific evidence.',
                  },
                  {
                    icon: Clock,
                  ...
                  },
                  {
                    ...
                    description: 'We revise your paper for free until it matches your exact needs perfectly — methodology, results, citations, and formatting all adjusted.',
                  },
                  {
                    icon: Lock,
                    title: 'Privacy First',
              ...
              <div className="text-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-3">We Stand Behind Every Science Assignment We Deliver</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">Testimonials & Science Assignment Examples</h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  Authentic reviews from verified students who improved their grades with our science assignment help.
                </p>
              </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="space-y-4">
              <FAQItem
                question="How much does science assignment help cost?"
                answer="Our pricing starts at around $10.99 to $16.00 per page for high school and college levels. The final cost depends on your academic level, deadline, and length. Ordering early gets you the lowest price possible — use our live calculator above for an instant, transparent quote."
              />
              <FAQItem
                question="Who can do my science assignment fast?"
              ...
              />
              <FAQItem
                question="How do your experts write a science lab report?"
                answer="Our experts follow strict academic rules. They include a clear introduction, list all materials, explain the methodology, and present your results using clear charts. They finish with a strong discussion and conclusion section backed by reliable citations from peer-reviewed scientific journals."
              />
              <FAQItem
                question="Is it safe to get science homework help online?"
              ...
              />
              <FAQItem
                question="Can I get help with a university level science project?"
                answer="Absolutely. We provide excellent help for all college and university levels. Our native English experts have advanced degrees in biology, chemistry, physics, and related fields. They can easily tackle the most complex research projects and lab reports for higher education."
              />
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-loose">
                Stop stressing over your science coursework. Let our professional experts handle your research and calculations. Get reliable science homework help today.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
                ...
                >
                  Start Your Science Assignment Now <ArrowRight className="w-5 h-5" />
                </Link>
                <Link
                  to="/samples"
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                {[
                  { icon: ShieldCheck, text: 'Plagiarism-Free Science Answers' },
