  ...
  const services = [
    {
      ...
      description: 'Expert science assignments across biology, chemistry, physics, earth science, astronomy, and environmental science. Our PhD-qualified scientists handle everything from complex research projects to lab reports, hypothesis testing, and empirical data analysis.',
      features: ['Biology, chemistry, physics', 'Lab report writing', 'Hypothesis testing & empirical data analysis', 'Peer-reviewed citations from scientific journals'],
    ...
    },
    {
      ...
      description: 'Working, well-commented code across all major languages and frameworks — Python, Java, C++, JavaScript, SQL, R, and MATLAB. Built from scratch, fully tested.',
