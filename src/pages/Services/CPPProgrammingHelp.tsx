                    ...
                    <>
                      ...
                      <Helmet>
                        ...
                        <meta
                          ...
                          content="Professional C++ programming help. Expert tutors in C++ programming, data structures, and algorithms. Get help now."

                        />

                        <link rel="canonical" href="https://essayembassy.com/services/assignment-help/cpp-programming" />
      ...
      <section className="w-full bg-[#F7FAFC] py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex justify-center mt-2">
            <a
              href="/order-now"
              className="flex items-center px-12 py-4 rounded-full bg-primary-600 text-white text-lg font-bold shadow-md hover:bg-primary-700 hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2"
            >
              Create an order
            </a>
          </div>
        ...
        <div className="max-w-md mx-auto px-4 relative flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col items-center relative z-10">
            ...
            <div className="flex flex-col items-center text-center mb-3 animate-fade-in-up">
              ...
              <a href="/order-now" className="flex items-center px-5 py-2 rounded-full bg-primary-600 text-white text-sm font-medium shadow hover:bg-primary-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2 mb-1">Get started</a>
            </div>
            {/* Arrow */}
      ...
      <section className="w-full py-12 rounded-2xl border-t border-gray-100 shadow-sm" style={{background: '#F7FAFC'}}>
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-12 items-center md:items-start">
          ...
          <div className="flex-1 min-w-[320px] flex flex-col justify-center items-start mb-10 md:mb-0">
            ...
            <Link
              to="/writers"
              className="flex items-center bg-primary-600 hover:bg-primary-700 text-white font-semibold text-lg px-8 py-3 rounded-xl shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:ring-offset-2"
      ...
      <section className="pt-10 pb-0 bg-[#F7FAFC] w-full px-4 md:px-0">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-5xl mx-auto py-14">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <Link
              to="/order-now"
              className="flex items-center bg-emerald-500 hover:bg-emerald-600 text-white font-bold px-8 py-3 rounded-xl shadow-md transition-all duration-200 text-lg focus:outline-none focus:ring-2 focus:ring-emerald-300 focus:ring-offset-2 transform hover:scale-105 active:scale-95"
            >
              Place an order
            </Link>
          </div>
