...
// ==================================================================================
// === MAIN ADMISSION ESSAY PAGE COMPONENT ===
// ==================================================================================

const AdmissionEssay = () => {
  const { testimonials } = useTestimonials();
  
  const samples: Sample[] = [
    { title: 'Personal Statement for Computer Science at MIT', pages: 2, style: 'Common App', content: 'This personal statement narrates the applicant\'s journey from building their first computer to developing a passion for machine learning, connecting their personal projects to their future academic goals at MIT...', downloadUrl: '#' },
    { title: 'Statement of Purpose for Medical School Application', pages: 1, style: 'AMCAS', content: 'A compelling narrative detailing the applicant\'s motivations for pursuing a career in medicine, highlighting key clinical and research experiences that have shaped their commitment to patient care...', downloadUrl: '#' },
  ];
  const freebies = ['Personalized Brainstorming', 'Multiple Drafts', 'Expert Editing', 'Tone & Style Matching', 'Formatting for any App', 'Confidential Consultation'];
  const faqs = [
    { question: 'How do you know what admissions committees want?', answer: 'Our team includes former admissions officers and experienced educational consultants who have firsthand knowledge of what top universities are looking for in an applicant. We use this insight to help you craft a compelling and authentic narrative.' },
    { question: 'Is this confidential?', answer: 'Absolutely. Your story, personal details, and order information are 100% confidential. We operate with the utmost discretion to protect your privacy throughout the entire process.' },
    { question: 'Can you help me if I don\'t know what to write about?', answer: 'Yes. Many students start in this position. Our process begins with a brainstorming session where we help you uncover unique experiences and qualities that will make your application stand out. We guide you in finding your story.' },
  ];
    ...
    <div className="animate-fade-in bg-white dark:bg-secondary-900">
      ...
      <section className="bg-secondary-50 dark:bg-secondary-900 py-20">
        <div className="container mx-auto px-6 text-center">
          <span className="font-semibold text-primary-600 dark:text-primary-400">Admission Essay Service</span>
          <h1 className="text-4xl md:text-5xl font-extrabold text-secondary-900 dark:text-white my-4">Tell Your Story. Get Admitted.</h1>
          <p className="text-lg text-secondary-600 dark:text-secondary-300 max-w-2xl mx-auto">Craft a compelling personal statement or admission essay that captures your unique voice and impresses admissions committees.</p>
          <div className="flex justify-center items-center flex-wrap gap-x-6 gap-y-2 my-8 text-sm text-secondary-500 dark:text-secondary-400">
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />Former Admissions Officers</span>
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />Unique Story Crafting</span>
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />100% Confidential</span>
          </div>
          <Link to="/order-now" className="btn-primary text-lg px-8 py-3 shadow-soft hover:shadow-medium transition-shadow">Start Your Application Essay</Link>
        </div>
      </section>

      <section className="section container">
        <h2 className="heading-lg text-center mb-8">Your Admission Essay is Your Voice</h2>
        <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto text-secondary-600 dark:text-secondary-300">
          <p>Your grades and test scores tell part of your story, but your admission essay is where you truly come to life. It's your opportunity to speak directly to the admissions committee, share your passions, and explain why you are the perfect fit for their institution. At Essay Embassy, we specialize in helping you find and refine that voice. Our experts don't just write essays; they work with you to craft a narrative that is authentic, compelling, and memorable. We help you transform your experiences into a powerful story that will set you apart from thousands of other applicants.</p>
        </div>
      </section>
      
      <section className="section bg-secondary-50 dark:bg-secondary-900">
        <div className="container text-center">
          <h2 className="heading-lg mb-8">Our Admission-Winning Services</h2>
      ...
      <section className="section container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Real feedback from students we helped get into their dream schools.
          </p>
        </div>
      ...
      <section className="section bg-secondary-50 dark:bg-secondary-900">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="heading-lg">Admission Essay Samples</h2>
            <p className="text-lg text-muted mt-4">See how we transform ideas into powerful personal statements.</p>
          </div>
      ...
      <section className="section container">
        <div className="grid lg:grid-cols-3 gap-16 items-start">
          <div className="lg:col-span-1 space-y-4 bg-secondary-50 dark:bg-secondary-800 p-8 rounded-lg shadow-soft">
            <h2 className="heading-md">Ask Our Admission Experts</h2>
            <p className="text-muted">Have a question about your application? Our team is here to provide answers.</p>
