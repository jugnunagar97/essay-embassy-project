...
const sampleCards = [
  ...
  {
    title: "Climate Change and Economic Development",
    pages: 15,
    level: "PhD",
    type: "Research Paper",
    citation: "Chicago"
  ...
  {
    title: "Renewable Energy: A Literature Review",
    pages: 8,
    level: "College",
...
export default function ResearchPaperWriting() {
  ...
  const faqData = [
    {
      question: 'What types of research papers do you help with?',
      answer: 'We assist with all types of research papers including empirical studies, literature reviews, systematic reviews, case studies, and comparative analyses across all academic disciplines.'
    },
    {
      question: 'How do you ensure proper research methodology?',
      answer: 'Our research paper experts are trained in various research methodologies including quantitative, qualitative, and mixed-methods approaches. They follow rigorous academic standards for data collection, analysis, and presentation.'
    },
    {
      question: 'Do you help with literature reviews and citations?',
      answer: 'Yes, we provide comprehensive literature review services and ensure proper citation formatting in APA, MLA, Chicago, Harvard, and other required academic styles with accurate reference lists.'
    },
  ];
        ...
        <main className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600">
              Get expert research paper writing help from PhD-qualified researchers. We handle literature reviews, data analysis, methodology, and academic formatting across all disciplines.
            </p>
            {/* Ratings */}
      ...
      <section className="container mx-auto px-6 py-6 md:py-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Meet the Research Experts Behind Your Success
          </h2>
          <p className="text-gray-500 text-base">
            Our research paper writers are PhD-qualified researchers with extensive experience in academic writing, data analysis, and research methodology across various fields of study.
          </p>
        </div>
      ...
      <section className="w-full bg-[#F7FAFC] py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-light tracking-wider text-center mb-20 animate-fade-in-up">
            We go beyond <span className="bg-gradient-to-r from-primary-500 via-blue-400 to-primary-600 bg-clip-text text-transparent animate-gradient-x font-semibold">research paper writing services</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-3 py-4 transition-all duration-300 animate-fade-in-up hover:scale-105 hover:shadow-xl">
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Expert research methodology</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Our researchers apply rigorous methodology including proper data collection, analysis techniques, and academic research standards.</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Comprehensive literature reviews</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">We conduct thorough literature reviews using peer-reviewed sources and academic databases to support your research arguments.</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Proper academic formatting</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">All research papers are formatted according to your required academic style (APA, MLA, Chicago, Harvard) with accurate citations.</div>
            </div>
            {/* Divider */}
