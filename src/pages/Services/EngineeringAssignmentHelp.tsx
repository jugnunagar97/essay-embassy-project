  ...
  const services = [
    {
      ...
      description: 'Expert engineering homework across civil, mechanical, electrical, chemical, aerospace, and industrial disciplines. Our degree-holding tutors handle everything from technical report writing and CAD software assignments to engineering design problems, system modeling, and simulation tasks.',
      features: ['Civil, mechanical, electrical & more', 'AutoCAD, SolidWorks & MATLAB support', 'Technical report writing', 'Engineering schematics & diagrams'],
    ...
    },
    {
      ...
      description: 'Working, well-commented code across all major languages — Python, Java, C++, JavaScript, SQL, R, and MATLAB. Built from scratch, fully tested.',
    ...
    },
    {
      ...
      features: ['Biology, chemistry, physics', 'Lab report writing', 'Hypothesis testing & empirical analysis', 'Peer-reviewed citations'],
