/**
 * Australia assignment help hub (single-file page).
 * Copy, schema, and UI cues are localised for Australian students (AUD, Australian English, universities & TAFE pathways).
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-xl border border-gray-100 ${compact ? 'p-6 lg:p-5' : 'p-8'}`}>
      <div className={`text-center ${compact ? 'mb-6' : 'mb-8'}`}>
        ...
        <p className="text-gray-600 text-sm">From AUD $15 per page. Clear estimate, no hidden fees.</p>
      </div>
      ...
      <div className={compact ? 'space-y-5' : 'space-y-6'}>
        <div>
          ...
          >
            <option value="highschool">ATAR / HSC / VCE / IB (or equivalent)</option>
        ...
        <div className={`bg-[#0B1F42]/5 rounded-2xl ${compact ? 'p-4' : 'p-6'} border border-[#0B1F42]/10`}>
          <div className={`flex justify-between items-center ${compact ? 'mb-4' : 'mb-6'}`}>
            <div>
              ...
              <p className={`${compact ? 'text-3xl' : 'text-4xl'} font-black text-[#0B1F42]`}>AUD ${totalPrice}</p>
            </div>
            <div className="text-right bg-white rounded-lg px-3 py-2 border border-[#0B1F42]/10">
              ...
              <p className={`${compact ? 'text-lg' : 'text-xl'} font-bold text-gray-900`}>AUD ${perPage}</p>
            </div>
          </div>
              ...
              <div className="flex min-w-0 items-center space-x-2">
                ...
                <div className="flex min-w-0 flex-col">
                  <div className="text-[13px] md:text-[14px]">
                    ...
                    >
                      &lt;hannah.k@student.unimelb.edu.au&gt;
                    </span>
                  </div>
          ...
          <div className="mb-[4px] space-y-3 border-b border-gray-100 pb-3">
            ...
            <div className="flex min-w-0 items-center gap-[6px]">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[12px] font-semibold tracking-[-0.3px] text-gray-500">Melbourne, VIC</div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <motion.div variants={fadeUp} className="grid grid-cols-2 gap-[10px] md:grid-cols-4">
            {[
              { num: '100%', label: 'English-first writers with Australian university experience' },
...
function AusAssignmentFinalCtaSection() {
  return (
    <div className="w-full bg-white pb-[28px]">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <motion.p variants={itemVariants} className="mb-[32px] max-w-[420px] text-[15px] leading-[1.6] text-slate-200">
            Join <strong className="font-semibold text-white">students across Australia</strong> who trust Essay Embassy for
      ...
      <RegionalAssignmentInterlink currentRegion="aus" />
    </div>
  );
}
...
const trustPoints = ['Turnitin® ready', 'APA / Harvard / AGLC', '24/7 AEST-friendly support'];
...
const services = [
  {
    ...
    icon: FileText,
    desc:
      'Custom essay writing — Essays and assessment briefs anchor most Australian bachelor and postgraduate coursework. Whether you need a critical humanities essay or a concise report, our writers deliver clear structure, discipline-appropriate analysis, and referencing that matches your subject guide and rubric. Every section is written from scratch against your learning outcomes and marking criteria.',
  },
  {
    title: 'Assignment Help',
    icon: PenTool,
    desc:
      'Online assignment help — Tight deadlines on Canvas, Moodle, Blackboard, or Turnitin submissions? We cover 400+ disciplines, from Nursing and Law to Engineering and Business, with a 98.2% on-time delivery rate so your work lands before the cut-off, even when the brief is complex or data-heavy.',
  },
  {
    title: 'Research Paper Help',
    icon: Search,
    desc:
      'Research paper support — Literature reviews, methodology chapters, and evidence-based arguments need credible sources and clean synthesis. Our subject experts gather peer-reviewed material, apply your required style (APA 7th, Harvard, AGLC, Vancouver, Chicago, etc.), and produce original, fully cited model papers you can learn from.',
  },
  {
    title: 'Thesis Writing',
    icon: GraduationCap,
    desc:
      'Honours & masters thesis writing — Many Australian postgraduate pathways culminate in a substantial thesis or capstone project. We help with structure, argument flow, ethics-committee-ready wording (where applicable), and chapter-by-chapter drafting so your core research is presented to the standard your examiners expect.',
  },
  {
    title: 'Dissertation Writing',
    icon: ScrollText,
    desc:
      'Complete dissertation support — Your doctoral thesis is the largest single assessment many students undertake. Our PhD-qualified experts help with proposals, chapters, analysis, and discussion, producing original, fully referenced drafts you can refine ahead of submission and your defence.',
  },
];
...
const whyUsFeatures = [
  {
    ...
    desc:
      'Australian universities and TAFE pathways are strict on structure, word limits, and referencing. Whether your course requires APA 7th, Harvard, AGLC, Vancouver, or Chicago, we follow your syllabus and brief so you do not lose marks on presentation or citation detail.',
  },
  {
    icon: Award,
    title: 'Original work for strong results',
    desc:
      'No one wants similarity flags or recycled paragraphs. Each order is researched and written from scratch, checked for originality, and aligned to Australian assessment expectations so you receive a clean model answer you can adapt responsibly.',
  },
  {
    icon: Clock,
    title: 'Deadline-first delivery',
    desc:
      'Late penalties add up fast. From standard weekly deadlines to last-minute submissions, our team works across Australian time zones (AEST/AEDT, AWST, ACST/ACDT) and global hours so your completed draft reaches you with time to review before you upload to Turnitin or your LMS.',
  },
  {
    icon: Users,
    title: 'Writers who understand Australian HE',
    desc:
      'We match you with fluent English writers experienced in Australian undergraduate and postgraduate conventions — from first-year reports to honours thesis chapters — so tone, structure, and referencing feel native to your programme.',
  },
  {
    icon: BookOpen,
...
const howItWorksSteps = [
  ...
  },
  {
    ...
    desc: 'We pair you with a graduate-qualified writer in your subject area — many with experience at Group of Eight universities and other leading Australian institutions.',
  },
  {
    number: '03',
    icon: FileCheck,
    ...
    <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <h3 className="mt-4 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            We Cover Every Subject <br className="hidden sm:block" /> Australian students ask us for
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            Our network of 500+ graduate writers spans major Australian faculties and research areas, so you get specialist depth on
            niche courses as well as mainstream programmes.
          </p>
        </motion.div>
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-sm font-medium text-slate-400">
          All subjects follow{' '}
          <span className="font-bold italic text-[#0B1F42]">Australian academic writing conventions</span>
        </p>
      </div>
    </div>
  </section>
...
const AcademicFootprintSection = () => (
  <section className="relative overflow-x-hidden bg-gradient-to-b from-white via-slate-50/80 to-slate-50 py-16 sm:py-24">
    ...
    <div className="relative mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mb-10 text-center sm:mb-12">
        ...
        >
          <div className="mx-auto mb-4 inline-flex items-center gap-2 rounded-full border border-slate-200/80 bg-white px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-slate-500 shadow-sm">
            ...
            Coast-to-coast Australia reach
          </div>
          ...
          <h3 className="mt-3 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            Helping Students From <br className="hidden sm:block" /> Leading Australian Universities &amp; Institutions
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
      ...
      >
        Trusted by students at <span className="text-[#0B1F42]">Group of Eight &amp; major research universities</span>
      </motion.p>
    </div>
  </section>
);
    ...
    <div className="relative z-10 mx-auto min-w-0 max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            We don&apos;t just write; we architect papers that aim for the criteria behind a Distinction or High Distinction at
          ...
          <div className="relative col-span-1 min-w-0 bg-slate-100 p-6 sm:p-10 lg:col-span-7">
            ...
            >
              <div className="flex h-full w-full flex-col items-center justify-center rounded-full border-2 border-[#D4A853] text-[#0B1F42]">
                ...
                <span className="text-3xl font-black sm:text-4xl">HD</span>
          ...
          <div className="col-span-1 flex min-w-0 flex-col justify-center p-8 sm:p-12 lg:col-span-5 lg:border-l lg:border-slate-100">
            ...
            <div className="mb-8 space-y-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <p className="min-w-0 text-sm text-slate-600">
                  <span className="font-bold text-[#0B1F42]">Format:</span> APA 7th (Australian university layout; title page &amp; references per your brief).
                </p>
              </div>
              <div className="flex min-w-0 items-start gap-3">
                <CheckCircle className="mt-1 h-5 w-5 shrink-0 text-[#D4A853]" />
            ...
            <div className="mb-8 rounded-2xl bg-slate-50 p-5 italic ring-1 ring-slate-100">
              ...
              <p className="mt-3 text-xs font-black uppercase tracking-widest text-slate-400 not-italic">
                — Course instructor, University of Melbourne
              </p>
            </div>
  ...
  <section className="relative overflow-hidden bg-slate-50 py-16 sm:py-24 lg:py-32">
    <div className="pointer-events-none absolute left-1/2 top-0 h-full w-full -translate-x-1/2 opacity-[0.03]">
      <svg width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
        <pattern id="aus-assignment-help-dots" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="2" fill="#0B1F42" />
        </pattern>
        <rect width="100%" height="100%" fill="url(#aus-assignment-help-dots)" />
      </svg>
    </div>
...
const AusHeroBackdrop = () => (
  <motion.div className="pointer-events-none absolute inset-0 overflow-hidden opacity-25">
    <svg className="absolute h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden>
      <defs>
        <linearGradient id="ausHeroWaveGrad" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default function AusAssignmentHelp() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-white font-sans text-slate-900">
      <Helmet htmlAttributes={{ lang: 'en-AU' }}>
        <title>Australia Assignment Help | University &amp; Postgrad Support in AUD</title>
        <meta
          name="description"
          content="Australia assignment help from AUD $15 per page. Australian English, APA/Harvard/AGLC, Turnitin-ready model essays, coursework, and dissertation support for Australian students."
        />
      </Helmet>
            ...
            >
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 backdrop-blur-md sm:mb-6 sm:px-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.15em] text-white sm:text-xs sm:tracking-[0.2em]">
                  Australian students · Australian English · AUD pricing
                </span>
              </div>
              ...
              <h1 className="mb-5 max-w-4xl text-[1.65rem] font-black leading-[1.12] tracking-tight text-white sm:mb-6 sm:text-4xl md:text-5xl lg:text-[3.25rem] lg:leading-[1.08] xl:text-6xl">
                Trusted Australia assignment help for university &amp; postgraduate students
              </h1>
              <p className="mx-auto mb-7 max-w-xl text-[15px] leading-relaxed text-slate-300 sm:mb-8 sm:text-lg lg:mx-0 lg:text-xl">
                Falling behind on deadlines or a tough course brief? If you are searching for{' '}
                <strong className="font-semibold text-white">assignment help Australia</strong> with clear{' '}
                <strong className="font-semibold text-white">AUD</strong> pricing, our writers deliver
                original, properly referenced model work from <strong className="font-semibold text-white">$15 per page</strong> so you can plan your time and budget with confidence.
              </p>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center sm:mb-14">
            ...
            <h3 className="mt-3 text-2xl font-black leading-tight tracking-tight text-[#0B1F42] sm:text-4xl md:text-5xl">
              Australian assignment writing across every major discipline
            </h3>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-600 sm:text-base">
              Tailored to Australian university and TAFE expectations — clear structure, critical analysis, and referencing that matches
              your subject outline. From short essays and LMS submissions to dissertations, our writers deliver structured model
              ...
              <div className="relative z-10 min-h-0 min-w-0 overflow-hidden rounded-2xl border-8 border-slate-50 bg-slate-100 shadow-xl sm:rounded-3xl sm:border-10 sm:shadow-2xl lg:rounded-[3rem] lg:border-[12px]">
                ...
                >
                  <img
                    ...
                    alt="Sample assignment graphic: clinical psychology case study on telehealth and rural mental health, HD-grade 85%, APA 7 layout, 15+ peer-reviewed sources, SPSS analysis, and course instructor review quote."
            ...
            <div className="order-1 flex min-w-0 flex-col lg:order-2">
              ...
              >
                ...
                <h3 className="text-2xl font-black tracking-tight text-[#0B1F42] sm:text-3xl md:text-4xl lg:text-[2.5rem] lg:leading-tight">
                  Why students choose Essay Embassy for Australia assignment help
                </h3>
