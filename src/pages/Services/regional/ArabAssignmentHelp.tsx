/**
 * UAE & Saudi Arabia (Arab Gulf) assignment help hub (single-file page).
 * Copy and UI cues target English-medium students in the Emirates and Kingdom — plus broader GCC contexts — with USD pricing that maps cleanly to AED/SAR checkouts.
    ...
    <div className={`bg-white rounded-2xl shadow-xl border border-gray-100 ${compact ? 'p-6 lg:p-5' : 'p-8'}`}>
      <div className={`text-center ${compact ? 'mb-6' : 'mb-8'}`}>
        ...
        <p className="text-gray-600 text-sm">
          From USD $15 per page (UAE · Saudi Arabia · GCC). Pay securely in USD; AED/SAR options at checkout.
        </p>
      </div>
      ...
      <div className={compact ? 'space-y-5' : 'space-y-6'}>
        <div>
          ...
          >
            <option value="highschool">Secondary / IB / American diploma · UAE MOE &amp; KSA pathways (or equivalent)</option>
        ...
        <div className={`bg-[#0B1F42]/5 rounded-2xl ${compact ? 'p-4' : 'p-6'} border border-[#0B1F42]/10`}>
          <div className={`flex justify-between items-center ${compact ? 'mb-4' : 'mb-6'}`}>
            <div>
              ...
              <p className={`${compact ? 'text-3xl' : 'text-4xl'} font-black text-[#0B1F42]`}>USD ${totalPrice}</p>
            </div>
            <div className="text-right bg-white rounded-lg px-3 py-2 border border-[#0B1F42]/10">
              ...
              <p className={`${compact ? 'text-lg' : 'text-xl'} font-bold text-gray-900`}>USD ${perPage}</p>
            </div>
          </div>
      ...
      <div className="mx-auto grid min-w-0 max-w-5xl auto-rows-max grid-cols-1 items-start gap-4 md:grid-cols-[repeat(3,minmax(0,1fr))] md:gap-[15px]">
        ...
        >
          ...
          <div className="absolute bottom-4 flex w-[calc(100%-48px)] items-center justify-between text-[13px] font-semibold text-[#6c6c85]">
            <span className="font-bold text-[#1a1a1a]">Layla M. 🇦🇪</span>
          ...
          <div className="mb-[4px] space-y-3 border-b border-gray-100 pb-3">
            ...
            <div className="flex min-w-0 items-center gap-[6px]">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[12px] font-semibold tracking-[-0.3px] text-gray-500">Dubai, UAE</div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <motion.div variants={fadeUp} className="grid grid-cols-2 gap-[10px] md:grid-cols-4">
            {[
              { num: '100%', label: 'English-first writers with UAE, Saudi & GCC university experience' },
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-1 gap-[12px] md:grid-cols-2">
            <div className="flex flex-col items-start rounded-xl border-[0.5px] border-gray-200 bg-white p-[18px]">
              ...
              <p className="mb-5 text-[13px] leading-[1.6] text-gray-500">
                ...
                strict adherence to APA 7th, MLA, Chicago, or Harvard as required, your brief is our blueprint.
              </p>
...
function ArabAssignmentFinalCtaSection() {
  return (
    <div className="w-full bg-white pb-[28px]">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <motion.p variants={itemVariants} className="mb-[32px] max-w-[420px] text-[15px] leading-[1.6] text-slate-200">
            Join <strong className="font-semibold text-white">students across the UAE &amp; Saudi Arabia</strong> who trust Essay Embassy for
      ...
      <RegionalAssignmentInterlink currentRegion="arab" />
    </div>
  );
}
...
const trustPoints = ['Turnitin® ready', 'APA / Harvard / IEEE', 'GCC timezone-friendly support'];
...
const services = [
  {
    ...
    icon: FileText,
    desc:
      'Custom essay writing — English-medium bachelor and postgraduate courses in the UAE and Saudi Arabia still expect tight argumentation, rubric alignment, and clean citations. Whether you are at a federal university, a private institution, or an international branch campus, our writers produce structured model essays you can learn from — written to your brief, learning outcomes, and marking guide.',
  },
  {
    title: 'Assignment Help',
    icon: PenTool,
    desc:
      'Online assignment help — Racing a deadline on Blackboard, Moodle, Canvas, or a Turnitin dropbox? We cover 400+ disciplines — Business, Engineering, Health Sciences, CS, Law, and more — with a 98.2% on-time delivery track record so drafts reach you before the portal closes, even when data analysis or appendices are involved.',
  },
  {
    title: 'Research Paper Help',
    icon: Search,
    desc:
      'Research paper support — Literature reviews, methods sections, and evidence-led discussion need credible sources and disciplined synthesis. Our specialists gather peer-reviewed material and format to your required style (APA 7th, Harvard, IEEE, Vancouver, Chicago, etc.), delivering fully referenced model papers aligned to Gulf English-medium conventions.',
  },
  {
    title: 'Thesis Writing',
    icon: GraduationCap,
    desc:
      'Honours & masters thesis writing — Capstones and thesis semesters are high stakes whether you study in Abu Dhabi, Dubai, Riyadh, Jeddah, or Dhahran. We assist with chapter scaffolding, coherent literature synthesis, ethics-ready wording where relevant, and supervisor-feedback revisions so each instalment reads credible and submission-ready.',
  },
  {
    title: 'Dissertation Writing',
    icon: ScrollText,
    desc:
      'Complete dissertation support — Doctoral milestones demand originality and methodological clarity. Our PhD-level bench supports proposals, results chapters, and discussion threads with meticulous citation hygiene — drafts you refine ahead of committee reviews or defense milestones.',
  },
];
...
const whyUsFeatures = [
  {
    ...
    desc:
      'Gulf English-medium programmes are exacting on structure, rubric language, and referencing. Whether your college insists on APA 7th, Harvard, IEEE, Vancouver, or Chicago, we mirror your handbook so you do not forfeit marks on layout or citation micro-details.',
  },
  {
    icon: Award,
    title: 'Original work for strong results',
    desc:
      'Similarity hits can derail a semester. Each brief is researched and drafted from scratch, checked for originality, and tuned to assessment expectations common across UAE and Saudi institutions so you receive a transparent model answer to study from responsibly.',
  },
  {
    icon: Clock,
    title: 'Deadline-first delivery',
    desc:
      'Late portal uploads are costly. From routine weekly tasks to tight deadlines across Abu Dhabi, Dubai, Riyadh, Jeddah, and Dammam, our operations team sequences writers with Arabian Peninsula–friendly coverage plus round-the-clock global backup so finished drafts reach your inbox with review time to spare.',
  },
  {
    icon: Users,
    title: 'Writers who understand Gulf campuses',
    desc:
      'We match you with fluent academic English specialists familiar with transnational curricula — STEM-heavy Saudi programmes, UAE honours streams, and diverse postgraduate majors — so tone, evidence use, and formatting feel aligned with your classroom.',
  },
  {
    icon: BookOpen,
    title: 'Support across 400+ subjects',
    desc:
      'From tutorial prep to your final-year capstone, one team can cover essays, reports, reflective pieces, and technical write-ups across more than 400 subject areas.',
  },
];
...
const howItWorksSteps = [
  ...
  },
  {
    ...
    desc: 'We pair you with a graduate-qualified writer in your subject area — many with experience at ranked UAE universities, Saudi research universities, and flagship GCC institutions.',
  },
  {
    number: '03',
    icon: FileCheck,
    ...
    <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <h3 className="mt-4 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            We Cover Every Subject <br className="hidden sm:block" /> UAE &amp; Saudi students ask us for
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            Our network of 500+ graduate writers spans STEM, business, health, law, and humanities faculties common across the Emirates and Kingdom, so niche major courses stay as comfortable as mainstream programmes.
          </p>
        </motion.div>
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-sm font-medium text-slate-400">
          All subjects follow{' '}
          <span className="font-bold italic text-[#0B1F42]">English-medium Gulf academic conventions</span>
        </p>
      </div>
    </div>
  </section>
...
const AcademicFootprintSection = () => (
  <section className="relative overflow-x-hidden bg-gradient-to-b from-white via-slate-50/80 to-slate-50 py-16 sm:py-24">
    ...
    <div className="relative mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mb-10 text-center sm:mb-12">
        ...
        >
          ...
          <h3 className="mt-3 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            Helping Students From <br className="hidden sm:block" /> Leading UAE &amp; Saudi Universities
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
      ...
      >
        Trusted by students at <span className="text-[#0B1F42]">flagship UAE &amp; Saudi research universities</span>
      </motion.p>
    </div>
  </section>
);
    ...
    <div className="relative z-10 mx-auto min-w-0 max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            We don&apos;t just write; we architect papers calibrated to the grading bands English-medium Gulf faculties expect — from solid B ranges through Distinction-level criteria at competitive programmes.
          </p>
        </motion.div>
      </div>
          ...
          <div className="col-span-1 flex min-w-0 flex-col justify-center p-8 sm:p-12 lg:col-span-5 lg:border-l lg:border-slate-100">
            ...
            <div className="mb-8 space-y-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <p className="min-w-0 text-sm text-slate-600">
                  <span className="font-bold text-[#0B1F42]">Format:</span> APA 7th (English-medium Gulf university layout; title page &amp; references per your brief).
                </p>
              </div>
              <div className="flex min-w-0 items-start gap-3">
                <CheckCircle className="mt-1 h-5 w-5 shrink-0 text-[#D4A853]" />
            ...
            <div className="mb-8 rounded-2xl bg-slate-50 p-5 italic ring-1 ring-slate-100">
              ...
              <p className="mt-3 text-xs font-black uppercase tracking-widest text-slate-400 not-italic">
                — Course instructor, American University of Sharjah
              </p>
            </div>
  ...
  <section className="relative overflow-hidden bg-slate-50 py-16 sm:py-24 lg:py-32">
    <div className="pointer-events-none absolute left-1/2 top-0 h-full w-full -translate-x-1/2 opacity-[0.03]">
      <svg width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
        <pattern id="arab-assignment-help-dots" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="2" fill="#0B1F42" />
        </pattern>
        <rect width="100%" height="100%" fill="url(#arab-assignment-help-dots)" />
      </svg>
    </div>
...
const ArabHeroBackdrop = () => (
  <motion.div className="pointer-events-none absolute inset-0 overflow-hidden opacity-25">
    <svg className="absolute h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden>
      <defs>
        <linearGradient id="arabHeroWaveGrad" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default function ArabAssignmentHelp() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-white font-sans text-slate-900">
      <Helmet htmlAttributes={{ lang: 'en' }}>
        <title>UAE &amp; Saudi Arabia Assignment Help | Gulf English-Medium Universities</title>
        <meta
          name="description"
          content="Assignment help for UAE and Saudi Arabia English-medium students from USD $15 per page. Turnitin-ready model essays, coursework, and postgraduate support tuned to Dubai, Abu Dhabi, Riyadh, and GCC campuses."
        />
      </Helmet>
            ...
            >
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 backdrop-blur-md sm:mb-6 sm:px-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.15em] text-white sm:text-xs sm:tracking-[0.2em]">
                  UAE · Saudi Arabia · GCC · USD pricing
                </span>
              </div>
              ...
              <h1 className="mb-5 max-w-4xl text-[1.65rem] font-black leading-[1.12] tracking-tight text-white sm:mb-6 sm:text-4xl md:text-5xl lg:text-[3.25rem] lg:leading-[1.08] xl:text-6xl">
                Trusted assignment help for UAE &amp; Saudi Arabia university students
              </h1>
              <p className="mx-auto mb-7 max-w-xl text-[15px] leading-relaxed text-slate-300 sm:mb-8 sm:text-lg lg:mx-0 lg:text-xl">
                Overwhelmed by portal deadlines or dense rubrics? If you need{' '}
                <strong className="font-semibold text-white">assignment help UAE</strong> or{' '}
                <strong className="font-semibold text-white">assignment help Saudi Arabia</strong> with transparent{' '}
                <strong className="font-semibold text-white">USD</strong> pricing, our writers deliver original, properly referenced model work from{' '}
                <strong className="font-semibold text-white">$15 per page</strong> — ideal for English-medium programmes across Dubai, Abu Dhabi, Riyadh, Jeddah, and neighbouring GCC cities.
              </p>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center sm:mb-14">
            ...
            <h3 className="mt-3 text-2xl font-black leading-tight tracking-tight text-[#0B1F42] sm:text-4xl md:text-5xl">
              Gulf assignment writing across every major discipline
            </h3>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-600 sm:text-base">
              Tailored to English-medium expectations in the Emirates and Kingdom — clear argumentation, analytical depth, and citations that mirror your programme handbook. From weekly LMS tasks to capstones and dissertations, we deliver structured model answers spanning 400+ subjects.
            </p>
              ...
              <div className="relative z-10 min-h-0 min-w-0 overflow-hidden rounded-2xl border-8 border-slate-50 bg-slate-100 shadow-xl sm:rounded-3xl sm:border-10 sm:shadow-2xl lg:rounded-[3rem] lg:border-[12px]">
                ...
                >
                  <img
                    ...
                    alt="Sample assignment graphic: clinical psychology case study on telehealth and rural mental health, A-grade 92%, APA 7 layout, 15+ peer-reviewed sources, SPSS analysis, and course instructor review quote."
            ...
            <div className="order-1 flex min-w-0 flex-col lg:order-2">
              ...
              >
                ...
                <h3 className="text-2xl font-black tracking-tight text-[#0B1F42] sm:text-3xl md:text-4xl lg:text-[2.5rem] lg:leading-tight">
                  Why students choose Essay Embassy for UAE &amp; Saudi assignment help
                </h3>
