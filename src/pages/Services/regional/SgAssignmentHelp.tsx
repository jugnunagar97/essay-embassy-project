/**
 * Singapore assignment help hub (single-file page).
 * Copy, schema, and UI cues are localised for SG students (SGD, Singapore English, local IHLs).
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-xl border border-gray-100 ${compact ? 'p-6 lg:p-5' : 'p-8'}`}>
      <div className={`text-center ${compact ? 'mb-6' : 'mb-8'}`}>
        ...
        <p className="text-gray-600 text-sm">From SGD $12 per page. Clear estimate, no hidden fees.</p>
      </div>
      ...
      <div className={compact ? 'space-y-5' : 'space-y-6'}>
        <div>
          ...
          >
            <option value="highschool">A-Level / IB / diploma (or equivalent)</option>
        ...
        <div className={`bg-[#0B1F42]/5 rounded-2xl ${compact ? 'p-4' : 'p-6'} border border-[#0B1F42]/10`}>
          <div className={`flex justify-between items-center ${compact ? 'mb-4' : 'mb-6'}`}>
            <div>
              ...
              <p className={`${compact ? 'text-3xl' : 'text-4xl'} font-black text-[#0B1F42]`}>SGD ${totalPrice}</p>
            </div>
            <div className="text-right bg-white rounded-lg px-3 py-2 border border-[#0B1F42]/10">
              ...
              <p className={`${compact ? 'text-lg' : 'text-xl'} font-bold text-gray-900`}>SGD ${perPage}</p>
            </div>
          </div>
          ...
          <div className="mb-[4px] space-y-3 border-b border-gray-100 pb-3">
            ...
            <div className="flex min-w-0 items-center gap-[6px]">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[12px] font-semibold tracking-[-0.3px] text-gray-500">Singapore</div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          <motion.div variants={fadeUp} className="grid grid-cols-2 gap-[10px] md:grid-cols-4">
            {[
              { num: '100%', label: 'English-first writers with Singapore & regional IHL experience' },
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-1 gap-[12px] md:grid-cols-2">
            <div className="flex flex-col items-start rounded-xl border-[0.5px] border-gray-200 bg-white p-[18px]">
              ...
              <p className="mb-5 text-[13px] leading-[1.6] text-gray-500">
                ...
                strict adherence to APA 7th, Harvard, IEEE, or OSCOLA as required, your brief is our blueprint.
              </p>
...
function SgAssignmentFinalCtaSection() {
  return (
    <div className="w-full bg-white pb-[28px]">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <motion.p variants={itemVariants} className="mb-[32px] max-w-[420px] text-[15px] leading-[1.6] text-slate-200">
            Join <strong className="font-semibold text-white">students across Singapore</strong> who trust Essay Embassy for
      ...
      <RegionalAssignmentInterlink currentRegion="sg" />
    </div>
  );
}
...
const trustPoints = ['Turnitin® ready', 'APA / Harvard / IEEE', '24/7 SGT-friendly support'];
...
const services = [
  {
    ...
    icon: FileText,
    desc:
      'Custom essay writing — Essays and coursework briefs sit at the heart of most Singapore degree programmes. Whether you need a discursive humanities essay or a tightly argued report, our writers deliver clear structure, critical analysis, and referencing that matches your module rubric. Every section is written from scratch against your learning outcomes and marking criteria.',
  },
  {
    title: 'Assignment Help',
    icon: PenTool,
    desc:
      'Online assignment help — Tight deadlines on LumiNUS, Canvas, or Turnitin submissions? We cover 400+ disciplines, from Nursing and Law to Computing and Business, with a 98.2% on-time delivery rate so your work lands before the cut-off, even when the brief is complex or data-heavy.',
  },
  {
    title: 'Research Paper Help',
    icon: Search,
    desc:
      'Research paper support — Literature reviews, methodology chapters, and evidence-based arguments need credible sources and clean synthesis. Our subject experts gather peer-reviewed material, apply your required style (APA 7th, Harvard, IEEE, etc.), and produce original, fully cited model papers you can learn from.',
  },
  {
    title: 'Thesis Writing',
    icon: GraduationCap,
    desc:
      'Honours & masters thesis writing — Many Singapore postgraduate programmes culminate in a substantial thesis or capstone. We help with structure, argument flow, ethics-committee-ready wording (where applicable), and chapter-by-chapter drafting so your core research is presented to the standard your examiners expect.',
  },
  {
    title: 'Dissertation Writing',
    icon: ScrollText,
    desc:
      'Complete dissertation support — Your doctoral thesis is the largest single assessment many students undertake. Our PhD-qualified experts help with proposals, chapters, analysis, and discussion, producing original, fully referenced drafts you can refine ahead of submission and your oral defence.',
  },
];
...
const whyUsFeatures = [
  {
    ...
    desc:
      'Singapore universities and polytechnics are strict on structure, word limits, and referencing. Whether your course requires APA 7th, Harvard, IEEE, or discipline-specific styles, we follow your brief and rubric so you do not lose marks on presentation or citation detail.',
  },
  {
    icon: Award,
    title: 'Original work for strong results',
    desc:
      'No one wants similarity flags or recycled paragraphs. Each order is researched and written from scratch, checked for originality, and aligned to Singapore assessment expectations so you receive a clean model answer you can adapt responsibly.',
  },
  {
    icon: Clock,
    title: 'Deadline-first delivery',
    desc:
      'Late penalties add up fast. From standard weekly deadlines to last-minute submissions, our team works across SGT and global hours so your completed draft reaches you with time to review before you upload to Turnitin or your LMS.',
  },
  {
    icon: Users,
    title: 'Writers who understand SG study',
    desc:
      'We match you with fluent English writers experienced in Singapore undergraduate and postgraduate conventions — from first-year reports to FYP and dissertation chapters — so tone, structure, and referencing feel native to your programme.',
  },
  {
    icon: BookOpen,
    title: 'Support across 400+ subjects',
    desc:
      'From week-four tutorial prep to your final-year project, one team can cover essays, reports, reflective pieces, and technical write-ups across more than 400 subject areas.',
  },
];
...
const howItWorksSteps = [
  ...
  },
  {
    ...
    desc: 'We pair you with a graduate-qualified writer in your subject area — many with experience at NUS, NTU, SMU, and other Singapore IHLs.',
  },
  {
    number: '03',
    icon: FileCheck,
    ...
    <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <h3 className="mt-4 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            We Cover Every Subject <br className="hidden sm:block" /> Singapore students ask us for
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            Our network of 500+ graduate writers spans major Singapore faculties and research areas, so you get specialist depth on
      ...
      <div className="mt-12 text-center">
        <p className="text-sm font-medium text-slate-400">
          All subjects follow{' '}
          <span className="font-bold italic text-[#0B1F42]">MOE-aligned academic writing conventions</span>
        </p>
      </div>
    </div>
  </section>
...
const AcademicFootprintSection = () => (
  <section className="relative overflow-x-hidden bg-gradient-to-b from-white via-slate-50/80 to-slate-50 py-16 sm:py-24">
    ...
    <div className="relative mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mb-10 text-center sm:mb-12">
        ...
        >
          ...
          <h3 className="mt-3 text-3xl font-black tracking-tight text-[#0B1F42] sm:text-4xl lg:text-5xl">
            Helping Students From <br className="hidden sm:block" /> Leading Singapore Universities &amp; Polytechnics
          </h3>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
      ...
      >
        Trusted by students at <span className="text-[#0B1F42]">autonomous universities &amp; polytechnics</span>
      </motion.p>
    </div>
  </section>
);
    ...
    <div className="relative z-10 mx-auto min-w-0 max-w-7xl px-5 sm:px-8 lg:px-12">
      <div className="mb-12 text-center lg:mb-16">
        ...
        >
          ...
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-blue-900 to-[#1652A0]" />
          <p className="mx-auto mt-6 max-w-2xl text-slate-600">
            We don&apos;t just write; we architect papers that aim for the criteria behind an A or Distinction grade at
            research-intensive Singapore universities.
          </p>
        </motion.div>
      </div>
          ...
          <div className="col-span-1 flex min-w-0 flex-col justify-center p-8 sm:p-12 lg:col-span-5 lg:border-l lg:border-slate-100">
            ...
            <div className="mb-8 space-y-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <p className="min-w-0 text-sm text-slate-600">
                  <span className="font-bold text-[#0B1F42]">Format:</span> APA 7th (Singapore university layout; title page &amp; references per your brief).
                </p>
              </div>
              <div className="flex min-w-0 items-start gap-3">
                <CheckCircle className="mt-1 h-5 w-5 shrink-0 text-[#D4A853]" />
            ...
            <div className="mb-8 rounded-2xl bg-slate-50 p-5 italic ring-1 ring-slate-100">
              ...
              <p className="mt-3 text-xs font-black uppercase tracking-widest text-slate-400 not-italic">
                — Module tutor, National University of Singapore
              </p>
            </div>
  ...
  <section className="relative overflow-hidden bg-slate-50 py-16 sm:py-24 lg:py-32">
    <div className="pointer-events-none absolute left-1/2 top-0 h-full w-full -translate-x-1/2 opacity-[0.03]">
      <svg width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
        <pattern id="sg-assignment-help-dots" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="2" fill="#0B1F42" />
        </pattern>
        <rect width="100%" height="100%" fill="url(#sg-assignment-help-dots)" />
      </svg>
    </div>
...
const SgHeroBackdrop = () => (
  <motion.div className="pointer-events-none absolute inset-0 overflow-hidden opacity-25">
    <svg className="absolute h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden>
      <defs>
        <linearGradient id="sgHeroWaveGrad" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default function SgAssignmentHelp() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-white font-sans text-slate-900">
      <Helmet htmlAttributes={{ lang: 'en-SG' }}>
        <title>Singapore Assignment Help | University &amp; Postgrad Support in SGD</title>
        <meta
          name="description"
          content="Singapore assignment help from SGD $12 per page. Singapore English, APA/Harvard/IEEE, Turnitin-ready model essays, coursework, and dissertation support for SG students."
        />
      </Helmet>
            ...
            >
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 backdrop-blur-md sm:mb-6 sm:px-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.15em] text-white sm:text-xs sm:tracking-[0.2em]">
                  SG students · Singapore English · SGD pricing
                </span>
              </div>
              ...
              <h1 className="mb-5 max-w-4xl text-[1.65rem] font-black leading-[1.12] tracking-tight text-white sm:mb-6 sm:text-4xl md:text-5xl lg:text-[3.25rem] lg:leading-[1.08] xl:text-6xl">
                Trusted Singapore assignment help for university &amp; postgraduate students
              </h1>
              <p className="mx-auto mb-7 max-w-xl text-[15px] leading-relaxed text-slate-300 sm:mb-8 sm:text-lg lg:mx-0 lg:text-xl">
                Falling behind on deadlines or a tough module brief? If you are searching for{' '}
                <strong className="font-semibold text-white">assignment help Singapore</strong> with clear{' '}
                <strong className="font-semibold text-white">SGD</strong> pricing, our writers deliver
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center sm:mb-14">
            ...
            <h3 className="mt-3 text-2xl font-black leading-tight tracking-tight text-[#0B1F42] sm:text-4xl md:text-5xl">
              Singapore assignment writing across every major discipline
            </h3>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-slate-600 sm:text-base">
              Tailored to Singapore university and polytechnic expectations — clear structure, critical analysis, and referencing that matches
              your module rubric. From short essays and LumiNUS submissions to dissertations, our writers deliver structured model
            ...
            <div className="order-1 flex min-w-0 flex-col lg:order-2">
              ...
              >
                ...
                <h3 className="text-2xl font-black tracking-tight text-[#0B1F42] sm:text-3xl md:text-4xl lg:text-[2.5rem] lg:leading-tight">
                  Why students choose Essay Embassy for Singapore assignment help
                </h3>
