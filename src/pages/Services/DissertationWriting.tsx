...
const carouselItems = [
  {
    ...
    title: 'Verification',
    description: 'We carefully verify each homework helper to ensure your safety. Every tutor undergoes identity verification through social media and background checks.'
  },
  {
    imgSrc: '/images/skill test.jpg',
    title: 'Subject Expertise',
    description: 'Our homework helpers are tested across multiple subjects and grade levels to ensure they can handle everything from basic math to advanced calculus.'
  },
  {
    imgSrc: '/images/quality analysis.jpg',
    title: 'Quick Response',
    description: "We understand homework deadlines are tight. Our AI system matches you with available tutors who can start helping within minutes."
  },
  {
    imgSrc: '/images/education level.jpg',
    title: 'Grade-Level Experts',
    description: 'From elementary school to college level, our tutors specialize in specific grade levels and understand age-appropriate teaching methods.'
  },
  {
    imgSrc: '/images/broad expertise.jpg',
    title: 'All Subjects Covered',
    description: 'Math, Science, English, History, Foreign Languages - no matter what homework you\'re struggling with, we have qualified tutors ready to help.'
  },
  {
    imgSrc: '/images/communication skills.jpg',
    title: 'Step-by-Step Guidance',
    description: 'Our tutors don\'t just give answers - they explain each step so you understand the process and can tackle similar problems on your own.'
  }
];

export function SpecialHomeworkHelpCarousel() {
          ...
          <div className="md:col-span-1 flex flex-col justify-between">
            <div>
              ...
              <div className="mb-4 flex items-center">
                ...
                What Makes Our Homework Help Service So Special?
                </h2>
              </div>
              <p className="text-base md:text-lg text-gray-400 leading-relaxed mt-2 mb-10 max-w-md" style={{fontFamily: 'Inter, sans-serif', letterSpacing: '0.01em'}}>
                Essay Embassy connects you with <span className="text-primary-500 font-medium">qualified homework tutors</span> across all subjects. Get personalized help with your daily homework and never fall behind in class again.
              </p>
            </div>
  ...
  const testimonials = [
    {
      id: 'EE-24467',
      rating: 5,
      text: "Got stuck on my calculus homework and the tutor explained each step so clearly! Now I understand derivatives much better and can solve similar problems on my own.",
      date: '04/14/2025',
      level: 'High School',
    },
    {
      id: 'EE-23901',
      rating: 5,
      text: 'My chemistry homework was due the next day and I was completely lost. The tutor helped me understand molecular structures and I got an A on the assignment!',
      date: '03/16/2025',
      level: 'College',
    },
    {
      id: 'EE-57281',
      rating: 4,
      text: 'Essay Embassy tutors are amazing! They helped me with my English literature homework and taught me how to analyze poems properly. Very patient and helpful.',
      date: '06/16/2025',
      level: 'High School',
    },
    {
      id: 'EE-19822',
      rating: 5,
      text: 'Physics problems used to stress me out, but now I have a go-to homework helper who breaks down complex concepts into simple steps. Life saver!',
      date: '02/10/2025',
      level: 'College',
    },
    {
      id: 'EE-33412',
      rating: 5,
      text: 'Needed help with my statistics homework and got paired with an expert who made probability distributions actually make sense. Great experience!',
      date: '01/22/2025',
      level: 'University',
    },
    {
      id: 'EE-11234',
      rating: 4,
      text: 'Spanish conjugations were driving me crazy until I got homework help here. The tutor was native speaker and helped me understand the patterns. ¡Gracias!',
      date: '05/05/2025',
      level: 'High School',
    },
  ];
                ...
                return (
                    ...
                    <>
                      ...
                      <Helmet>
                        ...
                        <title>Dissertation Writing Service | Expert Help</title>

                        <meta

                          name="description"

                          content="Professional dissertation writing service. Get comprehensive dissertation help from PhD-level writers. Original research guaranteed."

                        />

                        <link rel="canonical" href="https://essayembassy.com/services/dissertation-writing" />
      ...
      <section className="w-full bg-[#F7FAFC] py-16">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-semibold text-center mb-14 tracking-wide text-gray-900 drop-shadow-md" style={{letterSpacing: '0.03em'}}>
            We go beyond <span className="bg-gradient-to-r from-primary-500 via-blue-400 to-primary-600 bg-clip-text text-transparent">homework help services</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Whenever you ask us for homework help and hire a professional writer, your paper will contain zero AI content.</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">We're ready to prove that our papers are written from scratch with free reports for all "homework help" requests.</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
            ...
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Our homework experts leverage their experience to deliver well-researched and carefully put-together papers with deadlines starting from three hours.</div>
            </div>
            {/* Card 6 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Prices for our homework help services start at $10.80/page. You get all the essentials and even enjoy some freebies.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-10 px-2 bg-[#F7FAFC]">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-500/90 font-light text-center max-w-2xl mx-auto mb-10" style={{fontFamily: 'Inter, sans-serif', lineHeight: '1.6'}}>
            Preview real homework samples completed by our experts. Each sample demonstrates our commitment to quality, originality, and academic integrity—so you can trust us with your most important work.
          </p>
      ...
      <section className="w-full bg-[#F7FAFC] py-12">
        <div className="max-w-md mx-auto px-4 relative flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col items-center relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-900">Your Homework Help journey</h2>
            ...
            <div className="flex-1 w-full">
              ...
              <div className="bg-white/80 rounded-3xl shadow-lg p-4 md:p-8">
                <div className="space-y-2">
                  {[
                    {
                      question: 'Is your homework help service confidential and safe?',
                    ...
                    {
                      question: 'Will my homework be handled by a real expert?',
                      answer: 'Yes! Every homework task is handled by a qualified expert who has passed our rigorous selection and verification process to ensure top quality.'
                    },
                    {
                      question: 'How quickly can I receive homework help?',
                      answer: 'We offer deadlines starting from 3 hours. Choose your preferred deadline in the order form, and we\'ll ensure timely delivery by a homework expert.'
                    },
                    {
                      question: 'What if I am not satisfied with the homework help?',
                    ...
                    {
                      question: 'How do I place an order for homework help?',
