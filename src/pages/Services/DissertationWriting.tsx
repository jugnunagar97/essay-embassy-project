...
const sampleCards = [
  {
    title: "Dissertation Proposal: Sustainable Development",
    pages: 20,
    level: "PhD",
    type: "Proposal",
    citation: "APA"
  ...
  {
    title: "Methodology Section on AI Implementation",
    pages: 15,
    level: "Masters",
    type: "Methodology",
    citation: "MLA"
  ...
  {
    title: "Full Dissertation on Climate Change Mitigation",
    pages: 120,
    level: "PhD",
    type: "Full Dissertation",
    citation: "Harvard"
  },
  {
    title: "Statistical Analysis in Health Studies",
    pages: 25,
    level: "Masters",
    type: "Analysis",
    citation: "Chicago"
...
export default function DissertationWriting() {
  ...
  const faqData = [
    {
      question: 'What stages of dissertation can you assist with?',
      answer: 'We support dissertation topic finalization, research design, data collection, statistical analysis, and chapter writing.'
    },
    {
      question: 'Are your dissertation writers qualified?',
      answer: 'Our writers hold advanced degrees and possess extensive experience in dissertation writing across various fields.'
    },
    {
      question: 'How do you ensure the quality of the dissertation?',
      answer: 'We have a rigorous quality assurance process that includes multiple reviews, plagiarism checks, and expert consultations.'
    },
  ];
        ...
        <main className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600">
              Complete your dissertation with confidence. From topic finalization to defense preparation, our PhD experts provide comprehensive dissertation writing support across all academic fields.
            </p>
            {/* Ratings */}
      ...
      <section className="container mx-auto px-6 py-6 md:py-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Meet the PhD Experts Behind Your Dissertation Success
          </h2>
          <p className="text-gray-500 text-base">
            Our dissertation team consists exclusively of PhD-qualified researchers with extensive experience in academic writing, research methodology, and statistical analysis across various fields of study.
          </p>
        </div>
      ...
      <section className="w-full bg-[#F7FAFC] py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-light tracking-wider text-center mb-20 animate-fade-in-up">
            We go beyond <span className="bg-gradient-to-r from-primary-500 via-blue-400 to-primary-600 bg-clip-text text-transparent animate-gradient-x font-semibold">dissertation writing services</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-3 py-4 transition-all duration-300 animate-fade-in-up hover:scale-105 hover:shadow-xl">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Our PhD experts apply rigorous research methodologies ensuring your dissertation meets the highest academic standards.</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Statistical analysis support</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Get expert assistance with data collection, statistical analysis, and interpretation to strengthen your dissertation findings.</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Chapter-by-chapter support</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Receive dedicated support for each dissertation chapter, from literature review to conclusion, ensuring cohesive flow throughout.</div>
            </div>
            {/* Divider */}
