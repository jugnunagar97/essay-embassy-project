  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm">Expert law assignment help starting at just $16.00/page. Pricing updates in real time with zero hidden fees.</p>
      </div>
      <div className="space-y-6">
        ...
        <div className="bg-[#0B1F42]/5 rounded-2xl p-6 border border-[#0B1F42]/10">
          ...
          >
            Do My Law Assignment <ArrowRight className="w-5 h-5" />
          </Link>
...
// ─── Law Sub-Services Grid ─────────────────────────────────────────────────────
const LawServicesGrid = () => {
  const services = [
    {
      emoji: '📝',
      title: 'Contract Law Assignment Help',
      description: 'Expert contract law assignments covering offer and acceptance, consideration, breach of contract, remedies, and enforceable agreement analysis with accurate case citations.',
      features: ['Offer & acceptance rules', 'Consideration & capacity', 'Breach & remedies', 'Case citation accuracy'],
      cta: 'Get Contract Law Help',
      slug: '/assignment-help/law/contract-law',
      popular: true,
    },
    {
      emoji: '⚖️',
      title: 'Criminal Law Assignment Help',
      description: 'Detailed criminal law assignments covering mens rea, actus reus, defense arguments, criminal procedure, and sentencing analysis using current statutes and case law.',
      features: ['Mens rea & actus reus', 'Defense arguments', 'Criminal procedure', 'Sentencing analysis'],
      cta: 'Get Criminal Law Help',
      slug: '/assignment-help/law/criminal-law',
      popular: false,
    },
    {
      emoji: '🏢',
      title: 'Corporate Law Assignment Help',
      description: 'Precise corporate law assignments covering company formation, directors duties, shareholder rights, mergers and acquisitions, and corporate governance frameworks.',
      features: ['Company formation', 'Directors duties', 'Shareholder rights', 'Corporate governance'],
      cta: 'Get Corporate Law Help',
      slug: '/assignment-help/law/corporate-law',
      popular: false,
    },
    {
      emoji: '🏛️',
      title: 'Constitutional Law Assignment Help',
      description: 'Well-researched constitutional law assignments covering judicial review, separation of powers, fundamental rights, constitutional amendments, and landmark case analysis.',
      features: ['Judicial review', 'Separation of powers', 'Fundamental rights', 'Landmark case analysis'],
      cta: 'Get Constitutional Law Help',
      slug: '/assignment-help/law/constitutional-law',
      popular: false,
    },
    {
      emoji: '🌐',
      title: 'International Law Assignment Help',
      description: 'Thorough international law assignments covering treaties, state sovereignty, human rights law, international trade law, and dispute resolution mechanisms.',
      features: ['Treaties & sovereignty', 'Human rights law', 'International trade law', 'Dispute resolution'],
      cta: 'Get International Law Help',
      slug: '/assignment-help/law/international-law',
      popular: false,
    },
    {
      emoji: '🔨',
      title: 'Tort Law Assignment Help',
      description: 'Clear tort law assignments covering negligence, duty of care, vicarious liability, nuisance, defamation, and damages with properly structured IRAC analysis.',
      features: ['Negligence & duty of care', 'Vicarious liability', 'Nuisance & defamation', 'IRAC structure'],
      cta: 'Get Tort Law Help',
      slug: '/assignment-help/law/tort-law',
      popular: false,
    },
    {
      emoji: '💼',
      title: 'Business Law Assignment Help',
      description: 'Accurate business law assignments covering commercial contracts, consumer protection, employment law, competition law, and regulatory compliance for business entities.',
      features: ['Commercial contracts', 'Consumer protection', 'Employment law', 'Competition & compliance'],
      cta: 'Get Business Law Help',
      slug: '/assignment-help/law/business-law',
      popular: false,
    },
    {
      emoji: '👨‍👩‍👧',
      title: 'Family Law Assignment Help',
      description: 'Sensitive and thorough family law assignments covering marriage, divorce, child custody, adoption, domestic violence law, and financial settlements.',
      features: ['Marriage & divorce law', 'Child custody analysis', 'Adoption procedures', 'Financial settlements'],
      cta: 'Get Family Law Help',
      slug: '/assignment-help/law/family-law',
      popular: false,
    },
    {
      emoji: '💡',
      title: 'Intellectual Property Law Assignment Help',
      description: 'Specialist intellectual property assignments covering copyright, trademarks, patents, trade secrets, IP infringement, and licensing agreement analysis.',
      features: ['Copyright & trademarks', 'Patent law', 'Trade secrets', 'IP infringement analysis'],
      cta: 'Get IP Law Help',
      slug: '/assignment-help/law/intellectual-property-law',
      popular: false,
    },
    {
      emoji: '🌿',
      title: 'Environmental Law Assignment Help',
      description: 'Well-structured environmental law assignments covering climate legislation, pollution regulations, environmental impact assessments, and international environmental treaties.',
      features: ['Climate legislation', 'Pollution regulations', 'Environmental impact', 'International treaties'],
      cta: 'Get Environmental Law Help',
      slug: '/assignment-help/law/environmental-law',
      popular: false,
    },
  ];
...
export default function LawAssignmentHelp() {
  return (
    <>
      <Helmet>
        <title>Best Law Assignment Help for University Students</title>
        <meta name="description" content="Need law homework help? Pay someone to write law assignment tasks today. Hire the best law assignment writing service online for top grades." />
        <meta name="keywords" content="law assignment help, law homework help, do my law assignment, law assignment writing service, contract law assignment help, criminal law assignment help, corporate law assignment help, constitutional law assignment help" />
      </Helmet>
      <div className="min-h-screen bg-white font-sans">
            ...
            <div className="max-w-5xl mx-auto text-center mb-10">
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  ...
                  <span className="text-sm font-bold text-gray-700">Plagiarism Free Legal Briefs</span>
                </div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  <TrendingUp className="w-4 h-4 text-yellow-500" />
                  <span className="text-sm font-bold text-gray-700">Native English Law Experts</span>
                </div>
              ...
              <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-[#0B1F42] mb-10 leading-[1.2] tracking-tight">
                Professional Law Assignment Help Online
              </h1>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
                {[
                  ...
                  { value: '900+', label: 'Verified Legal Experts', color: 'text-[#1652A0]' },
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                  Why Choose Our Law Assignment Help Service?
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  We offer the best law assignment help for university students tackling contract law, criminal law, corporate law, constitutional law, and more. Here is why students worldwide trust us to help them get better grades.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-gradient-to-br from-[#0B1F42] to-[#1652A0] p-10 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-3xl font-black mb-4">Plagiarism Free Legal Briefs and Turnitin Report</h3>
                    ...
                    <div className="bg-green-500 text-white px-6 py-3 rounded-xl inline-flex items-center gap-2 font-bold text-lg shadow-xl">
                      <Trophy className="w-6 h-6" /> Your Paper, Written by a Real Law Expert
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-[#1652A0]">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Native English Law Experts</h3>
                  <p className="text-gray-600 leading-loose mb-6">
                    We hire experienced writers with advanced LLB, JD, and PhD degrees. They know exactly how to conduct thorough legal research and writing. They help you get top grades easily.
                  </p>
                  <ul className="space-y-3">
                    {['LLB, JD & PhD qualified writers', 'Contract & criminal law specialists', 'Corporate & constitutional experts', 'International & tort law professionals'].map((item, i) => (
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-orange-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Do you need law assignment help near me right now? Our customer support team works around the clock. You can chat with your law assignment helper online directly to share ideas and ask questions.
                  </p>
                  <ul className="space-y-3">
                    {['24/7 customer support', 'Direct writer chat', 'Share your rubric & cases', 'Instant responses'].map((item, i) => (
                      <li key={i} className="flex items-center text-gray-700 font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-red-500">
                  ...
                  <ul className="space-y-3">
                    {['Free revision window', 'Citations re-checked', 'Arguments & structure refined', 'Zero additional costs'].map((item, i) => (
                      <li key={i} className="flex items-center text-gray-700 font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-indigo-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Your personal details are completely safe with us. We protect your academic data with strong encryption when you buy law assignment canada, the UK, the US, or anywhere else.
                  </p>
                  <ul className="space-y-3">
              ...
              <div className="mt-16 text-center">
                ...
                >
                  Get My Law Assignment Done Today <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <div className="inline-block bg-[#0B1F42]/5 text-[#0B1F42] px-5 py-2 rounded-full text-sm font-semibold mb-4">
                  LAW ASSIGNMENT SERVICES WE OFFER
                </div>
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                  Law Assignment Help and All Sub-Topics We Cover
                </h2>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8]">
                  At EssayEmbassy, we specialize in providing top quality university law assignment help. Law classes require you to understand many different topics like deep legal case study analysis and complex contract law problems. When you find yourself thinking "I need to pay someone to write law assignment tasks", we are here for you. We offer the best law assignment help for university students worldwide.
                </p>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8] mt-4">
                  Whether you need law assignment help uk or law assignment help australia, our experts can assist you. We provide the best law assignment writing service to help you pass your classes. Our team handles everything from criminal justice coursework to detailed commercial law essays. We base all our writing on accurate research and current court cases.
                </p>
              </div>
              <LawServicesGrid />
              <div className="mt-12 bg-gray-50 rounded-2xl p-10 text-center border border-gray-200">
                <h3 className="text-2xl font-bold text-[#0B1F42] mb-3">Ready to Get Top Grades on Your Law Assignment?</h3>
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Every paper is written by a verified law expert with accurate citations, solid arguments, and proper formatting throughout.
                </p>
                <Link
                  to="/order-now"
                ...
                >
                  Order Law Assignment Help Now <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  A straightforward four-step process designed to get your law assignment completed and submitted on time. Get started in minutes.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Fill out our simple order form. Upload your instructions and tell us your deadline. Provide your grading rubric. Let us know if you need help with contract law case study documents or a basic essay.',
                    highlight: 'Takes 2 minutes',
                    features: ['Secure file upload', 'Share your rubric', 'Set your deadline', 'Attach case files'],
                  },
                  {
                    step: '2', icon: Users,
                    ...
                    desc: 'We match you with cheap law homework helpers online who understand your exact subject. Your writer will have the right academic background to help you succeed.',
                    highlight: 'Subject-matched law expert',
                    features: ['LLB, JD & PhD qualified', 'Subject-area match', 'Verified credentials', 'Choose your writer'],
                  },
                  {
                    ...
                    desc: 'Stay in touch with your writer. You can monitor the progress of your law homework help and ask questions at any time.',
                  ...
                  },
                  {
                    ...
                    desc: 'Receive your completed task by the deadline. Download your finished files and submit your assignment with total confidence.',
              ...
              <div className="text-center bg-[#0B1F42] rounded-2xl p-10">
                <h3 className="text-2xl font-bold text-white mb-3">Ready to Get Top Grades on Your Law Assignment?</h3>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Your expertly written, submission-ready law paper is just one step away.</p>
                <Link
                  to="/order-now"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
                    Affordable Law Assignment Help Pricing
                  </h2>
                  <p className="text-lg text-gray-600 mb-8 leading-loose">
                    Our rates start at just $16.00 per order for basic college levels. Pricing updates in real time with no surprises, making professional law homework help accessible for every student.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-[1.8]">
                  Commitments we stand behind with every law assignment we write and deliver.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Our experts write perfectly structured papers. We make sure your case citations are completely accurate throughout every assignment.',
                  },
                  {
                    icon: Clock,
              ...
              <div className="text-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-3">We Stand Behind Every Law Assignment We Deliver</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">What Students Say About Our Law Assignment Help</h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  Real reviews from verified students who improved their grades with our law assignment help.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { name: 'Lucas S.', tag: 'Verified', date: 'Oct 12, 2025', subject: 'Corporate Law', rating: 5, text: 'I told them to do my law assignment for my business class. The research was perfect. This is the best law assignment writing service.' },

                  { name: 'Fahid B.', tag: 'Returning Client', date: 'Nov 02, 2025', subject: 'Criminal Law', rating: 5, text: 'I needed university law assignment help for a tough paper. The defense arguments were completely accurate and delivered early.' },

                  { name: 'Johanna T.', tag: 'First-Time User', date: 'Nov 18, 2025', subject: 'Tort Law', rating: 4.9, text: 'My expert provided amazing help with my civil case files. The formatting was excellent and totally original.' },

                  { name: 'Ryan P.', tag: 'Returning Client', date: 'Dec 05, 2025', subject: 'Constitutional Law', rating: 5, text: 'Long time fan here. I use this law assignment helper online often. The writing is always flawless and avoids plagiarism completely.' },

                  { name: 'Darious D.', tag: 'Verified', date: 'Jan 14, 2026', subject: 'Property Law', rating: 5, text: 'I had to pay someone to write law assignment tasks for my real estate class. The legal case study analysis was deeply engaging and very professional.' },

                  { name: 'Liam K.', tag: 'First-Time User', date: 'Feb 22, 2026', subject: 'International Law', rating: 4.8, text: 'If you need cheap law homework helpers online, try this site. They used excellent logic and helped me meet a very tight deadline.' },
                ].map((review, i) => (
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="space-y-4">
              <FAQItem
                question="How much does law assignment help cost?"
              ...
              />
              <FAQItem
                question="Who can write my law assignment fast?"
              ...
              />
              <FAQItem
                question="How do your experts structure a legal case study?"
                answer="Our team uses strict academic guidelines like the IRAC method formatting. They identify the Issue, explain the Rule of law, Apply the rule to the facts, and state a clear Conclusion. We also format citations perfectly using Bluebook, OSCOLA, or Harvard styles."
              />
              <FAQItem
                question="Is it safe to buy law assignments online?"
              ...
              />
              <FAQItem
                question="Can I get help with a masters level law assignment?"
                answer="Absolutely. We provide excellent law homework help for all college and university levels. Our native English law experts have advanced degrees. They can easily tackle the most complex projects for higher education."
              />
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-loose">
                Stop stressing over your coursework. Let our professional experts handle your research and case studies. Get reliable law assignment help today.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
                ...
                >
                  Start Your Law Assignment Now <ArrowRight className="w-5 h-5" />
                </Link>
                <Link
                  to="/samples"
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                {[
                  { icon: ShieldCheck, text: 'Plagiarism Free Legal Briefs' },
