...
// ==================================================================================
// === MAIN ENGLISH ASSIGNMENT HELP PAGE COMPONENT ===
// ==================================================================================

const EnglishAssignmentHelp = () => {
  const { testimonials } = useTestimonials();
  
  const samples: Sample[] = [
    { title: 'Analysis of Shakespearean Sonnets', pages: 5, style: 'MLA', content: 'This paper provides a detailed analysis of the structure, themes, and literary devices used in a selection of Shakespeare\'s sonnets, focusing on Sonnets 18 and 130...', downloadUrl: '#' },
    { title: 'Character Arc of Jay Gatsby', pages: 6, style: 'Chicago', content: 'An in-depth exploration of the character development of Jay Gatsby in F. Scott Fitzgerald\'s "The Great Gatsby," tracing his ambitions, illusions, and ultimate downfall...', downloadUrl: '#' },
  ];
  const freebies = ['Literary Analysis', 'Poetry Interpretation', 'Character Studies', 'Thematic Exploration', 'Grammar & Syntax', 'Proofreading'];
  const faqs = [
    { question: 'Can you help with literary analysis?', answer: 'Yes, literary analysis is one of our core strengths. Our English experts can help you analyze any text, exploring themes, characters, symbolism, and literary devices to create a deep and insightful paper.' },
    { question: 'Do you cover specific literary periods?', answer: 'Absolutely. Our team includes specialists in various literary periods, from Old English and Renaissance literature to Modernism and Post-modernism. We can handle assignments on any era.' },
    { question: 'Can you help me with grammar and sentence structure?', answer: 'Yes. Beyond analysis, we provide expert editing and proofreading to ensure your writing is grammatically perfect, with clear, well-structured sentences that effectively convey your ideas.' },
  ];
    ...
    <div className="animate-fade-in bg-white dark:bg-secondary-900">
      ...
      <section className="bg-secondary-50 dark:bg-secondary-900 py-20">
        <div className="container mx-auto px-6 text-center">
          <span className="font-semibold text-primary-600 dark:text-primary-400">English Assignment Help</span>
          <h1 className="text-4xl md:text-5xl font-extrabold text-secondary-900 dark:text-white my-4">Master Your English Assignments</h1>
          <p className="text-lg text-secondary-600 dark:text-secondary-300 max-w-2xl mx-auto">From complex literary analysis to grammar exercises, our English experts are here to help you excel.</p>
          <div className="flex justify-center items-center flex-wrap gap-x-6 gap-y-2 my-8 text-sm text-secondary-500 dark:text-secondary-400">
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />Literary Analysis</span>
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />Grammar Perfection</span>
            <span className="flex items-center"><ShieldCheck className="h-4 w-4 mr-2 text-primary-500" />Any English Topic</span>
          </div>
          <Link to="/order-now" className="btn-primary text-lg px-8 py-3 shadow-soft hover:shadow-medium transition-shadow">Get English Help</Link>
        </div>
      </section>

      <section className="section container">
        <h2 className="heading-lg text-center mb-8">From Sonnets to Syntax</h2>
        <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto text-secondary-600 dark:text-secondary-300">
          <p>English assignments can be incredibly diverse, ranging from analyzing the intricate symbolism in a Shakespearean play to mastering the nuances of English grammar. At Essay Embassy, our team of literature and language experts is equipped to handle it all. We provide in-depth literary analysis, helping you uncover themes and character arcs you might have missed. We also offer precise assistance with grammar, syntax, and structure, ensuring your writing is as polished as your ideas. Whether you're dissecting poetry or perfecting a persuasive essay, we provide the expert support you need to succeed in your English courses.</p>
        </div>
      </section>
      
      <section className="section bg-secondary-50 dark:bg-secondary-900">
        <div className="container text-center">
          <h2 className="heading-lg mb-8">What Our English Help Includes</h2>
      ...
      <section className="section container">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Hear From Our <span className="text-primary-500">Literature Scholars</span>
          </h2>
          <div className="w-24 h-1 bg-primary-500 mx-auto mb-4"></div>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Real feedback from students who aced their English assignments with us.
          </p>
        </div>
      ...
      <section className="section bg-secondary-50 dark:bg-secondary-900">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="heading-lg">English Assignment Samples</h2>
            <p className="text-lg text-muted mt-4">See how we analyze literature and structure compelling arguments.</p>
          </div>
      ...
      <section className="section container">
        <div className="grid lg:grid-cols-3 gap-16 items-start">
          <div className="lg:col-span-1 space-y-4 bg-secondary-50 dark:bg-secondary-800 p-8 rounded-lg shadow-soft">
            <h2 className="heading-md">Ask Our English Experts</h2>
            <p className="text-muted">Have a question about your English assignment? We're here to help.</p>
...
export default EnglishAssignmentHelp;