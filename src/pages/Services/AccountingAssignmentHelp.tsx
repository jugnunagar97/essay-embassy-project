  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm">Expert accounting assignment help starting at just $16.00/page. Pricing updates in real time with zero hidden fees.</p>
      </div>
      <div className="space-y-6">
        ...
        <div className="bg-[#0B1F42]/5 rounded-2xl p-6 border border-[#0B1F42]/10">
          ...
          >
            Do My Accounting Assignment <ArrowRight className="w-5 h-5" />
          </Link>
...
// ─── Accounting Sub-Services Grid ─────────────────────────────────────────────────
const AccountingServicesGrid = () => {
  const services = [
    {
      emoji: '📊',
      title: 'Financial Accounting Assignment Help',
      description: 'Accurate financial accounting assignments covering income statements, balance sheets, general ledgers, and GAAP/IFRS standards compliance.',
      features: ['Preparation of financial statements', 'GAAP and IFRS standards', 'General ledger management', 'Bank reconciliations'],
      cta: 'Get Financial Accounting Help',
      slug: '/assignment-help/accounting/financial',
      popular: true,
    },
    {
      emoji: '🏢',
      title: 'Managerial Accounting Assignment Help',
      description: 'Detailed managerial accounting assignments covering cost behavior, budgeting, variance analysis, and internal performance evaluation.',
      features: ['Cost-volume-profit analysis', 'Budgeting and forecasting', 'Variance analysis reports', 'Internal performance review'],
      cta: 'Get Managerial Accounting Help',
      slug: '/assignment-help/accounting/managerial',
      popular: false,
    },
    {
      emoji: '📋',
      title: 'Cost Accounting Assignment Help',
      description: 'Clear cost accounting coursework covering job order costing, process costing, activity-based costing, and standard costing methods.',
      features: ['Job order & process costing', 'Activity-based costing', 'Standard costing methods', 'Overhead allocation'],
      cta: 'Get Cost Accounting Help',
      slug: '/assignment-help/accounting/cost',
      popular: false,
    },
    {
      emoji: '🧾',
      title: 'Taxation Assignment Help',
      description: 'In-depth taxation assignments covering personal income tax, corporate tax computations, tax planning, and compliance regulations.',
      features: ['Personal & corporate tax planning', 'Tax computations', 'Regulatory compliance', 'Deductions and credits'],
      cta: 'Get Taxation Help',
      slug: '/assignment-help/accounting/taxation',
      popular: false,
    },
    {
      emoji: '🔍',
      title: 'Auditing Assignment Help',
      description: 'Professional auditing assignments covering internal controls, audit sampling, substantive testing, and audit report drafting.',
      features: ['Internal controls risk assessment', 'Audit sampling methods', 'Substantive testing procedures', 'Audit reporting'],
      cta: 'Get Auditing Help',
      slug: '/assignment-help/accounting/auditing',
      popular: false,
    },
    {
      emoji: '🕵️',
      title: 'Forensic Accounting Assignment Help',
      description: 'Specialized forensic accounting tasks covering fraud investigation, dispute resolution, financial evidence gathering, and litigation support.',
      features: ['Fraud investigation cases', 'Dispute resolution tasks', 'Financial evidence gathering', 'Litigation support'],
      cta: 'Get Forensic Accounting Help',
      slug: '/assignment-help/accounting/forensic',
      popular: false,
    },
    {
      emoji: '💻',
      title: 'Accounting Information Systems Help',
      description: 'Comprehensive AIS assignments covering database management, transaction cycles, ERP software analysis, and system control risks.',
      features: ['Transaction cycle processing', 'ERP software analysis', 'Database management tasks', 'System control risk reviews'],
      cta: 'Get AIS Help',
      slug: '/assignment-help/accounting/ais',
      popular: false,
    },
    {
      emoji: '📈',
      title: 'Corporate Accounting Assignment Help',
      description: 'Expert corporate accounting assignments covering consolidated financial statements, company liquidations, and share issue processes.',
      features: ['Consolidated financial statements', 'Company valuation techniques', 'Liquidation processes', 'Share and debenture issues'],
      cta: 'Get Corporate Accounting Help',
      slug: '/assignment-help/accounting/corporate',
      popular: false,
    },
  ];
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function AccountingAssignmentHelp() {
  return (
    <>
      <Helmet>
        <title>Best Accounting Assignment Help for University Students</title>
        <meta name="description" content="Need accounting homework help? Pay someone to do accounting assignment tasks today. Hire the best accounting assignment writing service online for top grades." />
        <meta name="keywords" content="accounting assignment help, accounting homework help, do my accounting assignment, accounting assignment writing service, corporate accounting assignment help, financial modeling assignment help, investment assignment help" />
      </Helmet>
      <div className="min-h-screen bg-white font-sans">
            ...
            <div className="max-w-5xl mx-auto text-center mb-10">
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  ...
                  <span className="text-sm font-bold text-gray-700">Plagiarism-Free Financial Solutions</span>
                </div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm">
                  <TrendingUp className="w-4 h-4 text-yellow-500" />
                  <span className="text-sm font-bold text-gray-700">Native English Accounting Experts</span>
                </div>
              ...
              <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-[#0B1F42] mb-10 leading-[1.2] tracking-tight">
                Professional Accounting Assignment Help Online
              </h1>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  We offer the best accounting assignment help for university students tackling corporate accounting, investment analysis, financial modeling, and more. Here is why students worldwide trust us to help them get better grades.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-gradient-to-br from-[#0B1F42] to-[#1652A0] p-10 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-3xl font-black mb-4">Plagiarism-Free Financial Solutions and Free Turnitin Report</h3>
                    ...
                    <div className="bg-green-500 text-white px-6 py-3 rounded-xl inline-flex items-center gap-2 font-bold text-lg shadow-xl">
                      <Trophy className="w-6 h-6" /> Your Paper, Written by a Real Accounting Expert
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-[#1652A0]">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Native English Accounting Experts</h3>
                  <p className="text-gray-600 leading-loose mb-6">
                    We hire experienced writers with advanced master's and PhD degrees. They know exactly how to handle corporate accounting problems and explain complex investment valuation models. They help you get top grades easily.
                  </p>
                  <ul className="space-y-3">
                    {["Master's & PhD qualified writers", 'Corporate accounting specialists', 'Investment valuation experts', 'Financial modeling professionals'].map((item, i) => (
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-orange-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Need accounting assignment help right now? Our customer support team works around the clock. You can chat with your accounting assignment helper online directly to share ideas and ask questions at any stage.
                  </p>
                  <ul className="space-y-3">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-red-500">
                  ...
                  <ul className="space-y-3">
                    {['Free revision window', 'Calculations re-checked', 'Models & data refined', 'Zero additional costs'].map((item, i) => (
                      <li key={i} className="flex items-center text-gray-700 font-medium">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-indigo-500">
                  ...
                  <p className="text-gray-600 leading-loose mb-6">
                    Your personal details are completely safe with us. We protect your academic data with strong encryption when you pay for accounting assignment help in Canada, the UK, the US, or anywhere else.
                  </p>
                  <ul className="space-y-3">
              ...
              <div className="mt-16 text-center">
                ...
                >
                  Get My Accounting Assignment Done Today <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <div className="inline-block bg-[#0B1F42]/5 text-[#0B1F42] px-5 py-2 rounded-full text-sm font-semibold mb-4">
                  FINANCE ASSIGNMENT SERVICES WE OFFER
                </div>
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                  Accounting Assignment Help and All Sub-Topics We Cover
                </h2>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8]">
                  At EssayEmbassy, we specialize in providing top-quality university accounting assignment help. Accounting classes require you to understand many different topics and conduct deep research. When you find yourself thinking "I need to pay someone to do accounting assignment tasks," we are here for you. We offer the best accounting assignment help for university students worldwide.
                </p>
                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8] mt-4">
                  Whether you need accounting assignment help in the UK or accounting assignment help in Australia, our experts can assist. Our team handles everything from basic financial statement analysis to complex portfolio management tasks. We base all our writing on accurate market data.
                </p>
              </div>
              <AccountingServicesGrid />
              <div className="mt-12 bg-gray-50 rounded-2xl p-10 text-center border border-gray-200">
                <h3 className="text-2xl font-bold text-[#0B1F42] mb-3">Ready to Get Top Grades on Your Accounting Assignment?</h3>
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Every paper is written by a verified accounting expert with accurate calculations, solid analysis, and proper formatting throughout.
                </p>
                <Link
                  to="/order-now"
                ...
                >
                  Order Accounting Assignment Help Now <ArrowRight className="w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  A straightforward four-step process designed to get your accounting assignment completed and submitted on time. Get started in minutes.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Fill out our simple order form. Upload your instructions and tell us your deadline. Provide your grading rubric. Let us know if you need help with corporate accounting case study documents or basic homework and we will take it from there.',
                  ...
                  },
                  {
                    ...
                    desc: 'We match you with accounting homework helpers who understand your exact subject. Your writer will have the right academic background and real accounting experience to help you succeed.',
                    highlight: 'Subject-matched accounting expert',
                  ...
                  },
                  {
                    ...
                    desc: 'Stay in touch with your writer throughout the process. You can monitor the progress of your coursework and ask questions about your capital budgeting decisions at any time.',
              ...
              <div className="text-center bg-[#0B1F42] rounded-2xl p-10">
                <h3 className="text-2xl font-bold text-white mb-3">Ready to Get Top Grades on Your Accounting Assignment?</h3>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Your expertly written, submission-ready accounting paper is just one step away.</p>
                <Link
                  to="/order-now"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
                    Affordable Accounting Assignment Help Pricing
                  </h2>
                  <p className="text-lg text-gray-600 mb-8 leading-loose">
                    Our rates start at just $16.00 per order for basic college levels. Pricing updates in real time with no surprises, making professional accounting homework help accessible for every student.
                  </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-[1.8]">
                  Commitments we stand behind with every accounting assignment we write and deliver.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: 'Our experts write perfectly structured papers. We make sure your financial calculations and market data are completely accurate throughout every assignment.',
                  },
                  {
                    icon: Clock,
                  ...
                  },
                  {
                    ...
                    description: 'We revise your paper for free until it matches your exact needs. Calculations, models, and citations all adjusted at no extra charge.',
                  },
                  {
                    icon: Lock,
                    title: 'Privacy First',
              ...
              <div className="text-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-3">We Stand Behind Every Accounting Assignment We Deliver</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">What Students Say About Our Accounting Assignment Help</h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                  Real reviews from verified students who improved their grades with our accounting assignment help.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { name: 'Lucas S.', tag: 'Verified', date: 'Oct 12, 2025', subject: 'Corporate Accounting', rating: 5, text: 'I told them to do my accounting assignment for my business class. The research was perfect. This is the best accounting assignment writing service.' },

                  { name: 'Fahid B.', tag: 'Returning Client', date: 'Nov 02, 2025', subject: 'Investment Banking', rating: 5, text: 'I needed university accounting assignment help for a tough paper. The investment valuation models were completely accurate and delivered early.' },

                  { name: 'Johanna T.', tag: 'First-Time User', date: 'Nov 18, 2025', subject: 'Financial Planning', rating: 4.9, text: 'My expert provided amazing help with corporate accounting case study files. The formatting was excellent and totally original.' },

                  { name: 'Ryan P.', tag: 'Returning Client', date: 'Dec 05, 2025', subject: 'Public Accounting', rating: 5, text: 'Long-time fan here. I use this accounting assignment helper online often. The writing is always flawless and avoids plagiarism completely.' },

                  { name: 'Darious D.', tag: 'Verified', date: 'Jan 14, 2026', subject: 'Risk Management', rating: 5, text: 'I had to pay someone to do accounting assignment tasks for my risk class. The risk and return calculations were deeply engaging and very professional.' },

                  { name: 'Liam K.', tag: 'First-Time User', date: 'Feb 22, 2026', subject: 'International Accounting', rating: 4.8, text: 'If you need cheap accounting homework helpers online, use this site. They used excellent logic and helped me meet a very tight deadline.' },
                ].map((review, i) => (
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="space-y-4">
              <FAQItem
                question="How much does accounting assignment help cost?"
              ...
              />
              <FAQItem
                question="Who can do my accounting assignment fast?"
              ...
              />
              <FAQItem
                question="How do your experts solve complex financial models?"
                answer="Our team uses proven methods to solve financial problems. They are highly skilled in using tools like Excel to build solid models, manage risks, and analyze data accurately."
              />
              <FAQItem
                question="Is it safe to get accounting homework help online?"
              ...
              />
              <FAQItem
                question="Can I get help with a master's-level accounting assignment?"
                answer="Absolutely. We provide excellent accounting homework help for all college and university levels. Our native English accounting experts have advanced master's and PhD degrees. They can easily tackle the most complex projects for higher education."
              />
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-loose">
                Stop stressing over your coursework. Let our professional experts handle your research and market calculations. Get reliable accounting homework help today.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
                ...
                >
                  Start Your Accounting Assignment Now <ArrowRight className="w-5 h-5" />
                </Link>
                <Link
                  to="/samples"
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
                {[
                  { icon: ShieldCheck, text: 'Plagiarism-Free Financial Solutions' },
