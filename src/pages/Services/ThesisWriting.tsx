...
const sampleCards = [
  {
    title: "Thesis Proposal: Exploring Renewable Energy",
    pages: 15,
    level: "Masters",
    type: "Proposal",
    citation: "APA"
  ...
  {
    title: "Chapter 2: Literature Review on AI Ethics",
    pages: 25,
    level: "PhD",
  ...
  {
    title: "Data Analysis: Social Media Impact",
    pages: 20,
    level: "PhD",
  ...
  {
    title: "Full Thesis: Impact of Social Media on Society",
    pages: 100,
    level: "PhD",
    type: "Full Thesis",
    citation: "Chicago"
...
export default function ThesisWriting() {
  ...
  const faqData = [
    {
      question: 'What stages of thesis writing can you assist with?',
      answer: 'We provide comprehensive support throughout your entire thesis journey: proposal writing and development, literature review compilation, methodology design, data analysis and interpretation, individual chapter writing, full thesis composition, and defense preparation.'
    },
    {
      question: 'Do you provide thesis writing support for all academic levels?',
      answer: 'Yes, we offer thesis writing assistance for undergraduate honors theses, master\'s theses, and doctoral dissertations across all academic disciplines and fields of study.'
    },
    {
      question: 'Who will write my thesis chapters?',
      answer: 'Your thesis will be handled exclusively by PhD-qualified experts who have completed their own doctoral research in your specific field. Each writer has extensive experience in academic research methodology and scholarly writing.'
    },
  ];
    ...
    <div className="background-icons min-h-screen" style={{ fontFamily: 'Inter, sans-serif', backgroundColor: '#F7FAFC' }}>
        ...
        <main className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600">
              Transform your research into an exceptional thesis with expert guidance from our PhD-qualified writers. From proposal to defense, we provide comprehensive support for every stage of your thesis journey.
            </p>
            {/* Ratings */}
      ...
      <section className="container mx-auto px-6 py-6 md:py-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-900 mb-2">
            Meet the PhD Experts Behind Your Thesis Success
          </h2>
          <p className="text-gray-500 text-base">
            Our thesis writing team consists exclusively of PhD-qualified experts with extensive research experience. Each writer has successfully completed their own doctoral thesis and specializes in guiding students through every aspect of thesis development.
          </p>
        </div>
      ...
      <section className="w-full bg-[#F7FAFC] py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-light tracking-wider text-center mb-20 animate-fade-in-up">
            We go beyond <span className="bg-gradient-to-r from-primary-500 via-blue-400 to-primary-600 bg-clip-text text-transparent animate-gradient-x font-semibold">thesis writing services</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-3 py-4 transition-all duration-300 animate-fade-in-up hover:scale-105 hover:shadow-xl">
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">PhD-level research expertise</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Every thesis chapter is crafted by PhD-qualified researchers with deep expertise in your specific field and research methodology.</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Comprehensive thesis support</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">From proposal development to final defense preparation, we provide end-to-end support for every aspect of your thesis journey.</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Rigorous quality assurance</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Every thesis undergoes multiple quality checks including methodology review, citation verification, and academic writing standards compliance.</div>
            </div>
            {/* Divider */}
            ...
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Confidential research support</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Your thesis research and ideas remain completely confidential. We maintain the highest standards of academic integrity and data protection.</div>
            </div>
            {/* Card 5 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Milestone-based delivery</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Receive your thesis in carefully planned stages - from proposal to individual chapters - ensuring you stay on track with your academic timeline.</div>
            </div>
            {/* Card 6 */}
            <div className="flex flex-col items-center text-center bg-white/60 backdrop-blur-xl border border-white/30 shadow-lg rounded-xl px-4 py-6 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.5s'}}>
              ...
              <div className="font-normal text-base text-gray-700 mb-1 tracking-wide">Flexible pricing options</div>
              <div className="text-gray-500 text-base leading-relaxed font-normal max-w-xs mx-auto">Our thesis writing services offer flexible payment plans and chapter-by-chapter pricing to accommodate your budget and timeline needs.</div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-20 px-2 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-2 text-gray-900 tracking-tight">Sample Thesis Work</h2>
          <p className="text-center text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Explore authentic thesis samples crafted by our PhD experts. From compelling proposals to comprehensive literature reviews and complete dissertations—see the academic excellence we deliver.</p>
      ...
      <section className="w-full bg-white py-24">
        <div className="max-w-md mx-auto px-4 relative flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col items-center relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-900">Your Thesis Writing Journey</h2>
            <div className="flex flex-col items-center relative">
            {/* Step 1 */}
            <div className="flex flex-col items-center text-center mb-3 animate-fade-in-up">
              <span className="text-2xl mb-1">✍️</span>
              <div className="font-medium text-base md:text-lg text-gray-900 mb-0.5">1. Share your thesis requirements <span className="text-primary-600">(it's free)</span></div>
              <div className="text-gray-400 text-sm mb-2">Tell us about your research topic, academic level, and specific thesis needs</div>
            ...
            <div className="flex flex-col items-center text-center mb-3 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="font-medium text-base md:text-lg text-gray-900 mb-0.5">2. Get matched with a PhD expert</div>
              <div className="text-gray-400 text-sm">We assign a specialist researcher with expertise in your field</div>
            </div>
            {/* Arrow */}
            <div className="flex flex-col items-center mb-3">
              <svg width="18" height="24" fill="none" viewBox="0 0 24 24"><path d="M12 0v18m0 0l-5-5m5 5l5-5" stroke="#cbd5e1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            ...
            <div className="flex flex-col items-center text-center animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <span className="text-2xl mb-1">📄</span>
              <div className="font-medium text-base md:text-lg text-gray-900 mb-0.5">3. Receive your thesis work</div>
              <div className="text-gray-400 text-sm">Get your completed thesis chapters with ongoing support until graduation</div>
            </div>
          </div>
        </div>
        </div>
      ...
      <section className="w-full bg-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-10 text-gray-900 tracking-tight">Why Choose Our Thesis Writing Service</h2>
          <div className="flex flex-col md:flex-row justify-center items-stretch md:space-x-0 gap-4 md:gap-0">
            ...
            <div className="flex-1 flex flex-col items-center text-center px-2 md:px-4 max-w-xs mx-auto bg-white/80 rounded-xl shadow-md py-4">
              ...
              <span className="text-sm md:text-base font-medium text-gray-500 mt-1">Years of thesis<br className='hidden md:block'/>writing expertise</span>
            </div>
            {/* Divider */}
            ...
            <div className="flex-1 flex flex-col items-center text-center px-2 md:px-4 max-w-xs mx-auto bg-white/80 rounded-xl shadow-md py-4">
              ...
              <span className="text-sm md:text-base font-medium text-gray-500 mt-1">PhD-qualified<br className='hidden md:block'/>thesis specialists</span>
            </div>
            {/* Divider */}
            <div className="hidden md:flex items-center"><div className="h-12 border-l border-gray-200 mx-2"></div></div>
            {/* Stat 3 */}
            <div className="flex-1 flex flex-col items-center text-center px-2 md:px-4 max-w-xs mx-auto bg-white/80 rounded-xl shadow-md py-4">
              ...
              <span className="text-sm md:text-base font-medium text-gray-500 mt-1">Successful thesis<br className='hidden md:block'/>defenses supported</span>
            </div>
            {/* Divider */}
            <div className="hidden md:flex items-center"><div className="h-12 border-l border-gray-200 mx-2"></div></div>
            {/* Stat 4 */}
