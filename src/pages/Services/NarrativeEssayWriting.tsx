    ...
    const services = [
        {
            ...
            description: 'Transform real-life events into compelling stories. Our writers craft deeply personal essays that highlight growth and emotional insight with vivid authenticity.',
            features: ['First-person storytelling', 'Vivid scene-setting', 'Emotional resonance', 'Meaningful theme development'],
            cta: 'Write My Personal Essay',
            popular: true,
        },
        {
            emoji: '🎯',
        ...
        },
        {
            ...
            description: 'Explore relationships between events and their outcomes. Perfect for analyzing consequences and meaningful connections.',
        ...
        },
        {
            ...
            description: 'Compelling essays that win funding. Highlight achievements and demonstrate powerfully why you deserve support.',
