...
const PriceCalculator = () => {
    ...
    const calculatePrice = () => {
        const base = baseRates[academicLevel] || 18.00;
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-sm">Expert humanities homework help starting at just $14.00/page. Pricing updates in real time — zero hidden fees.</p>
            </div>
            <div className="space-y-6">
                ...
                <div className="bg-[#0B1F42]/5 rounded-2xl p-6 border border-[#0B1F42]/10">
                    ...
                    >
                        Do My Humanities Homework <ArrowRight className="w-5 h-5" />
                    </Link>
    ...
    const services = [
        {
            emoji: '🧠',
            title: 'Psychology',
            description: 'We help you understand ancient cultures, past societies, and human behavior perfectly. We provide deep qualitative research academic help.',
            features: ['Human behavior', 'Qualitative research', 'Step by step explanations', 'Liberal arts coursework'],
            cta: 'Get Psychology Help',
            slug: '/homework-help/humanities/psychology',
            popular: true,
        },
        {
            emoji: '🏛️',
            title: 'History',
            description: 'Humanities is a vast subject that deals with different aspects of society and culture. It includes human psychology, history, and studying ancient civilizations.',
            features: ['Ancient civilizations', 'Past societies', 'Society and culture', 'History facts'],
            cta: 'Get History Help',
            slug: '/homework-help/humanities/history',
            popular: true,
        },
        {
            emoji: '👥',
            title: 'Sociology',
            description: 'Our experts handle advanced social concepts. We provide accurate interdisciplinary studies answers for your hardest classes.',
            features: ['Social concepts', 'Interdisciplinary studies', 'Hardest classes', 'Advanced answers'],
            cta: 'Get Sociology Help',
            slug: '/homework-help/humanities/sociology',
            popular: true,
        },
        {
            emoji: '🤔',
            title: 'Philosophy',
            description: 'Philosophy looks into the formation and foundations of knowledge, existence, and reality. You can always trust our experts to craft logical arguments.',
            features: ['Foundations of knowledge', 'Existence and reality', 'Logical arguments', 'Perfect coursework'],
            cta: 'Get Philosophy Help',
            slug: '/homework-help/humanities/philosophy',
            popular: false,
        },
        {
            emoji: '🗳️',
            title: 'Political Science',
            description: 'We provide deep qualitative research academic help and step by step explanations. We are the best website to pay for humanities coursework worldwide.',
            features: ['Qualitative research', 'Academic help', 'Coursework worldwide', 'Step by step'],
            cta: 'Get Political Science Help',
            slug: '/homework-help/humanities/political-science',
            popular: false,
        },
        {
            emoji: '🌍',
            title: 'Anthropology',
            description: 'We act as a reliable cultural studies homework solutions guide. We help you understand ancient cultures and past societies perfectly.',
            features: ['Cultural studies', 'Homework solutions', 'Ancient cultures', 'Past societies'],
            cta: 'Get Anthropology Help',
            slug: '/homework-help/humanities/anthropology',
            popular: false,
        },
        {
            emoji: '📚',
            title: 'English Literature',
            description: 'We explore human language and expression with you. Our tutors cover literature studies and linguistics. Literature is a form of art in a written format.',
            features: ['Language and expression', 'Literature studies', 'Linguistics help', 'Written format art'],
            cta: 'Get Literature Help',
            slug: '/homework-help/humanities/english-literature',
            popular: false,
        },
        {
            emoji: '🗺️',
            title: 'Geography',
            description: 'College classes require you to understand many different aspects of society. We provide accurate interdisciplinary studies answers.',
            features: ['College classes', 'Interdisciplinary studies', 'Accurate answers', 'Society aspects'],
            cta: 'Get Geography Help',
            slug: '/homework-help/humanities/geography',
            popular: false,
        },
        {
            emoji: '🎓',
            title: 'Education',
            description: 'If you are asking who can help me with my university humanities homework, we provide excellent humanities essay writing assistance so your work is highly professional.',
            features: ['University homework', 'Essay writing', 'Highly professional', 'Excellent assistance'],
            cta: 'Get Education Help',
            slug: '/homework-help/humanities/education',
            popular: false,
        },
        {
            emoji: '🤝',
            title: 'Social Work',
            description: 'Our experts handle advanced social concepts. You can always trust our experts to deliver perfect liberal arts coursework assistance.',
            features: ['Social concepts', 'Liberal arts', 'Coursework assistance', 'Trust our experts'],
            cta: 'Get Social Work Help',
            slug: '/homework-help/humanities/social-work',
            popular: false,
        },
    ];
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function HumanitiesHomeworkHelp() {
    return (
        <>
            <Helmet>
                <title>Best Humanities Homework Help | Humanities Homework Solver</title>
                <meta name="description" content="Need to pay for humanities homework? Get reliable online humanities coursework help and liberal arts coursework assistance from our expert team today." />
                <meta name="keywords" content="humanities homework help, pay for humanities homework, humanities homework solver, online humanities coursework help, liberal arts coursework assistance" />
            </Helmet>
            <div className="min-h-screen bg-white font-sans">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-5xl mx-auto text-center mb-10">
                            ...
                            <h1 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-[#0B1F42] mb-10 leading-[1.2] tracking-tight">
                                Professional Humanities Homework Help Online
                            </h1>
                            <p className="text-[20px] text-gray-600 mb-14 max-w-3xl mx-auto leading-[1.9] font-medium opacity-90">
                                Are you struggling with history, literature, or culture topics? Use our humanities homework writing service today. Just ask us to do my humanities homework and get perfect grades every time.
                            </p>
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
                                {[
                                    ...
                                    { value: '1500+', label: 'Verified Experts', color: 'text-[#1652A0]' },
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                                    Why Choose Our Humanities Homework Help Service?
                                </h2>
                                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                                    We offer the best humanities homework help for university students tackling demanding coursework. Here is why students worldwide trust us to help them get better grades.
                                </p>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <div className="lg:col-span-2 bg-gradient-to-br from-[#0B1F42] to-[#1652A0] p-10 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-gray-300 text-lg mb-6 leading-loose">
                                            We offer strict guarantees for completely original work. You get <span className="text-white font-bold">custom answers built from scratch</span> with <span className="text-white font-bold">zero copied content</span>. Every order includes a <span className="text-white font-bold">free originality report</span> to prove your work is unique and safe. We guarantee zero artificial intelligence involvement in your coursework.
                                        </p>
                                        <div className="grid grid-cols-2 gap-4 mb-6">
                                            {[
                                                ...
                                                { icon: Ruler, color: 'text-yellow-300', title: 'Built From Scratch', sub: 'Custom answers guaranteed' },
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-[#1652A0]">
                                    ...
                                    <p className="text-gray-600 leading-loose mb-6">
                                        We hire experienced professionals with advanced degrees. Finding an affordable college humanities homework solver is easy with us. They provide highly accurate arts and humanities academic support to make sure you get top grades easily.
                                    </p>
                                    <ul className="space-y-3">
                                        {['Experienced professionals', 'Advanced degrees', 'Affordable homework solver', 'Get top grades easily'].map((item, i) => (
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-purple-500">
                                    ...
                                    <ul className="space-y-3">
                                        {['Never miss a deadline', 'Fast delivery options', 'Avoid late penalties', 'Rush orders accepted'].map((item, i) => (
                                            <li key={i} className="flex items-center text-gray-700 font-medium">
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-orange-500">
                                    ...
                                    <p className="text-gray-600 leading-loose mb-6">
                                        Do you need a critical thinking coursework solver right now? Our customer support team works around the clock. You can chat directly with your tutor to share ideas and ask questions about your topics.
                                    </p>
                                    <ul className="space-y-3">
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-red-500">
                                    ...
                                    <p className="text-gray-600 leading-loose mb-6">
                                        Your happiness is our main goal. We offer a free unlimited revision period so your coursework turns out exactly as you want without any extra charges.
                                    </p>
                                    <ul className="space-y-3">
                                        {['Unlimited revision period', 'Ensures your happiness', 'Turn out exactly as wanted', 'Zero extra charges'].map((item, i) => (
                                            <li key={i} className="flex items-center text-gray-700 font-medium">
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all border-2 border-gray-100 group hover:border-indigo-500">
                                    ...
                                    <p className="text-gray-600 leading-loose mb-6">
                                        Your personal details are completely safe with us. We protect your academic data with strong encryption when you pay someone to do my humanities homework online.
                                    </p>
                                    <ul className="space-y-3">
                            ...
                            <div className="mt-16 text-center">
                                ...
                                >
                                    Get My Humanities Homework Done Today <ArrowRight className="w-5 h-5" />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-7xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <h2 className="text-3xl md:text-5xl font-extrabold text-[#0B1F42] mb-6">
                                    Humanities Homework Help & Other Academic Services
                                </h2>
                                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8]">
                                    At EssayEmbassy, we specialize in providing top quality college humanities homework help. Humanities is a vast subject that deals with different aspects of society and culture. It includes human psychology, history, and studying ancient civilizations. When you find yourself thinking "I need to pay for humanities homework", we are here for you. We are the best website to pay for humanities coursework worldwide.
                                </p>
                                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8] mt-4">
                                    If you need to hire an expert for liberal arts coursework, our team is ready. We provide deep qualitative research academic help and step by step explanations. We help you understand ancient cultures, past societies, and human behavior perfectly. We explore human language and expression with you. Our tutors cover literature studies and linguistics. Literature is a form of art in a written format.
                                </p>
                                <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-[1.8] mt-4">
                                    Our experts handle advanced social concepts. We provide accurate interdisciplinary studies answers and act as a reliable cultural studies homework solutions guide for your hardest classes. Philosophy looks into the formation and foundations of knowledge, existence, and reality. You can always trust our experts to craft logical arguments and deliver perfect liberal arts coursework assistance.
                                </p>
                            </div>
                            <HumanitiesServicesGrid />
                            <div className="mt-12 bg-gray-50 rounded-2xl p-10 text-center border border-gray-200">
                                <h3 className="text-2xl font-bold text-[#0B1F42] mb-3">Ready to Get Top Grades on Your Humanities Homework?</h3>
                                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                                    Every solution is built by a verified expert — accurate research, clear arguments, and proper formatting included.
                                </p>
                                <Link
                                    to="/order-now"
                                ...
                                >
                                    Order Humanities Homework Help Now <ArrowRight className="w-5 h-5" />
                                </Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                                    A streamlined four-step process designed to get your humanities homework completed and submitted on time. Get started in minutes.
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        ...
                                        desc: 'Fill out our simple order form. Upload your instructions and tell us your deadline. If you want to say "do my college humanities homework for me", just let us know here.',
                                    ...
                                    },
                                    {
                                        ...
                                        desc: 'We match you with an expert who understands your exact subject. Your writer will conduct in-depth research to fully understand your specific topic.',
                                        highlight: 'Subject-matched expert',
                                        features: ['Expert profiles', 'Subject-area match', 'In-depth research', 'Understand your topic'],
                                    },
                                    {
                                        ...
                                        desc: 'Stay in touch with your tutor. You can chat with your expert in real time to monitor the progress of your coursework and ask questions.',
                                    ...
                                    },
                                    {
                                        ...
                                        desc: 'Receive your completed task exactly on the date you specified. Download your finished files and submit your coursework with total confidence.',
                            ...
                            <div className="text-center bg-[#0B1F42] rounded-2xl p-10">
                                <h3 className="text-2xl font-bold text-white mb-3">Ready to Get Top Grades on Your Humanities Homework?</h3>
                            ...
                            <div className="grid lg:grid-cols-2 gap-16 items-center">
                                <div>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">
                                        Affordable Humanities Homework Help Pricing
                                    </h2>
                                    <p className="text-lg text-gray-600 mb-8 leading-loose">
                                        Our rates start very low at just $14 per page. Prices depend on the difficulty of the task and your deadline.
                                    </p>
                                    <div className="space-y-4">
                                        {[
                                            { icon: DollarSign, title: 'Transparent Pricing', desc: 'Our rates start very low at just $14 per page. Prices depend on the difficulty of the task and your deadline.' },
                                            ...
                                            { icon: Award, title: 'Free Features Included', desc: 'Get free formatting, a title page, and a free plagiarism report with every order.' },
                                            { icon: Shield, title: 'Satisfaction Promise', desc: 'We offer free revisions and a clear refund process to protect your funds.' },
                                        ].map((item, i) => (
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-[1.8]">
                                    Commitments we take seriously with every humanities homework order we write and deliver.
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        ...
                                        description: 'Our experts write perfectly structured papers. We make sure your research and cultural facts are completely accurate.',
                                    },
                                    {
                                        icon: Clock,
                                        title: 'On Time Delivery',
                                        description: 'We always meet your deadlines so you can submit your coursework on time.',
                                    },
                                    {
                                        icon: RefreshCw,
                                    ...
                                    },
                                    {
                                        icon: Lock,
                                        title: 'Privacy First',
                                        description: 'Strict confidentiality policies keep your academic and payment data completely safe.',
                                    },
                                ].map((item, i) => (
                            ...
                            <div className="text-center bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8">
                                <h3 className="text-2xl font-bold mb-3">We Stand Behind Every Humanities Coursework We Deliver</h3>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-6xl mx-auto">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-[1.8]">
                                    Authentic reviews from verified students who improved their grades with our humanities homework help.
                                </p>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[
                                    { name: 'Lucas S.', tag: 'Verified', date: 'Oct 12, 2025', subject: 'Literature', rating: 5, text: 'I had to ask them to do my college humanities homework for me. The research was perfect. This is the best humanities homework writing service online.' },
                                    { name: 'Fahid B.', tag: 'Returning Client', date: 'Nov 02, 2025', subject: 'World History', rating: 5, text: 'I needed to pay someone to do my humanities homework online. The history facts were completely accurate and delivered early.' },
                                    { name: 'Johanna T.', tag: 'First-Time User', date: 'Nov 18, 2025', subject: 'Philosophy', rating: 4.9, text: 'I asked who can help me with my university humanities homework and they answered instantly. I will definitely use this service here again.' },
                                    { name: 'Ryan P.', tag: 'Returning Client', date: 'Dec 05, 2025', subject: 'Anthropology', rating: 5, text: 'Long time fan here. I decided to hire an expert for liberal arts coursework and they delivered fast. This is the best website to pay for humanities coursework.' },
                                    { name: 'Darious D.', tag: 'Verified', date: 'Jan 14, 2026', subject: 'Sociology', rating: 5, text: 'I needed college humanities homework help for my class. The reading responses were deeply engaging and very professional.' },
                                    { name: 'Liam K.', tag: 'First-Time User', date: 'Feb 22, 2026', subject: 'Linguistics', rating: 4.8, text: 'If you need an affordable college humanities homework solver online, use this site. They provided great language structure answers.' },
                                ].map((review, i) => (
                ...
                <section className="py-24 bg-gray-50">
                    <div className="container mx-auto px-4 max-w-5xl">
                        ...
                        <div className="space-y-4">
                            <FAQItem
                                question="Can I pay someone to do my humanities homework?"
                                answer="Yes, you can absolutely pay us to complete your tasks. Our experts are ready to provide reliable and affordable help online so you can get better grades easily."
                            />
                            <FAQItem
                                question="How much does it cost to hire a humanities homework solver?"
                                answer="Our pricing starts at just $14 per page. A simple high school essay costs less than a complex university research project. Ordering early ensures the best price."
                            />
                            <FAQItem
                                question="Who can do my liberal arts coursework online?"
                                answer="Our team of qualified professionals can handle your workload. We hire experts with master and doctoral degrees to ensure you receive the best online humanities coursework help available."
                            />
                            <FAQItem
                                question="Are humanities homework writing services confidential?"
                                answer="Yes. We keep your personal details completely private and never share them with third parties without your permission. It is entirely safe to use our website for your school tasks."
                            />
                            <FAQItem
                                question="How fast can I get my college humanities homework done?"
                                answer="Our professional writers can handle urgent tasks easily. We can complete your order quickly and offer fast turnaround options to help you avoid last minute stress."
                            />
                            <FAQItem
                                question="Where can I find accurate answers for my humanities coursework?"
                                answer="You can find the best sociology and philosophy solutions right here. We offer student friendly prices and highly accurate work for all advanced degrees."
                            />
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-loose">
                                Stop stressing over your social studies and arts coursework. Let our professional experts handle your research, essays, and reading reviews. Get reliable humanities homework help today.
                            </p>
                            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
                                ...
                                >
                                    Start Your Humanities Homework Now <ArrowRight className="w-5 h-5" />
                                </Link>
                                <Link
                                    to="/samples"
