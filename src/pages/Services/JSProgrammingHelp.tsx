  ...
  const testimonials = [
    {
      id: 'EE-24467',
      rating: 4,
      text: "Didn't really trust programming help services at first, but this changed my mind. Super clean, well-written JavaScript code. glad I gave them a shot.",
      date: '04/14/2025',
      level: 'Masters',
    },
    {
      id: 'EE-23901',
      rating: 5,
      text: 'Was in a total panic with my JavaScript assignment deadline. They not only delivered fast but the code was actually solid. Big lifesaver!',
      date: '03/16/2025',
      level: 'Bachelors',
    },
    {
      id: 'EE-57281',
      rating: 4,
      text: 'Needed this JavaScript project fast and they came through big time. Everything from the structure to the implementation was on point. Really solid work.',
      date: '06/16/2025',
      level: 'Bachelors',
    },
    {
      id: 'EE-19822',
      rating: 5,
      text: 'I was skeptical but the JavaScript expert was super communicative and the result was great. Will use again.',
      date: '02/10/2025',
      level: 'PhD',
    },
    {
      id: 'EE-33412',
      rating: 5,
      text: 'Essay Embassy made my JavaScript programming life so much easier. The quality was top-notch and the support team was very helpful.',
      date: '01/22/2025',
      level: 'Masters',
    },
    {
      id: 'EE-11234',
      rating: 4,
      text: 'Good service, quick turnaround, and the JavaScript code passed all checks. Would recommend.',
      date: '05/05/2025',
      level: 'College',
    },
  ];
...
function ServicesTabComponent() {
  ...
  const paperwork = [
    'Essay Writing',     'Paper Writing Services',     'Dissertation Writing Services',     'Research Proposal',     'Thesis Writing',     'Scholarship Essay',     'Argumentative Essay',     'Admission Essay',     'Admission Essay Writing',     'Case Study',     'Homework Help',     'Programming Help',     'Python Programming Help',     'Java Programming Help',     'JS Programming Help',     'Assignment Help',     'Narrative Essay'
  ];
  const coursework = [
    'Essay Writing',     'Paper Writing Services',     'Dissertation Writing Services',     'Case Study',     'Homework Help',     'Programming Help',     'Python Programming Help',     'Java Programming Help',     'JS Programming Help',     'Assignment Help'
  ];
  const other = [
    'Paper Writing Services',     'Dissertation Writing Services',     'Thesis Writing',     'Scholarship Essay',     'Argumentative Essay',     'Admission Essay',     'Admission Essay Writing'
  ];
...
export default function JSProgrammingHelp() {
  ...
  return (
    <div className="background-icons min-h-screen" style={{ fontFamily: 'Inter, sans-serif', backgroundColor: '#F7FAFC' }}>
        ...
        <main className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600">
              Looking for a reliable expert to help with JavaScript programming? Hire our professional programmer and be done with your JavaScript assignments.
            </p>
            {/* Ratings */}
      ...
      {/* Your Assignment Help journey Block */}
      <section className="w-full bg-[#F7FAFC] py-12">
            ...
            <div className="flex-1 w-full">
              ...
              <div className="bg-white/80 rounded-3xl shadow-lg p-4 md:p-8">
                <div className="space-y-2">
                  {[
                    {
                      question: 'Is your JavaScript programming help service confidential and safe?',
                    ...
                    {
                      question: 'How quickly can you complete my JavaScript assignment?',
                      answer: 'We offer flexible deadlines starting from 3 hours for urgent assignments. The timeframe depends on the complexity and length of your JavaScript project. You can choose the deadline that works best for you.'
                    },
                    {
                      question: 'What if I\'m not satisfied with my JavaScript programming assignment?',
                      answer: 'We offer unlimited free revisions until you\'re completely satisfied. If you\'re still not happy, we provide a full refund. Your satisfaction is guaranteed.'
                    },
                    {
                      question: 'Do your JavaScript experts have real programming experience?',
                      answer: 'Yes, all our JavaScript experts are experienced programmers with degrees in computer science or related fields. They have practical experience in web development, Node.js, React, and other JavaScript frameworks.'
                    },
                    {
                      question: 'Can you help with advanced JavaScript concepts like ES6+ and frameworks?',
                      answer: 'Absolutely! Our experts are proficient in modern JavaScript (ES6+), React, Vue.js, Angular, Node.js, and other popular frameworks. We can handle both basic and advanced JavaScript programming tasks.'
                    },
                    {
                      question: 'Will my JavaScript code be original and plagiarism-free?',
                      answer: 'Yes, all code is written from scratch by our experts. We provide a free plagiarism report with every assignment to guarantee originality and academic integrity.'
                    }
                  ].map((faq, idx) => {
