  ...
  const services = [
    {
      ...
      description: 'Expert comparison essays that examine similarities and differences between two or more subjects. We master both the point-by-point format and the block method to match your assignment perfectly.',
      features: ['Point-by-point & block method', 'Strong comparison structure', 'Balanced, objective analysis', 'Free Turnitin & GPTZero reports'],
      cta: 'Write My Comparison Essay',
      popular: true,
    },
    {
      emoji: '🎯',
