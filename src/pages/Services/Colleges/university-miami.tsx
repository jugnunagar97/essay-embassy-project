      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Hurricane Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF MIAMI)
// ==========================================

export const umiamiCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "The University of Miami is a private research university in Coral Gables with Herbert Business School, College of Engineering, and marine- and health-science research in South Florida.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Miami coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Herbert & Engineering Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const umiamiStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=328",
    caption: "QS 2026; marine science, business, and health pathways",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Herbert Business, Engineering, and Arts & Sciences expectations",
  },
  {
    icon: "dollar",
...
export const umiamiAlert: AlertBanner = {
  title: "Coral Gables Semester Alert:",
  body: "Miami's semester pace stacks Herbert cases, engineering labs, and communication projects—especially when internships intensify before fall and spring finals on Blackboard.",
};

export const umiamiCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Coral Gables campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Herbert Business School group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Engineering capstones, Herbert Business School presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const umiamiDepartments: Department[] = [
  {
    icon: "chart",
    name: "Herbert Business School",
    courses: ["ACC 201", "FIN 302", "MKT 301", "MAS 310"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["CAE 100", "ECE 201", "BME 210", "CSC 120"],
  },
  {
    icon: "quote",
    name: "School of Communication",
    courses: ["COM 101", "JMM 102", "STG 201", "RTF 101"],
  },
  {
    icon: "book",
    name: "College of Arts and Sciences",
    courses: ["PSY 110", "ECO 211", "ENG 105", "BIL 150"],
  }
];

export const umiamiProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Herbert Business Cases",
    subtitle: "Finance and analytics with executive clarity",
    bullets: [
      "Case memos with exhibits and quantified recommendations.",
      "Marketing plans with measurable KPIs.",
      "Professional tone for Herbert presentation standards.",
    ],
    footnote: "Herbert cases must be concise and analytical—not descriptive overviews.",
  },
  {
    icon: "brain",
    title: "Engineering & Computing",
    subtitle: "Labs and project documentation",
    bullets: [
      "BME and ECE lab reports with clear methodology.",
      "CSC project write-ups explaining design and testing.",
      "Technical vocabulary aligned to Miami engineering rubrics.",
    ],
    footnote: "Engineering faculty expect reproducible logic—we explain every step.",
  },
  {
    icon: "quote",
    title: "Communication & Marine Science",
    subtitle: "Media-aware and science-based writing",
    bullets: [
      "JMM stories with credible sourcing and structure.",
      "BIL lab reports with field data and discussion.",
      "APA citations across psychology and science courses.",
    ],
    footnote: "Miami's strengths span media and science—we match each rubric precisely.",
  }
];

export const umiamiServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const umiamiSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UM-204",
    name: "Valentina R.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "Herbert case during internship recruiting. Memo was quantitative and Blackboard-ready.",
  },
  {
    id: "UM-517",
    name: "Chris M.",
    ...
    quote: "Lab rubric wanted detailed methods. Writer delivered before exam crunch week.",
  },
  {
    id: "UM-339",
    name: "Laura G.",
    ...
    rating: 5,
    course: "JMM 102",
    serviceUsed: "Media Analysis",
    semester: "Fall 2024",
    quote: "Media analysis needed theory plus current campaigns. Draft needed only light edits.",
  }
];

export const umiamiSampleFaq: FaqItem[] = [
  {
    question: "Do you support Blackboard at the University of Miami?",
    answer: "Yes. Provide your Blackboard rubric and we align format and citations.",
  },
  {
    question: "Can you help international students with academic English?",
    answer: "We polish grammar and flow while preserving your analytical voice.",
  },
  {
    question: "Is work original for Miami academic integrity?",
    answer: "All content is custom-written from your prompt with no recycled papers.",
  },
  {
    question: "Do you cover marine and life science labs?",
    answer: "Yes. Science specialists handle BIL and related lab coursework.",
  }
];

export const umiamiSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Coral Gables Crunch?",
  name: "Marcus",
...
export const umiamiSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Miami Semester Overwhelm You",
  subtitle: "Hurricanes trust Essay Embassy when Blackboard deadlines and internship weeks collide. Stay on track through peak semesters.",
...
export default function UniversityMiami() {
  return (
    <>
      <title>University of Miami Essay Help | UM Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for University of Miami students. Support for Herbert business cases, engineering labs, and communication coursework."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-miami/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={umiamiCollegeData} />
          <Stats stats={umiamiStats} />
          <Alert data={umiamiAlert} />
          <CalendarSection
            eyebrow="Miami academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Hurricane deadline peaks across Herbert, engineering, and communication."
            periods={umiamiCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Miami's Academic Core"
            subtitle="From the Rock to engineering labs, we match Hurricane faculty standards."
            departments={umiamiDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Miami's Selective Standards"
            subtitle="With a top-330 QS global rank, Miami expects polished, well-argued academic work."
            cards={umiamiProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Hurricanes"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={umiamiServiceCards}
          />
          <Testimonials
            eyebrow="Hurricanes succeeding"
            title="What Miami Students Tell Us"
            subtitle="Feedback from Hurricanes balancing Herbert cases, engineering labs, and media assignments."
            items={umiamiSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Miami coursework."
            items={umiamiSampleFaq}
            support={umiamiSampleFaqSupport}
          />
          <BottomCta data={umiamiSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
