...
// ==========================================
// TAILORED DATA (DUKE UNIVERSITY)
// ==========================================

export const dukeCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  shortCode: "DUKE",
  heroTitle: "Duke University Essay & Assignment Help",
  location: "Durham, North Carolina",
  type: "Top-Tier Private Research University",
  studentsLabel: "Trusted by Duke Blue Devils",
  description:
    "Specialized academic writing support built for Duke students navigating the rigorous demands of Trinity College, the Pratt School of Engineering, and Sanford. Whether you are analyzing public policy or drafting a biology lab report, our expert writers know exactly what Duke professors expect.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Duke coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Trinity & Pratt Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const dukeStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#5",
    caption: "Elite global QS ranking by subject",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "130+",
    caption: "Experts familiar with Trinity, Pratt, and Sanford expectations",
  },
  {
    icon: "dollar",
...
export const dukeAlert: AlertBanner = {
  title: "Durham Semester Pace Alert:",
  body: "Duke's academic environment means assignments pile up rapidly. From rigorous Trinity writing requirements to Pratt engineering midterms in October and March, the workload is intense. Lock in your specialized writer before the campus-wide crunch hits.",
};

export const dukeCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Trinity humanities papers, Sanford policy briefs, and Pratt lab milestones converge. The fast pace hits hard right before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, deep research papers, and crucial final projects stack up in early December just before winter break.",
  ...
  },
  {
    ...
    body: "The spring semester pressure peaks with intensive psychology reviews, math problem sets, and Fuqua group project evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Pratt engineering capstones, Fuqua final presentations, and comprehensive Trinity theses are due. Demand for top writers is at its peak.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const dukeDepartments: Department[] = [
  {
    icon: "book",
    name: "Trinity College of Arts & Sciences",
    courses: ["WRITING 101", "POLSCI 145", "BIOLOGY 201L", "ECON 101"],
  },
  {
    icon: "brain",
    name: "Pratt School of Engineering",
    courses: ["EGR 101L", "BME 244L", "ME 221L", "ECE 110L"],
  },
  {
    icon: "quote",
    name: "Sanford School of Public Policy",
    courses: ["PUBPOL 155", "PUBPOL 301", "PUBPOL 590"],
  },
  {
    icon: "chart",
    name: "Fuqua School of Business",
    courses: ["ACCOUNTG 590", "FINANCE 645", "MGMT 738"],
  },
];

export const dukeProfessorCards: ProfessorIntel[] = [
  {
    icon: "book",
    title: "Trinity Humanities & Sciences",
    subtitle: "Deep theoretical engagement for top-ranked programs",
    bullets: [
      "Thesis-driven essays that engage critically with course readings in political science, history, and economics.",
      "Perfectly formatted citations including APA, Chicago, or MLA styles.",
      "Original argumentation, not just summary, showing deep comprehension of complex lectures.",
    ],
    footnote:
      "Trinity professors expect nuanced academic writing. We match this elite standard with profound and well-researched papers.",
  },
  {
    icon: "brain",
    title: "Pratt Engineering & Tech",
    subtitle: "Precision lab reports and clean technical methodology",
    bullets: [
      "Rigorous adherence to technical lab report structures expected by Duke TAs.",
      "Clear, step-by-step methodology explanations and data visualizations.",
      "Accurate technical terminology appropriate for rigorous STEM courses.",
    ],
    footnote:
      "Pratt professors care about reproducible methods and clear technical communication. We help you explain the math and code perfectly.",
  },
  {
    icon: "quote",
    title: "Sanford Public Policy",
    subtitle: "Evidence-based policy memos and analytical briefs",
    bullets: [
      "Executive summaries that get straight to the data and policy recommendations.",
      "Integration of political, economic, and social frameworks.",
      "Clear, professional tone that Sanford professors expect for real-world policy readiness.",
    ],
    footnote:
      "Sanford graders penalize fluff heavily. We ensure your analyses are concise, data-driven, and highly analytical to stand out.",
  },
];

export const dukeServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
  ...
  },
  {
    ...
    body: "In-depth research papers spanning STEM, humanities, public policy, and business. Properly sourced, cited, and formatted to your institution's standards.",
...
export const dukeSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "DUKE-204",
    name: "Sarah M.",
    major: "Public Policy",
    ...
    semester: "Fall 2024",
    quote:
      "The grading curve at Sanford is tough, and I had a major policy memo due the same week as my economics midterm. The writer perfectly nailed the formatting and the executive summary was spotless. Saved my grade.",
  },
  {
    id: "DUKE-517",
    name: "David L.",
    ...
    rating: 5,
    course: "BME 244L",
    serviceUsed: "Technical Report",
    semester: "Spring 2024",
    quote:
      "Writing up the documentation and data analysis for my engineering project was taking way too long. The writer broke down my methodology clearly and formatted it exactly to Pratt's lab standards.",
  },
  {
    id: "DUKE-339",
    name: "Chloe T.",
    ...
    rating: 4,
    course: "BIOLOGY 201L",
    serviceUsed: "Research Paper",
    semester: "Fall 2024",
    quote:
      "Duke's biology department is top-tier so I was nervous about outsourcing. The paper cited recent journals in perfect APA format and drew great connections. Just needed a tiny edit on the thesis statement.",
  },
  {
    id: "DUKE-712",
    name: "Javier R.",
    ...
    rating: 5,
    course: "POLSCI 145",
    serviceUsed: "Analytical Essay",
    semester: "Spring 2025",
    quote:
      "My professor expects extremely deep readings of complex texts. I did not have the time because of my extracurriculars. The essay I got back was profound, well-argued, and did not use any generic filler.",
  },
  {
    id: "DUKE-088",
    name: "Emily W.",
    ...
    rating: 5,
    course: "ECON 101",
    serviceUsed: "Case Study Analysis",
    semester: "Fall 2024",
    quote:
      "Had a 15-page market entry strategy due and I was drowning. The writer used real data, formatted the analysis beautifully, and made it sound like an actual consulting deliverable. Unbelievable quality.",
  },
  {
    id: "DUKE-631",
    name: "Jason H.",
    ...
    rating: 5,
    course: "ECE 110L",
    serviceUsed: "Lab Write-up",
    semester: "Spring 2025",
    quote:
      "Engineering lab reports back-to-back are a nightmare. I sent over my raw data and the rubric. The results and discussion sections came back flawless, explaining the circuit performance perfectly.",
  },
];

export const dukeSampleFaq: FaqItem[] = [
  {
    question:
      "Are your writers familiar with Duke's specific program requirements?",
    answer:
      "Yes. Duke's academic landscape is diverse. From the quantitative rigor of Pratt to the deep humanities focus of Trinity and Sanford. We match your assignment with writers who hold degrees in your specific discipline and understand the difference in grading rubrics across the university.",
  },
  {
    question:
      "I am an international student at Duke. Can you help me meet the language expectations?",
    answer:
      "Absolutely. If you gained admission to Duke meeting the demanding SAT 1490+, TOEFL 100+, or IELTS 7+ requirements, you are expected to write at a very high academic level. Our native English-speaking experts help bridge any gaps, ensuring your ideas are communicated flawlessly without losing your unique voice.",
  },
  {
    question: "Will my paper pass Turnitin and Duke's strict academic integrity checks?",
    answer:
      "100 percent. Duke has a zero-tolerance policy for plagiarism. Every assignment we deliver is written entirely from scratch based on your specific prompt and syllabus. We never use recycled content, essay banks, or AI generation. You will receive a fully original document that passes Turnitin checks with flying colors.",
  },
  {
    question:
      "Can you handle complex formatting like Sanford policy briefs or Pratt lab reports?",
    answer:
      "Yes. Our team includes specialists who know how to format executive summaries for policy briefs, technical IEEE reports for engineering, and standard APA or Chicago styles for Trinity research papers. Just attach your professor's instructions and we will follow them to the letter.",
  },
];

export const dukeSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Durham Crunch?",
  name: "Marcus",
  role: "Academic Support Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Academic Support Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const dukeSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Duke Semester Overwhelm You",
  subtitle:
    "Thousands of Blue Devils trust Essay Embassy when the Gothic campus gets busy and deadlines overlap. Keep your grades high while navigating the fast pace of Durham.",
...
export default function DukeUniversity() {
  return (
    <>
      <title>
        Duke University Essay Help | Duke Assignment Writing Service
      </title>
      <meta
        name="description"
        content="Expert academic writing for Duke University students. Tailored support for Trinity research papers, Pratt engineering labs, and Sanford policy briefs."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/duke-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={dukeCollegeData} />
          <Stats stats={dukeStats} />
          <Alert data={dukeAlert} />
          <CalendarSection
            eyebrow="Duke academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="The fast-paced Durham environment means assignments stack up fast. Get ahead of Trinity, Pratt, and Sanford deadlines."
            periods={dukeCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering the Entire Gothic Campus"
            subtitle="From West Campus to the engineering quads, we know what your professors expect."
            departments={dukeDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Duke's Elite Standards"
            subtitle="With a top-62 global ranking, Duke sets a high bar. Our writers understand exactly what it takes to excel across all schools."
            cards={dukeProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Blue Devils"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={dukeServiceCards}
          />
          <Testimonials
            eyebrow="Blue Devils succeeding"
            title="What Duke Students Tell Us"
            subtitle="Real feedback from Duke students navigating the semester grind across Trinity, Sanford, and Pratt."
            items={dukeSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Duke coursework."
            items={dukeSampleFaq}
            support={dukeSampleFaqSupport}
          />
          <BottomCta data={dukeSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
