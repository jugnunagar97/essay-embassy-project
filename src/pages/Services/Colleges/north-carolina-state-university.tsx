      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Wolfpack Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (NORTH CAROLINA STATE UNIVERSITY)
// ==========================================

export const ncstateCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  type: "STEM-Forward Public Research University",
  studentsLabel: "Trusted by NC State Wolfpack",
  description:
    "NC State is a public research university in Raleigh built around engineering, agriculture, and Poole College of Business—Think and Do project culture with heavy lab and design documentation.",
  cta: {
    primary: { href: "/order-now", label: "Get help for NC State coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Poole & Engineering Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const ncstateStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#275",
    caption: "QS 2026; engineering and agriculture research strengths",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Poole, Engineering, and CALS expectations",
  },
  {
    icon: "dollar",
...
export const ncstateAlert: AlertBanner = {
  title: "Raleigh Semester Alert:",
  body: "NC State's Think and Do pace means Poole team projects, engineering design labs, and CALS reports converge before October and April finals. Wolfpack midterms fill calendars fast.",
};

export const ncstateCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Agriculture and Life Sciences assignments, and College of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Raleigh campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Poole College of Management group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Engineering capstones, Poole College of Management presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const ncstateDepartments: Department[] = [
  {
    icon: "chart",
    name: "Poole College of Management",
    courses: ["BUS 320", "FIN 311", "MIE 310", "ACC 200"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["E 101", "MAE 206", "ECE 200", "CSC 216"],
  },
  {
    icon: "users",
    name: "College of Agriculture and Life Sciences",
    courses: ["AG 101", "ANS 150", "BIO 181", "ST 311"],
  },
  {
    icon: "book",
    name: "Humanities and Social Sciences",
    courses: ["PSY 200", "EC 201", "POL 201", "ENG 101"],
  }
];

export const ncstateProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Poole Business & Analytics",
    subtitle: "Team-ready case deliverables",
    bullets: [
      "Operations and finance cases with quantified recommendations.",
      "Professional memos for Poole presentation rubrics.",
      "Data exhibits ready for Moodle submission.",
    ],
    footnote: "Poole emphasizes applied business reasoning—we keep cases practical and sourced.",
  },
  {
    icon: "brain",
    title: "Engineering & CSC",
    subtitle: "Design labs and coding documentation",
    bullets: [
      "MAE and ECE lab reports with design justification.",
      "CSC 216 project documentation explaining architecture and tests.",
      "Technical vocabulary aligned to NC State engineering faculty.",
    ],
    footnote: "Think and Do means showing your work—we document process and outcomes clearly.",
  },
  {
    icon: "users",
    title: "CALS & Social Science",
    subtitle: "Applied science and policy writing",
    bullets: [
      "CALS lab reports with field data and discussion.",
      "Economics and policy essays using current evidence.",
      "APA citations across psychology and agricultural sciences.",
    ],
    footnote: "CALS assignments often blend science with real-world application—we connect both.",
  }
];

export const ncstateServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const ncstateSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "NCSU-204",
    name: "Jordan P.",
    ...
    rating: 5,
    course: "MIE 310",
    serviceUsed: "Case Study",
    semester: "Fall 2024",
    quote: "Poole case during design project season. Analysis was quantitative and slide-ready—team used it verbatim.",
  },
  {
    id: "NCSU-517",
    name: "Taylor R.",
    ...
    quote: "Needed architecture explanation for TA review. Report matched the rubric on first pass.",
  },
  {
    id: "NCSU-339",
    name: "Alex G.",
    ...
    semester: "Fall 2024",
    quote: "Discussion section was weak in my draft. Writer fixed statistical interpretation and figure captions.",
  }
];

export const ncstateSampleFaq: FaqItem[] = [
  {
    question: "Do you support Moodle at NC State?",
    answer: "Yes. Share your Moodle rubric and we align formatting, citations, and deliverable type.",
  },
  {
    question: "Can you help engineering design projects?",
    answer: "We document design rationale, testing, and results to match MAE and ECE expectations.",
  },
  {
    question: "Is work original for NC State academic integrity?",
    answer: "All content is custom-written from your prompt with no recycled or AI-generated text.",
  },
  {
    question: "Do you cover CALS lab and field coursework?",
    answer: "Yes. Agricultural and life sciences assignments go to writers with relevant science training.",
  }
];

export const ncstateSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Raleigh Crunch?",
  name: "Marcus",
...
export const ncstateSampleBottomCta: BottomCtaData = {
  title: "Do not Let the NC State Semester Overwhelm You",
  subtitle: "Wolfpack students trust Essay Embassy when Moodle deadlines and design projects overlap. Stay on track through peak weeks.",
...
export default function NorthCarolinaStateUniversity() {
  return (
    <>
      <title>NC State Essay Help | North Carolina State University Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for NC State students. Support for Poole business cases, engineering labs, and CALS research in Raleigh."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/north-carolina-state-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={ncstateCollegeData} />
          <Stats stats={ncstateStats} />
          <Alert data={ncstateAlert} />
          <CalendarSection
            eyebrow="NC State academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Wolfpack crunch weeks across Poole, Engineering, and CALS."
            periods={ncstateCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering NC State's Think and Do Core"
            subtitle="From the Brickyard to engineering complexes, we match Wolfpack grading culture."
            departments={ncstateDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for NC State's STEM-Forward Standards"
            subtitle="With a top-280 QS global rank, NC State expects practical, well-documented academic work."
            cards={ncstateProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for the Wolfpack"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={ncstateServiceCards}
          />
          <Testimonials
            eyebrow="Wolfpack succeeding"
            title="What NC State Students Tell Us"
            subtitle="Feedback from Wolfpack students balancing Poole cases, engineering labs, and CALS coursework."
            items={ncstateSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for NC State coursework."
            items={ncstateSampleFaq}
            support={ncstateSampleFaqSupport}
          />
          <BottomCta data={ncstateSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
