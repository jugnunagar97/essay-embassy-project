      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Jumbo Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (TUFTS UNIVERSITY)
// ==========================================

export const tuftsCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Tufts is a selective private research university with Medford/Somerville undergraduate campuses, School of Engineering, and international-relations-oriented arts and sciences.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Tufts coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Tufts Arts & Engineering Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const tuftsStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=334",
    caption: "QS 2026; international relations and health sciences profile",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Arts & Sciences, Engineering, and Fletcher-adjacent policy writing",
  },
  {
    icon: "dollar",
...
export const tuftsAlert: AlertBanner = {
  title: "Tufts Semester Alert:",
  body: "Tufts's selective pace stacks engineering labs, IR-style policy papers, and writing-intensive seminars—especially on the Medford campus before finals on Canvas.",
};

export const tuftsCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, Fletcher School pathways assignments, and School of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Medford/Somerville campuses.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and School of Arts and Sciences group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "School of Engineering capstones, School of Arts and Sciences presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const tuftsDepartments: Department[] = [
  {
    icon: "book",
    name: "School of Arts and Sciences",
    courses: ["PSY 0001", "EC 0005", "PHIL 0001", "HIST 0001"],
  },
  {
    icon: "brain",
    name: "School of Engineering",
    courses: ["EN 0001", "CS 0015", "BME 0010", "ME 0010"],
  },
  {
    icon: "users",
    name: "International Relations",
    courses: ["ILO 0001", "PS 0061", "DHP D100", "EC 0012"],
  },
  {
    icon: "quote",
    name: "Writing Intensive Seminars",
    courses: ["ENG 0001", "CLS 0001", "AM 0001", "PJS 0001"],
  }
];

export const tuftsProfessorCards: ProfessorIntel[] = [
  {
    icon: "users",
    title: "IR & Policy Writing",
    subtitle: "Current global affairs analysis",
    bullets: [
      "Policy memos citing credible international relations scholarship.",
      "PS essays linking institutions to contemporary events.",
      "Clear recommendations appropriate to seminar rubrics.",
    ],
    footnote: "Tufts IR courses expect currency and credibility in sources.",
  },
  {
    icon: "brain",
    title: "Engineering & CS",
    subtitle: "Technical precision for Jumbos",
    bullets: [
      "BME and ME lab reports with reproducible methodology.",
      "CS documentation explaining design and testing.",
      "Technical tone for Tufts engineering faculty.",
    ],
    footnote: "Engineering faculty grade communication alongside results—we document both.",
  },
  {
    icon: "book",
    ...
    bullets: [
      ...
      "Writing-intensive revision-ready structure.",
      "Chicago or MLA citations as required.",
    ],
    footnote: "Tufts seminars expect depth—we deliver argument-led scholarship.",
  }
];

export const tuftsServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const tuftsSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "TUFTS-204",
    name: "Rachel A.",
    ...
    semester: "Fall 2024",
    quote: "IR brief due during club leadership week. Writer used current sources and matched the rubric.",
  },
  {
    id: "TUFTS-517",
    name: "Ben K.",
    ...
    quote: "Methods section needed work. Writer delivered before a brutal midterm stretch.",
  },
  {
    id: "TUFTS-339",
    name: "Lily C.",
    ...
    rating: 5,
    course: "ENG 0001",
    serviceUsed: "Seminar Essay",
    semester: "Fall 2024",
    quote: "Seminar wanted tighter claims. Draft gave me a structure I refined quickly.",
  }
];

export const tuftsSampleFaq: FaqItem[] = [
  {
    question: "Do you support Canvas at Tufts?",
    answer: "Yes. Share your Canvas rubric and we align structure, citations, and length.",
  },
  {
    question: "Can you help IR and policy-oriented seminars?",
    answer: "We assign writers with international relations training and current source habits.",
  },
  {
    question: "Is work original for Tufts academic integrity?",
    answer: "All drafts are custom-written from your prompt with no AI or essay banks.",
  },
  {
    question: "Do you cover School of Engineering labs?",
    answer: "Yes. STEM specialists handle methodology, results, and technical discussion.",
  }
];

export const tuftsSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Tufts Crunch?",
  name: "Marcus",
...
export const tuftsSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Tufts Semester Overwhelm You",
  subtitle: "Jumbos trust Essay Embassy when Canvas seminars and STEM labs overlap. Stay on track through peak weeks.",
...
export default function TuftsUniversity() {
  return (
    <>
      <title>Tufts University Essay Help | Tufts Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Tufts students. Support for engineering labs, international relations papers, and arts & sciences research in Medford."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/tufts-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={tuftsCollegeData} />
          <Stats stats={tuftsStats} />
          <Alert data={tuftsAlert} />
          <CalendarSection
            eyebrow="Tufts academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Jumbo deadline peaks across arts & sciences, engineering, and policy-oriented courses."
            periods={tuftsCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Tufts' Academic Core"
            subtitle="From the Hill to STEM halls, we match Tufts faculty standards."
            departments={tuftsDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Tufts' Selective Bar"
            subtitle="With a top-340 QS global rank, Tufts expects nuanced, well-argued academic work."
            cards={tuftsProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Jumbos"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={tuftsServiceCards}
          />
          <Testimonials
            eyebrow="Jumbos succeeding"
            title="What Tufts Students Tell Us"
            subtitle="Feedback from Jumbos balancing engineering labs, IR papers, and seminar essays."
            items={tuftsSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Tufts coursework."
            items={tuftsSampleFaq}
            support={tuftsSampleFaqSupport}
          />
          <BottomCta data={tuftsSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
