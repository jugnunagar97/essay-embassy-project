      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Cyclone Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (IOWA STATE UNIVERSITY)
// ==========================================

export const isuCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Iowa State is a land-grant public research university in Ames with Ivy College of Business, College of Engineering, and agriculture and life sciences research.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Iowa State coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Ivy & Engineering Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const isuStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=452",
    caption: "QS 2026; agriculture, engineering, and design research",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Ivy College, Engineering, and LAS expectations",
  },
  {
    icon: "dollar",
...
export const isuAlert: AlertBanner = {
  title: "Ames Semester Alert:",
  body: "Iowa State's land-grant workload stacks Ivy cases, engineering labs, and CALS reports before fall and spring finals on Canvas. Cyclone midterms fill calendars fast.",
};

export const isuCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Ames campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Ivy College of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Engineering capstones, Ivy College of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const isuDepartments: Department[] = [
  {
    icon: "chart",
    name: "Ivy College of Business",
    courses: ["ACCT 284", "FIN 301", "MKT 340", "MGMT 310"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["ENGR 101", "CPRE 185", "ME 231", "EE 201"],
  },
  {
    icon: "users",
    name: "Agriculture and Life Sciences",
    courses: ["AGRON 114", "AN S 114", "ECON 101", "BIOL 211"],
  },
  {
    icon: "book",
    name: "Liberal Arts and Sciences",
    courses: ["PSYCH 101", "POL S 101", "HIST 201", "ENGL 150"],
  }
];

export const isuProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Ivy Business & Analytics",
    subtitle: "Quantified Midwest business writing",
    bullets: [
      "Finance and marketing cases with clear recommendations.",
      "Analytics memos aligned to Ivy rubrics.",
      "Team-ready sections for presentations.",
    ],
    footnote: "Ivy cases demand numbers tied to decisions—we deliver practical analysis.",
  },
  {
    icon: "brain",
    title: "Engineering & CPRE",
    subtitle: "Design and computing documentation",
    bullets: [
      "ME and EE lab reports with reproducible methods.",
      "CPRE documentation explaining code and testing.",
      "Technical tone for Iowa State engineering faculty.",
    ],
    footnote: "Engineering faculty expect auditable methods—we document every step.",
  },
  {
    icon: "users",
    title: "CALS & LAS",
    subtitle: "Applied ag and social science writing",
    bullets: [
      "Agronomy and animal science lab reports.",
      "Economics papers with empirical support.",
      "APA structure across psychology and policy courses.",
    ],
    footnote: "Land-grant assignments value application—we connect theory to Iowa-relevant data.",
  }
];

export const isuServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const isuSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "ISU-204",
    name: "Megan W.",
    major: "Marketing",
    ...
    semester: "Fall 2024",
    quote: "Ivy case during homecoming week. Analysis was quantitative and presentation-ready.",
  },
  {
    id: "ISU-517",
    name: "Chris A.",
    ...
    quote: "Project write-up matched Canvas rubric on first submission.",
  },
  {
    id: "ISU-339",
    name: "Derek F.",
    ...
    semester: "Fall 2024",
    quote: "Lab discussion needed field-data interpretation. Writer nailed it.",
  }
];

export const isuSampleFaq: FaqItem[] = [
  {
    question: "Do you support Canvas at Iowa State?",
    answer: "Yes. Share your Canvas rubric and we align format and citations.",
  },
  {
    question: "Can you help engineering design and CPRE projects?",
    answer: "STEM specialists document design, testing, and results.",
  },
  {
    question: "Is work original for ISU academic integrity?",
    answer: "All content is custom-written from your prompt only.",
  },
  {
    question: "Do you cover CALS lab coursework?",
    answer: "Yes. Agricultural science assignments go to relevant specialists.",
  }
];

export const isuSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Ames Crunch?",
  name: "Marcus",
...
export const isuSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Iowa State Semester Overwhelm You",
  subtitle: "Cyclones trust Essay Embassy when Canvas deadlines and design projects overlap. Stay on track through peak weeks.",
...
export default function IowaStateUniversity() {
  return (
    <>
      <title>Iowa State Essay Help | ISU Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Iowa State students. Support for Ivy business cases, engineering labs, and agriculture research in Ames."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/iowa-state-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={isuCollegeData} />
          <Stats stats={isuStats} />
          <Alert data={isuAlert} />
          <CalendarSection
            eyebrow="Iowa State academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Cyclone crunch weeks across Ivy, Engineering, and agriculture programs."
            periods={isuCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Iowa State's Core Colleges"
            subtitle="From Central Campus to engineering halls, we match Cyclone grading culture."
            departments={isuDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Iowa State Research Standards"
            subtitle="With a top-460 QS global rank, Ames expects evidence-based, rubric-aligned academic work."
            cards={isuProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Cyclones"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={isuServiceCards}
          />
          <Testimonials
            eyebrow="Cyclones succeeding"
            title="What Iowa State Students Tell Us"
            subtitle="Feedback from Cyclones balancing Ivy cases, engineering labs, and CALS coursework."
            items={isuSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Iowa State coursework."
            items={isuSampleFaq}
            support={isuSampleFaqSupport}
          />
          <BottomCta data={isuSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
