      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Rice Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (RICE UNIVERSITY)
// ==========================================

export const riceCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Rice is a private research university in Houston with a small undergraduate community and intensive faculty engagement. Support spans Jones School of Business, the George R. Brown School of Engineering, and natural sciences and humanities programs where lab reports and case analyses carry heavy weight.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Rice coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Jones & Engineering Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const riceStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=119",
    caption: "QS 2026 global rank; strong research citations and sustainability scores",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Jones, Brown Engineering, and Weiss expectations",
  },
  {
    icon: "dollar",
...
export const riceAlert: AlertBanner = {
  title: "Houston Semester Pace Alert:",
  body: "Rice's intimate campus still moves fast. From Jones finance models to engineering design labs and humanities thesis drafts, deadlines cluster before fall and spring breaks. Reserve a writer before midterm week fills up.",
};

export const riceCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, Weiss School of Natural Sciences assignments, and George R. Brown School of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the hedges and academic quads.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Jones School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "George R. Brown School of Engineering capstones, Jones School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const riceDepartments: Department[] = [
  {
    icon: "chart",
    name: "Jones School of Business",
    courses: ["BUSI 310", "FINC 301", "MGMT 321", "ACCT 310"],
  },
  {
    icon: "brain",
    name: "George R. Brown School of Engineering",
    courses: ["ELEC 242", "MECH 310", "BIOE 370", "CHBE 311"],
  },
  {
    icon: "book",
    name: "Weiss School of Natural Sciences",
    courses: ["CHEM 121", "PHYS 101", "BIOS 201", "MATH 212"],
  },
  {
    icon: "quote",
    name: "School of Humanities",
    courses: ["HIST 210", "ENGL 200", "PHIL 251", "POLI 200"],
  }
];

export const riceProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Jones Business & Finance",
    subtitle: "Case rigor with clean quantitative logic",
    bullets: [
      "Concise executive summaries tied to data and strategic recommendations.",
      "Spreadsheet-ready financial logic without filler paragraphs.",
      "Professional tone aligned with Jones case-competition standards.",
    ],
    footnote: "Jones graders reward precision. We keep analyses tight, sourced, and decision-ready.",
  },
  {
    icon: "brain",
    title: "Brown Engineering & STEM",
    subtitle: "Lab clarity and reproducible methods",
    bullets: [
      "Structured lab reports with explicit methodology and results.",
      "Technical vocabulary appropriate for upper-level engineering courses.",
      "Clear figures, units, and error analysis where rubrics require them.",
    ],
    footnote: "Rice engineering faculty expect reproducible methods. We document every step so TAs can follow your logic.",
  },
  {
    icon: "book",
    title: "Weiss Sciences & Humanities",
    subtitle: "Evidence-led writing across disciplines",
    bullets: [
      "Literature reviews that synthesize peer-reviewed sources, not summaries.",
      "APA or Chicago citations matched to department preferences.",
      "Original arguments that connect theory to current research debates.",
    ],
    footnote: "Whether in BIOS or HIST, Rice values depth. We build arguments that read like seminar-ready scholarship.",
  }
];

export const riceServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const riceSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "RICE-204",
    name: "Priya K.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "Two Jones assignments landed the same week. The writer structured the DCF and risk sections cleanly and kept the executive summary under one page. Exactly what my TA wanted.",
  },
  {
    id: "RICE-517",
    name: "Marcus T.",
    ...
    rating: 5,
    course: "BIOE 370",
    serviceUsed: "Lab Report",
    semester: "Spring 2024",
    quote: "My lab partner handled the bench work; I needed help on the write-up. Methods and discussion came back formatted to our rubric with clear figures.",
  },
  {
    id: "RICE-339",
    name: "Elena R.",
    ...
    semester: "Fall 2024",
    quote: "The paper wove primary and secondary sources in Chicago notes without sounding generic. I only tweaked the intro after review.",
  }
];

export const riceSampleFaq: FaqItem[] = [
  {
    question: "Are your writers familiar with Rice's program-specific rubrics?",
    answer: "Yes. We match Jones case formats, Brown engineering lab structures, and humanities citation styles with writers who have completed graduate work in those fields.",
  },
  {
    question: "Can you help international students meet Rice's writing expectations?",
    answer: "Absolutely. Rice admits a globally diverse cohort. Our editors polish grammar and flow while preserving your ideas and analytical voice.",
  },
  {
    question: "Will my work pass Canvas and Turnitin at Rice?",
    answer: "Every order is written from scratch from your prompt. We do not recycle banks or use AI drafts. You receive an original paper ready for integrity checks.",
  },
  {
    question: "Do you handle urgent deadlines during midterms?",
    answer: "Yes. We offer turnaround from 12 hours upward. Share your syllabus deadline and rubric so we can assign the right specialist immediately.",
  }
];

export const riceSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Houston Crunch?",
  name: "Marcus",
  role: "Gulf Coast Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Gulf Coast Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const riceSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Rice Semester Overwhelm You",
  subtitle: "Rice Owls trust Essay Embassy when seminars, labs, and case analyses collide. Stay on track without sacrificing sleep.",
...
export default function RiceUniversity() {
  return (
    <>
      <title>Rice University Essay Help | Rice Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Rice students. Tailored support for Jones business cases, engineering labs, and Weiss science reports."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/rice-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={riceCollegeData} />
          <Stats stats={riceStats} />
          <Alert data={riceAlert} />
          <CalendarSection
            eyebrow="Rice academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan ahead for Houston's fall and spring crunch weeks across Jones, engineering, and humanities programs."
            periods={riceCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering the Rice Academic Core"
            subtitle="From the hedges to the research labs, we align with what Rice faculty expect on Canvas."
            departments={riceDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Rice's High Academic Bar"
            subtitle="With a top-120 global QS standing, Rice sets demanding standards. Our writers match that rigor school by school."
            cards={riceProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Owls"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={riceServiceCards}
          />
          <Testimonials
            eyebrow="Owls succeeding"
            title="What Rice Students Tell Us"
            subtitle="Real feedback from Rice students balancing Jones cases, STEM labs, and humanities seminars."
            items={riceSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Rice coursework."
            items={riceSampleFaq}
            support={riceSampleFaqSupport}
          />
          <BottomCta data={riceSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
