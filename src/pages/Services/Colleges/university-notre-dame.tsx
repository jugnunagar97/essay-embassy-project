      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Fighting Irish Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF NOTRE DAME)
// ==========================================

export const ndCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Notre Dame is a private Catholic research university known for Mendoza College of Business, College of Engineering, and arts and letters seminars with ethics-integrated analytics.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Notre Dame coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Mendoza & Engineering Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const ndStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#299",
    caption: "QS 2026; undergraduate focus with Mendoza and engineering excellence",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Mendoza, Engineering, and Arts & Letters expectations",
  },
  {
    icon: "dollar",
...
export const ndAlert: AlertBanner = {
  title: "Notre Dame Semester Alert:",
  body: "Notre Dame's rigorous semester stacks Mendoza cases, engineering design labs, and Arts & Letters seminar essays—especially before fall break and finals on Sakai.",
};

export const ndCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Arts and Letters assignments, and College of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Notre Dame campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Mendoza College of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Engineering capstones, Mendoza College of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const ndDepartments: Department[] = [
  {
    icon: "chart",
    name: "Mendoza College of Business",
    courses: ["ACCT 20100", "FIN 30210", "MGT 30100", "MARK 20200"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["ENGR 101", "AME 20231", "CSE 20311", "EE 20224"],
  },
  {
    icon: "book",
    name: "College of Arts and Letters",
    courses: ["PHIL 10101", "ECON 10401", "HIST 10010", "WRIT 10101"],
  },
  {
    icon: "users",
    name: "Keough School of Global Affairs",
    courses: ["KSGA 20001", "POL 10100", "IR 20100", "SOC 10010"],
  }
];

export const ndProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Mendoza Business & Ethics",
    subtitle: "Values-aware case writing",
    bullets: [
      "Case memos balancing analytics with ethical framing.",
      "Finance and marketing assignments aligned to Mendoza rubrics.",
      "Presentation-ready summaries for Sakai submissions.",
    ],
    footnote: "Mendoza integrates ethics into analytics—we deliver both rigor and responsibility.",
  },
  {
    icon: "brain",
    title: "Engineering & CSE",
    subtitle: "Design labs with clear documentation",
    bullets: [
      "AME and CSE project reports with design justification.",
      "Lab reports with reproducible methodology and results.",
      "Technical vocabulary appropriate for Notre Dame faculty.",
    ],
    footnote: "Engineering courses grade communication alongside outcomes—we document both.",
  },
  {
    icon: "book",
    title: "Arts & Letters Seminars",
    subtitle: "Humanities depth with thesis clarity",
    bullets: [
      "WRIT and PHIL essays with argument reconstruction.",
      "Global affairs papers citing current policy sources.",
      "Chicago or MLA citations per department guidance.",
    ],
    footnote: "Arts & Letters seminars punish summary-only writing—we build original claims.",
  }
];

export const ndServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const ndSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "ND-204",
    name: "Patrick M.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "Mendoza case during a packed football weekend. Memo was ethical, quantitative, and Sakai-ready.",
  },
  {
    id: "ND-517",
    name: "Claire R.",
  ...
  },
  {
    ...
    semester: "Fall 2024",
    quote: "Needed a thesis on institutions with credible sources. Structure was excellent with minor edits.",
  }
];

export const ndSampleFaq: FaqItem[] = [
  {
    question: "Do you support Sakai assignments at Notre Dame?",
    answer: "Yes. Share your Sakai rubric and we align format, citations, and length.",
  },
  {
    question: "Can you help Mendoza ethics-integrated cases?",
    answer: "We balance quantitative analysis with values-aware recommendations Mendoza expects.",
  },
  {
    question: "Is work original for Notre Dame honor codes?",
    answer: "All content is custom-written from your instructions with no AI or essay banks.",
  },
  {
    question: "Do you cover Keough global affairs briefs?",
    answer: "Yes. Policy assignments receive writers with international relations training.",
  }
];

export const ndSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Notre Dame Crunch?",
  name: "Marcus",
...
export const ndSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Notre Dame Semester Overwhelm You",
  subtitle: "Fighting Irish trust Essay Embassy when Sakai deadlines and Mendoza cases overlap. Stay on track through peak weeks.",
...
export default function UniversityNotreDame() {
  return (
    <>
      <title>Notre Dame Essay Help | University of Notre Dame Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for Notre Dame students. Support for Mendoza business cases, engineering labs, and Arts & Letters research."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-notre-dame/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={ndCollegeData} />
          <Stats stats={ndStats} />
          <Alert data={ndAlert} />
          <CalendarSection
            eyebrow="Notre Dame academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Fighting Irish deadline peaks across Mendoza, engineering, and global affairs."
            periods={ndCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Notre Dame's Academic Core"
            subtitle="From the Dome to engineering halls, we match Irish faculty standards."
            departments={ndDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Notre Dame's Elite Bar"
            subtitle="With a top-300 QS global rank, Notre Dame expects polished, ethically grounded academic work."
            cards={ndProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for the Fighting Irish"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={ndServiceCards}
          />
          <Testimonials
            eyebrow="Fighting Irish succeeding"
            title="What Notre Dame Students Tell Us"
            subtitle="Feedback from students balancing Mendoza cases, engineering labs, and seminar research."
            items={ndSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Notre Dame coursework."
            items={ndSampleFaq}
            support={ndSampleFaqSupport}
          />
          <BottomCta data={ndSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
