      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Scarlet Knight Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (RUTGERS UNIVERSITY–NEW BRUNSWICK)
// ==========================================

export const rutgersCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  type: "Public Research University (Rutgers–New Brunswick)",
  studentsLabel: "Trusted by Rutgers Scarlet Knights",
  description:
    "Rutgers–New Brunswick is the flagship research campus of Rutgers University with Rutgers Business School, School of Engineering, and Bloustein public policy across multiple campuses in New Jersey.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Rutgers coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "RBS & Engineering Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const rutgersStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=334",
    caption: "QS 2026; major R1 research across Busch and College Avenue campuses",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Rutgers Business School, Engineering, and SAS expectations",
  },
  {
    icon: "dollar",
...
export const rutgersAlert: AlertBanner = {
  title: "New Brunswick Semester Alert:",
  body: "Rutgers's multi-campus model stacks RBS cases, engineering labs, and SAS research papers before October and April finals on Canvas.",
};

export const rutgersCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, School of Arts and Sciences assignments, and School of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the New Brunswick campuses.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Rutgers Business School group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "School of Engineering capstones, Rutgers Business School presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const rutgersDepartments: Department[] = [
  {
    icon: "chart",
    name: "Rutgers Business School",
    courses: ["33:010:272", "33:390:300", "33:136:370", "29:390:329"],
  },
  {
    icon: "brain",
    name: "School of Engineering",
    courses: ["14:440:100", "14:332:221", "14:155:201", "01:198:111"],
  },
  {
    icon: "users",
    name: "Bloustein Public Policy",
    courses: ["10:762:205", "10:832:300", "10:762:230", "34:970:303"],
  },
  {
    icon: "book",
    name: "School of Arts and Sciences",
    courses: ["01:640:151", "01:830:101", "01:220:102", "01:355:101"],
  }
];

export const rutgersProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "RBS Cases & Analytics",
    subtitle: "Quantified business deliverables",
    bullets: [
      "Case memos with financial exhibits and recommendations.",
      "Analytics assignments aligned to RBS rubrics.",
      "Team-ready sections for group presentations.",
    ],
    footnote: "RBS graders want numbers tied to decisions—we keep analyses practical.",
  },
  {
    icon: "brain",
    ...
    bullets: [
      "Lab reports with explicit procedures and results.",
      "CS 111 documentation explaining logic and testing.",
      "Technical tone for Rutgers engineering faculty.",
    ],
    footnote: "Engineering TAs grade methodology strictly—we make work auditable.",
  },
  {
    icon: "users",
    title: "Bloustein & SAS Policy",
    subtitle: "Evidence-based public writing",
    bullets: [
      "Policy briefs citing government and academic sources.",
      "Economics and political science essays with thesis clarity.",
      "APA formatting across social science departments.",
    ],
    footnote: "Bloustein assignments need credible, current evidence—we deliver it.",
  }
];

export const rutgersServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const rutgersSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "RU-204",
    name: "Nisha P.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "RBS case during bus route chaos week. Analysis was quantitative and presentation-ready.",
  },
  {
    id: "RU-517",
    name: "Tom G.",
    ...
    quote: "Needed clear documentation for CS project. TA rubric satisfied on first submission.",
  },
  {
    id: "RU-339",
    name: "Elena S.",
    ...
    semester: "Fall 2024",
    quote: "Brief required NJ-relevant sources. Structure and recommendations were excellent.",
  }
];

export const rutgersSampleFaq: FaqItem[] = [
  {
    question: "Do you support Canvas across Rutgers campuses?",
    answer: "Yes. Share your Canvas rubric—we align deliverables for Busch, Livingston, and College Ave courses.",
  },
  {
    question: "Can you help RBS group presentations?",
    answer: "We deliver memo sections and data exhibits your team integrates into decks.",
  },
  {
    question: "Is work original for Rutgers academic integrity?",
    answer: "All papers are custom-written from your prompt with no recycled content.",
  },
  {
    question: "Do you cover Bloustein urban planning papers?",
    answer: "Yes. Policy and planning assignments go to writers with public affairs training.",
  }
];

export const rutgersSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the New Brunswick Crunch?",
  name: "Marcus",
...
export const rutgersSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Rutgers Semester Overwhelm You",
  subtitle: "Scarlet Knights trust Essay Embassy when Canvas deadlines overlap across campuses. Stay on track through peak weeks.",
...
export default function RutgersUniversityNewBrunswick() {
  return (
    <>
      <title>Rutgers Essay Help | Rutgers University New Brunswick Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for Rutgers New Brunswick students. Support for RBS business cases, engineering labs, and SAS research papers."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/rutgers-university-new-brunswick/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={rutgersCollegeData} />
          <Stats stats={rutgersStats} />
          <Alert data={rutgersAlert} />
          <CalendarSection
            eyebrow="Rutgers academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Scarlet Knight crunch weeks across Busch, Livingston, and College Avenue workloads."
            periods={rutgersCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Rutgers New Brunswick's Core"
            subtitle="From the Raritan to engineering quads, we match Rutgers grading culture."
            departments={rutgersDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Rutgers Research Standards"
            subtitle="With a top-340 QS global rank, Rutgers expects well-cited, discipline-appropriate writing."
            cards={rutgersProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Scarlet Knights"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={rutgersServiceCards}
          />
          <Testimonials
            eyebrow="Scarlet Knights succeeding"
            title="What Rutgers Students Tell Us"
            subtitle="Feedback from Scarlet Knights balancing RBS cases, engineering labs, and SAS essays."
            items={rutgersSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Rutgers coursework."
            items={rutgersSampleFaq}
            support={rutgersSampleFaqSupport}
          />
          <BottomCta data={rutgersSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
