      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Highlander Quarter Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF CALIFORNIA, RIVERSIDE)
// ==========================================

export const ucrCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "UC Riverside is a University of California campus on the quarter system with School of Business, Bourns College of Engineering, and CHASS in inland Southern California.",
  cta: {
    primary: { href: "/order-now", label: "Get help for UCR coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "UCR Business & Bourns Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const ucrStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#449",
    caption: "QS 2026 UC campus; growing research in business and engineering",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with School of Business, Bourns Engineering, and CHASS expectations",
  },
  {
    icon: "dollar",
...
export const ucrAlert: AlertBanner = {
  title: "Riverside Quarter Alert:",
  body: "UCR's quarter system compresses business cases, Bourns labs, and CHASS essays into fast 10-week arcs. Highlanders midterms peak in weeks 4 and 8 on Canvas.",
};

export const ucrCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Humanities, Arts, and Social Sciences assignments, and Bourns College of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Riverside campus.",
  ...
  },
  {
    ...
    body: "Bourns College of Engineering capstones, School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const ucrDepartments: Department[] = [
  {
    icon: "chart",
    name: "School of Business",
    courses: ["BUS 020", "FIN 102", "MKT 103", "STAT 100A"],
  },
  {
    icon: "brain",
    name: "Bourns College of Engineering",
    courses: ["ENGR 001", "CS 010A", "ME 002", "EE 001A"],
  },
  {
    icon: "book",
    name: "CHASS",
    courses: ["ENG 001", "HIST 005", "PHIL 001", "SOC 001"],
  },
  {
    icon: "users",
    name: "Natural and Agricultural Sciences",
    courses: ["BIOL 005A", "CHEM 001A", "ENT 100", "ECON 002"],
  }
];

export const ucrProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "School of Business Cases",
    subtitle: "Quarter-ready business writing",
    bullets: [
      "Case memos with financial exhibits and recommendations.",
      "Statistics integration where rubrics require it.",
      "Concise deliverables for 10-week turnarounds.",
    ],
    footnote: "UCR business cases must be tight—quarters leave little revision time.",
  },
  {
    icon: "brain",
    title: "Bourns Engineering & CS",
    subtitle: "Technical depth for labs and code",
    bullets: [
      "ENGR and CS lab reports with clear methodology.",
      "Project documentation explaining design and testing.",
      "Technical tone for Bourns faculty.",
    ],
    footnote: "Bourns faculty expect reproducible STEM communication—we deliver it.",
  },
  {
    icon: "book",
    title: "CHASS & Life Sciences",
    subtitle: "Evidence-led UC writing",
    bullets: [
      "ENG 001 essays with thesis clarity.",
      "Biology lab reports with proper discussion sections.",
      "APA citations across social and life sciences.",
    ],
    footnote: "CHASS seminars grade argument depth—we build thesis-led papers.",
  }
];

export const ucrServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const ucrSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UCR-204",
    name: "Andrea G.",
    major: "Business",
    ...
    semester: "Fall 2024",
    quote: "Business case during week 4 quarter crunch. Memo was quantitative and Canvas-ready.",
  },
  {
    id: "UCR-517",
    name: "Jose M.",
    ...
    quote: "Documentation explained design clearly for the TA.",
  },
  {
    id: "UCR-339",
    name: "Lena P.",
    ...
    semester: "Fall 2024",
    quote: "Needed sharper thesis on inequality. Draft needed only light edits.",
  }
];

export const ucrSampleFaq: FaqItem[] = [
  {
    question: "Do you understand UCR's quarter system?",
    answer: "Yes. We prioritize fast, high-quality turnarounds for quarter midterms and finals.",
  },
  {
    question: "Can you help Bourns and CS combined deliverables?",
    answer: "We document code and formal reports in one coordinated package.",
  },
  {
    question: "Is work original for UCR academic integrity?",
    answer: "Every paper is written from scratch from your prompt.",
  },
  {
    question: "Do you support ENG 001 and writing requirements?",
    answer: "Yes. We help structure arguments while keeping your voice.",
  }
];

export const ucrSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Riverside Quarter Crunch?",
  name: "Marcus",
...
export const ucrSampleBottomCta: BottomCtaData = {
  title: "Do not Let the UCR Quarter Overwhelm You",
  subtitle: "Highlanders trust Essay Embassy when quarter deadlines stack on Canvas. Protect your GPA through peak weeks.",
...
export default function UniversityCaliforniaRiverside() {
  return (
    <>
      <title>UC Riverside Essay Help | UCR Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for UC Riverside students. Support for School of Business cases, Bourns engineering labs, and CHASS research papers."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-california-riverside/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={ucrCollegeData} />
          <Stats stats={ucrStats} />
          <Alert data={ucrAlert} />
          <CalendarSection
            eyebrow="UCR academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Highlander quarter peaks across business, engineering, and CHASS."
            periods={ucrCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering UCR's UC Core"
            subtitle="From the Bell Tower to Bourns labs, we match UC-level faculty expectations."
            departments={ucrDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for UCR's UC Standards"
            subtitle="With a top-450 QS global rank, Riverside expects rigorous, well-cited work on quarter timelines."
            cards={ucrProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Highlanders"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={ucrServiceCards}
          />
          <Testimonials
            eyebrow="Highlanders succeeding"
            title="What UCR Students Tell Us"
            subtitle="Feedback from Highlanders balancing business cases, Bourns projects, and CHASS research."
            items={ucrSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for UCR coursework."
            items={ucrSampleFaq}
            support={ucrSampleFaqSupport}
          />
          <BottomCta data={ucrSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
