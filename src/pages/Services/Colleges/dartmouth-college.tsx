      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Dartmouth Quarter Pace
          </span>
...
// ==========================================
// TAILORED DATA (DARTMOUTH COLLEGE)
// ==========================================

export const dartmouthCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Dartmouth is an Ivy League research university in Hanover operating on fast 10-week quarters. Thayer School of Engineering, economics, and writing-intensive seminars demand concise, high-depth work.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Dartmouth coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Thayer & Arts & Sciences Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const dartmouthStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=247",
    caption: "QS 2026; undergraduate-focused Ivy with quarter-system pace",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Tuck pathways, Thayer, and Arts & Sciences expectations",
  },
  {
    icon: "dollar",
...
export const dartmouthAlert: AlertBanner = {
  title: "Hanover Quarter Pace Alert:",
  body: "Dartmouth's fast 10-week quarters compress essays, Thayer labs, and economics problem sets. Weeks 4 and 8 are notorious—reserve a writer before the Big Green midterm rush.",
};

export const dartmouthCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, Guarini School of Graduate Studies assignments, and College of Arts & Sciences lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Hanover campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Thayer School of Engineering group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Arts & Sciences capstones, Thayer School of Engineering presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const dartmouthDepartments: Department[] = [
  {
    icon: "brain",
    name: "Thayer School of Engineering",
    courses: ["ENGS 20", "ENGS 21", "COSC 1", "ENGS 76"],
  },
  {
    icon: "book",
    name: "College of Arts & Sciences",
    courses: ["ECON 1", "GOVT 3", "PSYC 1", "WRIT 5"],
  },
  {
    icon: "chart",
    name: "Quantitative Social Science",
    courses: ["QSS 17", "GOVT 10", "MATH 3", "ECON 20"],
  },
  {
    icon: "quote",
    name: "Writing & Rhetoric",
    courses: ["WRIT 5", "WRIT 2", "ENGL 53", "HIST 96"],
  }
];

export const dartmouthProfessorCards: ProfessorIntel[] = [
  {
    icon: "brain",
    title: "Thayer Engineering Projects",
    subtitle: "Hands-on labs with tight documentation",
    bullets: [
      "ENGS project reports with design rationale and testing.",
      "Clear schematics and methodology for Thayer faculty review.",
      "Technical tone without unnecessary jargon.",
    ],
    footnote: "Thayer grades process and communication equally—we document both thoroughly.",
  },
  {
    icon: "book",
    title: "Arts & Sciences Seminars",
    subtitle: "Ivy-level argumentation",
    bullets: [
      "WRIT 5 essays with thesis clarity and revision-ready structure.",
      "GOVT papers linking theory to contemporary institutions.",
      "Chicago-style citations where seminars require them.",
    ],
    footnote: "Dartmouth seminars punish summary-only writing—we build original claims.",
  },
  {
    icon: "chart",
    title: "Economics & QSS",
    subtitle: "Quantitative rigor in short terms",
    bullets: [
      "Problem sets explained with clear assumptions and notation.",
      "Empirical papers integrating data and economic theory.",
      "Concise writing suited to 10-week turnaround expectations.",
    ],
    footnote: "Quarter pace means less time to recover— we deliver tight, correct drafts fast.",
  }
];

export const dartmouthServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const dartmouthSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "DART-204",
    name: "Sophie M.",
    major: "Engineering",
    ...
    semester: "Fall 2024",
    quote: "Quarter moved too fast after ENGS 21 fieldwork. Report came back structured exactly how Thayer wanted design justification.",
  },
  {
    id: "DART-517",
    name: "James T.",
    ...
    quote: "Winter term is brutal. Paper had sharp thesis and Chicago footnotes—minimal edits before submission.",
  },
  {
    id: "DART-339",
    name: "Aria L.",
    ...
    rating: 5,
    course: "ECON 20",
    serviceUsed: "Empirical Essay",
    semester: "Fall 2024",
    quote: "Empirical section needed cleaner econometric explanation. Writer made the regression story readable for non-specialists.",
  }
];

export const dartmouthSampleFaq: FaqItem[] = [
  {
    question: "Do you understand Dartmouth's 10-week quarter system?",
    answer: "Yes. We prioritize fast, high-quality turnarounds aligned to quarter midterms and finals.",
  },
  {
    question: "Can you help Thayer project-heavy courses?",
    answer: "Engineering specialists document design, testing, and results to Thayer rubrics.",
  },
  {
    question: "Is work original under Dartmouth honor principles?",
    answer: "All content is custom-written from your prompt—no AI or recycled papers.",
  },
  {
    question: "Do you support WRIT 5 and first-year writing?",
    answer: "We help structure arguments and citations while keeping your voice intact.",
  }
];

export const dartmouthSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Quarter Crunch?",
  name: "Marcus",
...
export const dartmouthSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Dartmouth Quarter Overwhelm You",
  subtitle: "Dartmouth students trust Essay Embassy when 10-week quarters stack seminars, labs, and research. Protect your GPA through peak weeks.",
...
export default function DartmouthCollege() {
  return (
    <>
      <title>Dartmouth College Essay Help | Dartmouth Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Dartmouth students. Support for Thayer engineering labs, arts & sciences seminars, and quarter-system research papers in Hanover."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/dartmouth-college/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={dartmouthCollegeData} />
          <Stats stats={dartmouthStats} />
          <Alert data={dartmouthAlert} />
          <CalendarSection
            eyebrow="Dartmouth academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate quarter-system peaks across Thayer, arts & sciences, and writing-intensive seminars."
            periods={dartmouthCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Dartmouth's Academic Core"
            subtitle="From the Green to Thayer labs, we match Ivy-level faculty expectations."
            departments={dartmouthDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Dartmouth's Ivy Standards"
            subtitle="With a top-250 QS profile and quarter-system intensity, Dartmouth demands concise, high-depth academic work."
            cards={dartmouthProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Big Green"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={dartmouthServiceCards}
          />
          <Testimonials
            eyebrow="Big Green succeeding"
            title="What Dartmouth Students Tell Us"
            subtitle="Feedback from students balancing quarter timelines, Thayer projects, and seminar essays."
            items={dartmouthSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Dartmouth coursework."
            items={dartmouthSampleFaq}
            support={dartmouthSampleFaqSupport}
          />
          <BottomCta data={dartmouthSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
