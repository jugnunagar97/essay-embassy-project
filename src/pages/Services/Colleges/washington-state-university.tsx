      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Cougar Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (WASHINGTON STATE UNIVERSITY)
// ==========================================

export const wsuCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Washington State University is a land-grant public research university in Pullman with Carson College of Business, Voiland College of Engineering, and agricultural sciences.",
  cta: {
    primary: { href: "/order-now", label: "Get help for WSU coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Carson & Voiland Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const wsuStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=440",
    caption: "QS 2026; agriculture, veterinary, and engineering on the Palouse",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Carson College, Voiland Engineering, and CAS expectations",
  },
  {
    icon: "dollar",
...
export const wsuAlert: AlertBanner = {
  title: "Pullman Semester Alert:",
  body: "WSU's Palouse semesters stack Carson cases, Voiland labs, and CAS papers before Thanksgiving and May finals on Canvas. Cougar midterms spike demand early.",
};

export const wsuCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Arts and Sciences assignments, and Voiland College of Engineering and Architecture lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Pullman campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Carson College of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Voiland College of Engineering and Architecture capstones, Carson College of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const wsuDepartments: Department[] = [
  {
    icon: "chart",
    name: "Carson College of Business",
    courses: ["ACCTG 230", "MGTOP 340", "FIN 325", "MKTG 360"],
  },
  {
    icon: "brain",
    name: "Voiland College of Engineering",
    courses: ["ENGR 120", "CPT_S 121", "ME 215", "CE 211"],
  },
  {
    icon: "users",
    name: "Agricultural Sciences",
    courses: ["SOIL_S 201", "AFS 101", "ENTOM 101", "ECONS 101"],
  },
  {
    icon: "book",
    name: "College of Arts and Sciences",
    courses: ["PSYCH 105", "POL_S 101", "HIST 105", "ENGLISH 101"],
  }
];

export const wsuProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Carson Business Cases",
    subtitle: "Practical Palouse-market analysis",
    bullets: [
      "Finance and marketing cases with quantified recommendations.",
      "MGTOP analytics aligned to Carson rubrics.",
      "Professional memos for Canvas submission.",
    ],
    footnote: "Carson graders want decisions backed by data—not filler.",
  },
  {
    icon: "brain",
    title: "Voiland Engineering & CPT_S",
    subtitle: "Labs and computing documentation",
    bullets: [
      "ME and CE lab reports with reproducible methods.",
      "CPT_S documentation explaining code and testing.",
      "Technical vocabulary for Voiland faculty.",
    ],
    footnote: "Voiland courses grade technical communication—we match that bar.",
  },
  {
    icon: "users",
    title: "Ag Sciences & CAS",
    subtitle: "Applied research writing",
    bullets: [
      "Ag economics papers connecting theory to regional data.",
      "Psychology literature reviews with APA citations.",
      "Policy essays with credible government sources.",
    ],
    footnote: "Land-grant culture values application—we connect theory to practice.",
  }
];

export const wsuServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const wsuSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "WSU-204",
    name: "Tyler N.",
    major: "Management",
    ...
    semester: "Fall 2024",
    quote: "Carson case before Thanksgiving crunch. Memo was quantitative and rubric-aligned.",
  },
  {
    id: "WSU-517",
    name: "Hannah B.",
    ...
    quote: "Needed testing documentation beyond code. TA satisfied on first submission.",
  },
  {
    id: "WSU-339",
    name: "Ian K.",
    ...
    semester: "Fall 2024",
    quote: "Paper needed regional data sources. Structure was strong with light edits.",
  }
];

export const wsuSampleFaq: FaqItem[] = [
  {
    question: "Do you support Canvas at WSU?",
    answer: "Yes. Share your Canvas rubric and we align deliverables.",
  },
  {
    question: "Can you help agricultural and vet-prep coursework?",
    answer: "Science specialists handle ag and life sciences lab writing.",
  },
  {
    question: "Is work original for WSU academic integrity?",
    answer: "All drafts are custom-written from your prompt only.",
  },
  {
    question: "Do you cover Carson group presentations?",
    answer: "Yes. We deliver analysis sections for team slide decks.",
  }
];

export const wsuSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Pullman Crunch?",
  name: "Marcus",
  role: "Pacific Northwest Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Pacific Northwest Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const wsuSampleBottomCta: BottomCtaData = {
  title: "Do not Let the WSU Semester Overwhelm You",
  subtitle: "Cougars trust Essay Embassy when Canvas deadlines and Palouse winters overlap. Stay on track all semester.",
...
export default function WashingtonStateUniversity() {
  return (
    <>
      <title>WSU Essay Help | Washington State University Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for Washington State students. Support for Carson business cases, Voiland engineering labs, and CAS research in Pullman."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/washington-state-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={wsuCollegeData} />
          <Stats stats={wsuStats} />
          <Alert data={wsuAlert} />
          <CalendarSection
            eyebrow="WSU academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Cougar crunch weeks across Carson, Voiland, and agricultural sciences."
            periods={wsuCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering WSU's Land-Grant Core"
            subtitle="From the Cougar flag to Voiland labs, we match Pullman grading culture."
            departments={wsuDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for WSU Research Standards"
            subtitle="With a top-440 QS global rank, Washington State expects practical, well-sourced academic work."
            cards={wsuProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Cougars"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={wsuServiceCards}
          />
          <Testimonials
            eyebrow="Cougars succeeding"
            title="What WSU Students Tell Us"
            subtitle="Feedback from Cougars balancing Carson cases, engineering labs, and ag sciences coursework."
            items={wsuSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for WSU coursework."
            items={wsuSampleFaq}
            support={wsuSampleFaqSupport}
          />
          <BottomCta data={wsuSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
