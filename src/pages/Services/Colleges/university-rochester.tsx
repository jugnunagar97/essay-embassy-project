      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Rochester Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF ROCHESTER)
// ==========================================

export const urochesterCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Rochester is a selective private research university on the River Campus, known for Simon Business pathways, Hajim Engineering, and quantitative arts and sciences seminars with graduate-level expectations.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Rochester coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Simon & Hajim Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const urochesterStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=247",
    caption: "QS 2026; research intensity in optics, music, and quantitative fields",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Simon, Hajim, and Arts & Sciences expectations",
  },
  {
    icon: "dollar",
...
export const urochesterAlert: AlertBanner = {
  title: "Rochester Semester Alert:",
  body: "Rochester's research-intensive semesters stack Simon analytics, Hajim labs, and arts & sciences seminars—especially before winter break and May finals on the River Campus.",
};

export const urochesterCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, School of Arts & Sciences assignments, and Hajim School of Engineering & Applied Sciences lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the River Campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Simon Business School group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Hajim School of Engineering & Applied Sciences capstones, Simon Business School presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const urochesterDepartments: Department[] = [
  {
    icon: "chart",
    name: "Simon Business School",
    courses: ["ACC 201", "FIN 205", "MKT 221", "CIS 102"],
  },
  {
    icon: "brain",
    name: "Hajim School of Engineering",
    courses: ["CSC 161", "ME 101", "ECE 111", "OPT 241"],
  },
  {
    icon: "book",
    name: "School of Arts & Sciences",
    courses: ["PHIL 101", "ECON 101", "PSYC 101", "WRT 105"],
  },
  {
    icon: "users",
    name: "Warner School of Education",
    courses: ["EDU 200", "EDU 305", "EDU 410", "EDU 450"],
  }
];

export const urochesterProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Simon Business & CIS",
    subtitle: "Quantitative cases with clean logic",
    bullets: [
      "Finance cases with defensible assumptions and sensitivity notes.",
      "CIS analytics assignments with structured methodology.",
      "Professional tone for presentation-ready deliverables.",
    ],
    footnote: "Simon pathways emphasize numbers tied to decisions—we keep analyses rigorous.",
  },
  {
    icon: "brain",
    title: "Hajim Engineering & Optics",
    subtitle: "Technical reports with precision",
    bullets: [
      "Lab reports documenting apparatus, procedure, and uncertainty.",
      "OPT and ECE assignments with appropriate technical vocabulary.",
      "Clear figures and units aligned to Hajim rubrics.",
    ],
    footnote: "Rochester's STEM reputation shows up in grading—we document methods exhaustively.",
  },
  {
    icon: "book",
    title: "Arts & Sciences Seminars",
    subtitle: "Thesis-driven humanities and social science",
    bullets: [
      "WRT 105 essays with revision-ready argument structure.",
      "Economics papers integrating theory and empirical sources.",
      "Chicago or APA citations per department guidance.",
    ],
    footnote: "Seminar faculty want original claims supported by scholarship—not plot recap.",
  }
];

export const urochesterServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const urochesterSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UR-204",
    name: "Nina V.",
    ...
    semester: "Fall 2024",
    quote: "Simon-style case during a brutal optics lab week. Memo was quantitative and needed almost no edits.",
  },
  {
    id: "UR-517",
    name: "Leo F.",
    ...
    quote: "Error analysis section was my weak spot. Writer nailed uncertainty discussion and figure captions.",
  },
  {
    id: "UR-339",
    name: "Emma D.",
    ...
    rating: 5,
    course: "WRT 105",
    serviceUsed: "Argumentative Essay",
    semester: "Fall 2024",
    quote: "Thesis workshop feedback wanted tighter claims. The draft gave me a structure I could refine quickly.",
  }
];

export const urochesterSampleFaq: FaqItem[] = [
  {
    question: "Do you understand Rochester's research-heavy undergraduate culture?",
    answer: "Yes. We assign writers who can match the depth expected even in intro-level seminars.",
  },
  {
    question: "Can you help Hajim lab and optics coursework?",
    answer: "STEM specialists handle methodology, results, and technical discussion sections.",
  },
  {
    question: "Is work original for UR academic honesty?",
    answer: "All drafts are custom-written from your prompt with no recycled content.",
  },
  {
    question: "Do you support Simon quantitative courses?",
    answer: "We cover finance, analytics, and CIS assignments with data-backed writing.",
  }
];

export const urochesterSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Rochester Crunch?",
  name: "Marcus",
  role: "Northeast Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Northeast Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const urochesterSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Rochester Semester Overwhelm You",
  subtitle: "Yellowjackets trust Essay Embassy when research papers and labs overlap on the River Campus. Stay ahead of the curve.",
...
export default function UniversityRochester() {
  return (
    <>
      <title>University of Rochester Essay Help | UR Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for University of Rochester students. Support for Simon business cases, Hajim engineering labs, and arts & sciences research."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-rochester/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={urochesterCollegeData} />
          <Stats stats={urochesterStats} />
          <Alert data={urochesterAlert} />
          <CalendarSection
            eyebrow="Rochester academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Yellowjacket crunch weeks across Simon, Hajim, and arts & sciences."
            periods={urochesterCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Rochester's River Campus"
            subtitle="From Rush Rhees Library to Hajim labs, we align with UR faculty standards."
            departments={urochesterDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Rochester's Research Intensity"
            subtitle="With a top-250 QS global standing, Rochester expects precise, graduate-level thinking even in undergraduate courses."
            cards={urochesterProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Yellowjackets"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={urochesterServiceCards}
          />
          <Testimonials
            eyebrow="Yellowjackets succeeding"
            title="What Rochester Students Tell Us"
            subtitle="Feedback from UR students balancing Simon cases, Hajim labs, and quantitative seminars."
            items={urochesterSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Rochester coursework."
            items={urochesterSampleFaq}
            support={urochesterSampleFaqSupport}
          />
          <BottomCta data={urochesterSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
