      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Trojan Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF SOUTHERN CALIFORNIA)
// ==========================================

export const uscCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "USC is a private research university in Los Angeles with professional-school depth across Marshall, Viterbi, Annenberg, and Dornsife. Assignments often mirror industry pace—case decks, media analyses, and engineering project documentation.",
  cta: {
    primary: { href: "/order-now", label: "Get help for USC coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Marshall & Viterbi Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const uscStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#146",
    caption: "QS 2026; strong visibility in business, cinema, and engineering",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Marshall, Viterbi, and Dornsife expectations",
  },
  {
    icon: "dollar",
...
export const uscAlert: AlertBanner = {
  title: "Los Angeles Semester Alert:",
  body: "USC's fast quarter-and-semester mix means overlapping deadlines. Marshall case decks, Viterbi labs, and Annenberg media analyses peak before finals. Secure a writer before syllabus week gets crowded.",
};

export const uscCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, Dornsife College of Letters, Arts and Sciences assignments, and Viterbi School of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the University Park campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Marshall School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Viterbi School of Engineering capstones, Marshall School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const uscDepartments: Department[] = [
  {
    icon: "chart",
    name: "Marshall School of Business",
    courses: ["BUAD 280", "FBE 401", "ACCT 410", "MKT 402"],
  },
  {
    icon: "brain",
    name: "Viterbi School of Engineering",
    courses: ["CSCI 103", "EE 101", "AME 201", "ISE 370"],
  },
  {
    icon: "quote",
    name: "Annenberg School for Communication",
    courses: ["COMM 206", "JOUR 350", "PR 351", "CMGT 310"],
  },
  {
    icon: "book",
    name: "Dornsife College",
    courses: ["ECON 203", "IR 210", "PSYC 100", "WRIT 150"],
  }
];

export const uscProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Marshall Strategy & Finance",
    subtitle: "Pitch-ready cases with LA industry context",
    bullets: [
      "Slide-ready case narratives with quantified market logic.",
      "Executive summaries that mirror consulting deliverables.",
      "Brand and venture analyses grounded in recent market data.",
    ],
    footnote: "Marshall rewards clarity and commercial realism. We write cases that feel boardroom-ready.",
  },
  {
    icon: "brain",
    title: "Viterbi Engineering & CS",
    subtitle: "Technical depth for labs and design projects",
    bullets: [
      "Clean documentation for programming and systems assignments.",
      "Structured lab reports with test plans and results analysis.",
      "Appropriate technical tone for upper-division engineering courses.",
    ],
    footnote: "Viterbi TAs look for reproducible logic. We explain code, data, and design choices step by step.",
  },
  {
    icon: "quote",
    title: "Annenberg Media & Communication",
    subtitle: "Theory-rich writing with professional polish",
    bullets: [
      "Media analysis papers linking theory to contemporary campaigns.",
      "APA-heavy research writing for communication and journalism courses.",
      "Argumentation beyond summary—clear claims and evidence chains.",
    ],
    footnote: "Annenberg sits in a global media capital. We connect coursework to real industry discourse.",
  }
];

export const uscServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const uscSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "USC-204",
    name: "Alyssa P.",
    ...
    rating: 5,
    course: "BUAD 280",
    serviceUsed: "Case Deck",
    semester: "Fall 2024",
    quote: "Marshall case night overlapped with a midterm. The writer delivered tight exhibits and a one-page executive summary that matched our grading sheet.",
  },
  {
    id: "USC-517",
    name: "Kevin N.",
    ...
    quote: "Documentation was dragging my grade down. Got clear pseudocode explanations and test-case discussion that satisfied the TA rubric.",
  },
  {
    id: "USC-339",
    name: "Mia C.",
    ...
    semester: "Fall 2024",
    quote: "The paper integrated theory with current campaigns and stayed in perfect APA. Minimal edits before submission.",
  }
];

export const uscSampleFaq: FaqItem[] = [
  {
    question: "Do you cover Marshall, Viterbi, and Annenberg formatting rules?",
    answer: "Yes. We assign writers who know business case structures, engineering report standards, and communication research styles.",
  },
  {
    question: "Can you help busy students balancing internships in LA?",
    answer: "Many Trojans intern while studying. We handle urgent turnarounds so you can protect grades during busy weeks.",
  },
  {
    question: "Will USC Blackboard integrity tools flag your work?",
    answer: "We deliver 100% original drafts from your prompt. No recycled content or AI-generated text.",
  },
  {
    question: "Do you support WRIT 150 and Dornsife core classes?",
    answer: "Absolutely. We help with argument structure, citation, and revision for writing-intensive Dornsife requirements.",
  }
];

export const uscSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the LA Crunch?",
  name: "Marcus",
  role: "West Coast Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, West Coast Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const uscSampleBottomCta: BottomCtaData = {
  title: "Do not Let the USC Semester Overwhelm You",
  subtitle: "USC Trojans rely on Essay Embassy when internships, labs, and case work collide. Stay competitive without burning out.",
...
export default function UniversitySouthernCalifornia() {
  return (
    <>
      <title>USC Essay Help | University of Southern California Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for USC students. Tailored support for Marshall business cases, Viterbi engineering labs, and Annenberg communication papers."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-southern-california/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={uscCollegeData} />
          <Stats stats={uscStats} />
          <Alert data={uscAlert} />
          <CalendarSection
            eyebrow="USC academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate LA's academic rhythm across Marshall, Viterbi, Dornsife, and Annenberg deadlines."
            periods={uscCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering USC's Core Schools"
            subtitle="From University Park to health sciences corridors, we match USC faculty expectations."
            departments={uscDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for USC's Competitive Standards"
            subtitle="With a top-150 QS global rank, USC expects polished, industry-aware academic work."
            cards={uscProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Trojans"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={uscServiceCards}
          />
          <Testimonials
            eyebrow="Trojans succeeding"
            title="What USC Students Tell Us"
            subtitle="Feedback from Trojans balancing Marshall cases, Viterbi projects, and Dornsife research."
            items={uscSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for USC coursework."
            items={uscSampleFaq}
            support={uscSampleFaqSupport}
          />
          <BottomCta data={uscSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
