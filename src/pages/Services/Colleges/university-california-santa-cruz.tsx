      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Slug Quarter Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF CALIFORNIA, SANTA CRUZ)
// ==========================================

export const ucscCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "UC Santa Cruz is a University of California campus on the quarter system with Baskin School of Engineering, physical and biological sciences, and coastal research strengths among the redwoods.",
  cta: {
    primary: { href: "/order-now", label: "Get help for UCSC coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Baskin & Sciences Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const ucscStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=465",
    caption: "QS 2026 UC campus; coastal STEM and games-related strengths",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Baskin Engineering, Physical/Biological Sciences, and Social Sciences expectations",
  },
  {
    icon: "dollar",
...
export const ucscAlert: AlertBanner = {
  title: "Santa Cruz Quarter Alert:",
  body: "UCSC's quarter system stacks Baskin project reports, science lab write-ups, and social science essays into fast 10-week terms. Slug midterms peak in weeks 4 and 8 on Canvas.",
};

export const ucscCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, Social Sciences Division assignments, and Physical and Biological Sciences lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Santa Cruz campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Baskin School of Engineering group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Physical and Biological Sciences capstones, Baskin School of Engineering presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const ucscDepartments: Department[] = [
  {
    icon: "brain",
    name: "Baskin School of Engineering",
    courses: ["CSE 20", "AM 10", "ECE 101", "CSE 30"],
  },
  {
    icon: "book",
    name: "Physical and Biological Sciences",
    courses: ["CHEM 1A", "BIOL 20A", "PHYS 5A", "ASTR 1"],
  },
  {
    icon: "users",
    name: "Social Sciences Division",
    courses: ["ECON 1", "PSYC 1", "SOC 1", "POLI 1"],
  },
  {
    icon: "quote",
    name: "Humanities Division",
    courses: ["HIS 10A", "LIT 1", "PHIL 11", "FMST 1"],
  }
];

export const ucscProfessorCards: ProfessorIntel[] = [
  {
    icon: "brain",
    title: "Baskin Engineering & CSE",
    subtitle: "Quarter-paced technical writing",
    bullets: [
      "CSE project documentation explaining algorithms and testing.",
      "AM and ECE lab reports with clear methodology.",
      "Technical tone for Baskin faculty.",
    ],
    footnote: "Baskin grades how you explain work—not just outcomes.",
  },
  {
    icon: "book",
    title: "Science Labs & Field Courses",
    subtitle: "Coastal and lab precision",
    bullets: [
      "Biology and chemistry lab reports with discussion and error analysis.",
      "Ecology papers connecting field data to theory.",
      "APA structure across science courses.",
    ],
    footnote: "UCSC science faculty expect reproducible methods—we document them clearly.",
  },
  {
    icon: "users",
    ...
    bullets: [
      "ECON and POLI essays with thesis-led arguments.",
      "Humanities papers with close reading and citations.",
      "MLA or Chicago per department guidance.",
    ],
    footnote: "Seminars grade depth—we deliver argument-led scholarship, not summaries.",
  }
];

export const ucscServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const ucscSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UCSC-204",
    name: "Leo V.",
    ...
    semester: "Fall 2024",
    quote: "CSE project during week 4 quarter crunch. Documentation passed the TA rubric first try.",
  },
  {
    id: "UCSC-517",
    name: "Maya I.",
    ...
    quote: "Lab discussion needed ecological interpretation. Writer nailed the coastal context.",
  },
  {
    id: "UCSC-339",
    name: "Sam R.",
    ...
    semester: "Fall 2024",
    quote: "Needed sharper institutional analysis. Draft needed only light edits.",
  }
];

export const ucscSampleFaq: FaqItem[] = [
  {
    question: "Do you understand UCSC's quarter system?",
    answer: "Yes. We offer fast turnarounds aligned to quarter midterms and finals.",
  },
  {
    question: "Can you help Baskin CSE and AM combined workloads?",
    answer: "STEM specialists handle code documentation and formal reports together.",
  },
  {
    question: "Is work original for UCSC academic integrity?",
    answer: "Every paper is written from scratch from your prompt.",
  },
  {
    question: "Do you cover marine and ecology field coursework?",
    answer: "Yes. Science writers handle field-lab and research papers in those tracks.",
  }
];

export const ucscSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Santa Cruz Quarter Crunch?",
  name: "Marcus",
...
export const ucscSampleBottomCta: BottomCtaData = {
  title: "Do not Let the UCSC Quarter Overwhelm You",
  subtitle: "Banana Slugs trust Essay Embassy when quarter deadlines stack on Canvas. Protect your GPA through peak weeks.",
...
export default function UniversityCaliforniaSantaCruz() {
  return (
    <>
      <title>UC Santa Cruz Essay Help | UCSC Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for UC Santa Cruz students. Support for Baskin engineering projects, science lab reports, and social sciences research."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-california-santa-cruz/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={ucscCollegeData} />
          <Stats stats={ucscStats} />
          <Alert data={ucscAlert} />
          <CalendarSection
            eyebrow="UCSC academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Banana Slug quarter peaks across engineering, sciences, and humanities."
            periods={ucscCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering UCSC's Coastal UC Core"
            subtitle="From the redwoods to Baskin labs, we match UC Santa Cruz faculty expectations."
            departments={ucscDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for UCSC's UC Standards"
            subtitle="With a top-470 QS global rank, Santa Cruz expects rigorous, well-cited work on quarter timelines."
            cards={ucscProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Banana Slugs"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={ucscServiceCards}
          />
          <Testimonials
            eyebrow="Banana Slugs succeeding"
            title="What UCSC Students Tell Us"
            subtitle="Feedback from Slugs balancing Baskin projects, science labs, and social science research."
            items={ucscSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for UCSC coursework."
            items={ucscSampleFaq}
            support={ucscSampleFaqSupport}
          />
          <BottomCta data={ucscSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
