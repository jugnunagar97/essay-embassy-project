      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Husky Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (NORTHEASTERN UNIVERSITY)
// ==========================================

export const neuCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  type: "Private Research University (Co-op)",
  studentsLabel: "Trusted by Northeastern Huskies",
  description:
    "Northeastern is a Boston-based private research university known for co-op and experiential learning across D'Amore-McKim, Khoury College of Computer Sciences, and College of Social Sciences and Humanities.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Northeastern coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "McKim & Khoury Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const neuStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=410",
    caption: "QS 2026; experiential learning and co-op integration",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with D'Amore-McKim, Khoury, and CSSH expectations",
  },
  {
    icon: "dollar",
...
export const neuAlert: AlertBanner = {
  title: "Boston Co-op Semester Alert:",
  body: "Northeastern's co-op calendar compresses McKim cases, Khoury project reports, and CSSH seminar papers between work terms. Book writers before Canvas peaks during accelerated semesters.",
};

export const neuCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Social Sciences and Humanities assignments, and Khoury College of Computer Sciences lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Boston campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and D'Amore-McKim School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Khoury College of Computer Sciences capstones, D'Amore-McKim School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const neuDepartments: Department[] = [
  {
    icon: "chart",
    name: "D'Amore-McKim School of Business",
    courses: ["FINA 2201", "MKTG 2201", "ACCT 1201", "ENTR 2201"],
  },
  {
    icon: "brain",
    name: "Khoury College of Computer Sciences",
    courses: ["CS 2500", "CS 3500", "DS 2500", "CS 1800"],
  },
  {
    icon: "book",
    name: "Social Sciences and Humanities",
    courses: ["ECON 1115", "PSYC 1101", "PHIL 1101", "ENGW 1111"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["GE 1110", "ME 2350", "EECE 2160", "BIOE 2350"],
  }
];

export const neuProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "McKim Cases & Analytics",
    subtitle: "Professional, co-op-ready deliverables",
    bullets: [
      "Finance cases with exhibits and executive summaries.",
      "Marketing plans with measurable KPIs.",
      "Tone suited to McKim presentation rubrics.",
    ],
    footnote: "McKim cases should read like workplace memos—we deliver that polish.",
  },
  {
    icon: "brain",
    title: "Khoury CS & Data Science",
    subtitle: "Code plus documentation bundles",
    bullets: [
      "CS 2500/3500 reports explaining algorithms and testing.",
      "Data science assignments with reproducible methodology.",
      "Clear technical communication for Khoury TAs.",
    ],
    footnote: "Khoury grades how you explain code—not just that it runs.",
  },
  {
    icon: "book",
    title: "CSSH Seminars & ENGW",
    subtitle: "Argument-driven Boston writing",
    bullets: [
      "ENGW essays with thesis clarity and revision-ready flow.",
      "Economics papers connecting theory to data.",
      "APA or MLA citations per course requirements.",
    ],
    footnote: "CSSH seminars punish summary-only writing—we build original claims.",
  }
];

export const neuServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const neuSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "NEU-204",
    name: "Daniel H.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "McKim case during co-op search week. Memo was professional and Canvas-ready.",
  },
  {
    id: "NEU-517",
    name: "Priya A.",
    ...
    quote: "Needed software design documentation fast. TA rubric passed first try.",
  },
  {
    id: "NEU-339",
    name: "Luke M.",
    ...
    semester: "Fall 2024",
    quote: "Empirical essay needed cleaner policy linkage. Strong draft with minor edits.",
  }
];

export const neuSampleFaq: FaqItem[] = [
  {
    question: "Do you help students on co-op or accelerated schedules?",
    answer: "Yes. We offer expedited turnarounds when work terms compress academic deadlines.",
  },
  {
    question: "Can you support Khoury CS and DS combined deliverables?",
    answer: "We coordinate code explanations and formal reports in one package.",
  },
  {
    question: "Is work original for Northeastern academic integrity?",
    answer: "All papers are custom-written from your prompt with no AI text.",
  },
  {
    question: "Do you cover ENGW writing-intensive courses?",
    answer: "Yes. We help structure arguments while preserving your voice.",
  }
];

export const neuSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Boston Co-op Crunch?",
  name: "Marcus",
...
export const neuSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Northeastern Semester Overwhelm You",
  subtitle: "Huskies trust Essay Embassy when co-op interviews and coursework collide. Protect your GPA through busy terms.",
...
export default function NortheasternUniversity() {
  return (
    <>
      <title>Northeastern University Essay Help | NEU Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Northeastern students. Support for D'Amore-McKim business cases, Khoury computing projects, and CSSH research in Boston."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/northeastern-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={neuCollegeData} />
          <Stats stats={neuStats} />
          <Alert data={neuAlert} />
          <CalendarSection
            eyebrow="Northeastern academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Husky deadlines across co-op cycles, McKim, and Khoury workloads."
            periods={neuCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Northeastern's Experiential Core"
            subtitle="From Centennial to Khoury labs, we match co-op-era faculty expectations."
            departments={neuDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Northeastern's Experiential Bar"
            subtitle="With a top-410 QS global rank, Northeastern expects professional, rubric-aligned academic work."
            cards={neuProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Huskies"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={neuServiceCards}
          />
          <Testimonials
            eyebrow="Huskies succeeding"
            title="What Northeastern Students Tell Us"
            subtitle="Feedback from Huskies balancing co-op prep, McKim cases, and Khoury projects."
            items={neuSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Northeastern coursework."
            items={neuSampleFaq}
            support={neuSampleFaqSupport}
          />
          <BottomCta data={neuSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
