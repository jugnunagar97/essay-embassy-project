      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Gopher Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF MINNESOTA)
// ==========================================

export const umnCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  type: "Public Research University (Twin Cities flagship)",
  studentsLabel: "Trusted by Minnesota Golden Gophers",
  description:
    "The University of Minnesota's Twin Cities campus is the system's research flagship—home to Carlson School of Management, College of Science and Engineering, and liberal arts and public health programs in Minneapolis–Saint Paul.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Minnesota coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Carlson & CSE Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const umnStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=212",
    caption: "QS 2026 system rank; Twin Cities hosts Carlson and CSE",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Carlson, CSE, and CLA expectations",
  },
  {
    icon: "dollar",
...
export const umnAlert: AlertBanner = {
  title: "Twin Cities Semester Alert:",
  body: "Minnesota winters do not slow deadlines. Carlson cases, CSE labs, and CLA seminar papers peak before Thanksgiving and again in late April. Book early when Canvas queues spike.",
};

export const umnCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Liberal Arts assignments, and College of Science and Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Twin Cities campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Carlson School of Management group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Science and Engineering capstones, Carlson School of Management presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const umnDepartments: Department[] = [
  {
    icon: "chart",
    name: "Carlson School of Management",
    courses: ["MGMT 3001", "FINA 3001", "ACCT 3001", "MKTG 3001"],
  },
  {
    icon: "brain",
    name: "College of Science and Engineering",
    courses: ["CSCI 1133", "ME 2011", "EE 3001", "BMEN 3501"],
  },
  {
    icon: "book",
    name: "College of Liberal Arts",
    courses: ["PSY 1001", "ECON 1101", "POL 1001", "WRIT 1301"],
  },
  {
    icon: "stethoscope",
    name: "School of Public Health",
    courses: ["PUBH 3001", "EPID 5001", "HLTH 3001", "PUBH 5101"],
  }
];

export const umnProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Carlson Case & Analytics",
    subtitle: "Quantified business writing",
    bullets: [
      "Case memos with financial logic and actionable recommendations.",
      "Marketing plans with measurable KPIs.",
      "Professional formatting for Carlson presentation rubrics.",
    ],
    footnote: "Carlson cases reward concise analysis backed by numbers—not generic frameworks.",
  },
  {
    icon: "brain",
    title: "CSE Labs & Computing",
    subtitle: "STEM clarity through Minnesota winters",
    bullets: [
      "Lab reports with explicit methods and discussion of error.",
      "CSCI documentation explaining algorithms and testing.",
      "Technical tone suitable for upper-division CSE courses.",
    ],
    footnote: "CSE faculty expect reproducible work— we document assumptions and results clearly.",
  },
  {
    icon: "stethoscope",
    title: "Public Health & CLA",
    subtitle: "Evidence-based social and health writing",
    bullets: [
      "Policy briefs citing peer-reviewed epidemiology.",
      "CLA essays with thesis-driven arguments and proper citations.",
      "APA formatting across psychology and health courses.",
    ],
    footnote: "Public health assignments need current literature—we source recent, credible studies.",
  }
];

export const umnServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const umnSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UMN-204",
    name: "Olivia R.",
    major: "Marketing",
    ...
    rating: 5,
    course: "MKTG 3001",
    serviceUsed: "Marketing Plan",
    semester: "Fall 2024",
    quote: "Carlson presentation rubric was strict on KPIs. The writer built a credible plan we used almost verbatim in slides.",
  },
  {
    id: "UMN-517",
    name: "Ethan P.",
    ...
    quote: "Discussion section needed real statistical care. Delivered on time before a brutal midterm week.",
  },
  {
    id: "UMN-339",
    name: "Hana S.",
    ...
    semester: "Fall 2024",
    quote: "Brief required recent epidemiology sources. Structure and citations were spot-on for my program director.",
  }
];

export const umnSampleFaq: FaqItem[] = [
  {
    question: "Do you support Canvas courses on the Twin Cities campus?",
    answer: "Yes. Share your Canvas rubric—we match length, citation style, and assignment type.",
  },
  {
    question: "Can you help Carlson presentation-heavy courses?",
    answer: "We deliver memo and slide-ready content aligned to Carlson grading sheets.",
  },
  {
    question: "Is work original under Minnesota academic standards?",
    answer: "Every paper is custom-written from your prompt with no recycled content.",
  },
  {
    question: "Do you cover public health graduate writing?",
    answer: "Yes. Graduate briefs and literature reviews go to health sciences specialists.",
  }
];

export const umnSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Twin Cities Crunch?",
  name: "Marcus",
  role: "Upper Midwest Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Upper Midwest Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const umnSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Minnesota Semester Overwhelm You",
  subtitle: "Golden Gophers trust Essay Embassy when Canvas deadlines stack through cold-weather midterms. Stay on track all semester.",
...
export default function UniversityMinnesotaSystem() {
  return (
    <>
      <title>University of Minnesota Essay Help | UMN Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for University of Minnesota students. Support for Carlson business cases, CSE engineering labs, and CLA research papers in Minneapolis."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-minnesota-system/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={umnCollegeData} />
          <Stats stats={umnStats} />
          <Alert data={umnAlert} />
          <CalendarSection
            eyebrow="Minnesota academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Twin Cities crunch weeks across Carlson, CSE, and CLA programs."
            periods={umnCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering the U of M Twin Cities Core"
            subtitle="From Northrop Mall to engineering halls, we know what Minnesota faculty expect."
            departments={umnDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Minnesota Research Standards"
            subtitle="With a top-215 global QS standing, the U of M expects rigorous, well-cited academic work."
            cards={umnProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Golden Gophers"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={umnServiceCards}
          />
          <Testimonials
            eyebrow="Gophers succeeding"
            title="What Minnesota Students Tell Us"
            subtitle="Feedback from Gophers balancing Carlson analytics, CSE projects, and CLA seminars."
            items={umnSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Minnesota coursework."
            items={umnSampleFaq}
            support={umnSampleFaqSupport}
          />
          <BottomCta data={umnSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
