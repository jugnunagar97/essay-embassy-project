      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Sun Devil Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (ARIZONA STATE UNIVERSITY)
// ==========================================

export const asuCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  type: "Innovation-Focused Public University",
  studentsLabel: "Trusted by ASU Sun Devils",
  description:
    "Arizona State is a large public university system anchored in Tempe, recognized for innovation, online-plus-campus scale, and sustainability research. Support covers W. P. Carey, Ira A. Fulton Engineering, Cronkite journalism, and high-enrollment CLAS courses.",
  cta: {
    primary: { href: "/order-now", label: "Get help for ASU coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Carey & Fulton Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const asuStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "95.2",
    caption: "High QS international research network score (2026 edition)",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with W. P. Carey, Fulton Engineering, and Cronkite expectations",
  },
  {
    icon: "dollar",
...
export const asuAlert: AlertBanner = {
  title: "Tempe Semester Pace Alert:",
  body: "ASU's multi-campus system moves quickly. Carey analytics projects, Fulton design labs, and Cronkite reporting deadlines often overlap before session finals. Book early during October and April peaks.",
};

export const asuCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Liberal Arts and Sciences assignments, and Ira A. Fulton Schools of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Tempe and metro campuses.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and W. P. Carey School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Ira A. Fulton Schools of Engineering capstones, W. P. Carey School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const asuDepartments: Department[] = [
  {
    icon: "chart",
    name: "W. P. Carey School of Business",
    courses: ["ACC 231", "FIN 300", "MKT 400", "SCM 300"],
  },
  {
    icon: "brain",
    name: "Ira A. Fulton Schools of Engineering",
    courses: ["CSE 110", "EEE 202", "MAE 214", "BME 350"],
  },
  {
    icon: "quote",
    name: "Walter Cronkite School",
    courses: ["JMC 101", "JMC 201", "PR 371", "MED 394"],
  },
  {
    icon: "book",
    name: "College of Liberal Arts and Sciences",
    courses: ["PSY 101", "POS 110", "BIO 181", "ENG 101"],
  }
];

export const asuProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Carey Business & Analytics",
    subtitle: "Data-informed cases with clean visuals",
    bullets: [
      "Analytics memos with charts tied to clear recommendations.",
      "Marketing and finance assignments aligned to Carey rubrics.",
      "Concise writing for high-enrollment online and in-person sections.",
    ],
    footnote: "Carey emphasizes measurable outcomes. We connect data to decisions without filler.",
  },
  {
    icon: "brain",
    title: "Fulton Engineering & Computing",
    subtitle: "Build-ready documentation",
    bullets: [
      "Software project reports with architecture and testing sections.",
      "Engineering labs with assumptions, calculations, and results.",
      "Technical tone suitable for Fulton upper-division courses.",
    ],
    footnote: "Fulton projects often grade process as heavily as outcomes. We document both thoroughly.",
  },
  {
    icon: "quote",
    title: "Cronkite Journalism & Media",
    subtitle: "AP-aware reporting and analysis",
    bullets: [
      "News writing with tight ledes and verified sourcing.",
      "Media criticism essays linking industry trends to theory.",
      "PR plans with audience segmentation and measurable KPIs.",
    ],
    footnote: "Cronkite faculty expect publishable clarity. We edit for structure, accuracy, and style.",
  }
];

export const asuServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const asuSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "ASU-204",
    name: "Tyler J.",
    major: "Marketing",
    ...
    rating: 5,
    course: "MKT 400",
    serviceUsed: "Campaign Plan",
    semester: "Fall 2024",
    quote: "Carey group project needed a credible media plan fast. The writer delivered audience insights and KPIs we used directly in our presentation.",
  },
  {
    id: "ASU-517",
    name: "Sofia L.",
    ...
    rating: 5,
    course: "CSE 110",
    serviceUsed: "Project Documentation",
    semester: "Spring 2024",
    quote: "Coding was fine but the write-up was weak. Got clear testing and architecture sections that boosted my grade.",
  },
  {
    id: "ASU-339",
    name: "Noah R.",
    ...
    rating: 5,
    course: "JMC 201",
    serviceUsed: "Feature Article",
    semester: "Fall 2024",
    quote: "Cronkite standards are strict on sourcing. The draft had clean structure and quotes placeholders I filled after interviews.",
  }
];

export const asuSampleFaq: FaqItem[] = [
  {
    question: "Do you support ASU Online and in-person courses?",
    answer: "Yes. Rubrics are often shared across modalities. Send your prompt and we match the same quality standards.",
  },
  {
    question: "Can you help with sustainability and innovation-themed assignments?",
    answer: "ASU emphasizes innovation. We incorporate current sustainability and policy sources when your brief requires them.",
  },
  {
    question: "Will Canvas originality checks pass?",
    answer: "We write from scratch only. No databases, no AI text, no recycled student papers.",
  },
  {
    question: "Do you handle Fulton coding plus report bundles?",
    answer: "Absolutely. We can deliver code explanations and formal reports in one coordinated package.",
  }
];

export const asuSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Tempe Crunch?",
  name: "Marcus",
  role: "Southwest Academic Advisor",
  imageSrc: "/images/writers/Marcus-East-Coast.jpg",
  imageAlt: "Marcus, Southwest Academic Advisor",
  contactHref: "/contact",
  contactLabel: "Chat about your assignment",
};

export const asuSampleBottomCta: BottomCtaData = {
  title: "Do not Let the ASU Semester Overwhelm You",
  subtitle: "Sun Devils use Essay Embassy when innovation projects, labs, and media assignments stack up. Protect your GPA through peak weeks.",
...
export default function ArizonaStateUniversity() {
  return (
    <>
      <title>ASU Essay Help | Arizona State University Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for ASU students. Tailored support for W. P. Carey business cases, Fulton engineering labs, and Cronkite journalism assignments."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/arizona-state-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={asuCollegeData} />
          <Stats stats={asuStats} />
          <Alert data={asuAlert} />
          <CalendarSection
            eyebrow="ASU academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Stay ahead of Sun Devil deadlines across Carey, Fulton, CLAS, and Cronkite."
            periods={asuCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering ASU's Innovation Ecosystem"
            subtitle="From Tempe to downtown Phoenix hubs, we match ASU's interdisciplinary expectations."
            departments={asuDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for ASU's Scale and Innovation"
            subtitle="With rising global QS standing and major online-plus-campus enrollment, ASU demands flexible, high-quality academic work."
            cards={asuProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Sun Devils"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={asuServiceCards}
          />
          <Testimonials
            eyebrow="Sun Devils succeeding"
            title="What ASU Students Tell Us"
            subtitle="Feedback from Sun Devils balancing Carey cases, Fulton labs, and Cronkite assignments."
            items={asuSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for ASU coursework."
            items={asuSampleFaq}
            support={asuSampleFaqSupport}
          />
          <BottomCta data={asuSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
