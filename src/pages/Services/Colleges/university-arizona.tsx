      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Wildcat Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (THE UNIVERSITY OF ARIZONA)
// ==========================================

export const uarizonaCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "The University of Arizona is a public research university in Tucson with Eller College of Management, College of Engineering, and strong optical and space-science research portfolios.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Arizona coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Eller & Engineering Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const uarizonaStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "#293",
    caption: "QS 2026; optics, space sciences, and desert-region research",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Eller, Engineering, and COLLE expectations",
  },
  {
    icon: "dollar",
...
export const uarizonaAlert: AlertBanner = {
  title: "Tucson Semester Pace Alert:",
  body: "Arizona's D2L-heavy semesters stack Eller case memos, engineering labs, and COLLE research papers before fall and spring finals. Wildcats midterms spike demand in October and March.",
};

export const uarizonaCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Tucson campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Eller College of Management group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "College of Engineering capstones, Eller College of Management presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const uarizonaDepartments: Department[] = [
  {
    icon: "chart",
    name: "Eller College of Management",
    courses: ["ACCT 250", "FIN 311", "MKTG 361", "BNAD 301"],
  },
  {
    icon: "brain",
    name: "College of Engineering",
    courses: ["ENGR 102", "ME 250", "ECE 175", "CSC 110"],
  },
  {
    icon: "book",
    name: "College of Liberal Arts and Sciences",
    courses: ["PSY 101", "ECON 200", "MATH 122A", "ENGL 101"],
  },
  {
    icon: "users",
    name: "Social and Behavioral Sciences",
    courses: ["SOC 200", "POL 201", "GEOG 210", "ANTH 200"],
  }
];

export const uarizonaProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Eller Business & Finance",
    subtitle: "Case memos with Southwest market context",
    bullets: [
      "Finance cases with quantified assumptions and clean exhibits.",
      "Marketing plans aligned to Eller presentation rubrics.",
      "Professional tone for internship-heavy semesters.",
    ],
    footnote: "Eller graders want data-backed decisions—not generic strategy language.",
  },
  {
    icon: "brain",
    title: "Engineering & Computer Science",
    subtitle: "Labs with reproducible STEM writing",
    bullets: [
      "ME and ECE lab reports with explicit methodology.",
      "CSC documentation explaining logic and testing.",
      "Technical vocabulary suited to UA engineering faculty.",
    ],
    footnote: "Engineering TAs grade process and clarity—we document both thoroughly.",
  },
  {
    icon: "book",
    title: "COLLE Seminars & Social Science",
    subtitle: "Evidence-led desert-region scholarship",
    bullets: [
      "Research papers citing peer-reviewed sources in APA.",
      "Policy essays connecting theory to Southwest contexts.",
      "Thesis-driven humanities writing beyond summary.",
    ],
    footnote: "COLLE seminars reward original claims supported by literature.",
  }
];

export const uarizonaServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const uarizonaSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UA-204",
    name: "Riley S.",
    major: "Finance",
    ...
    semester: "Fall 2024",
    quote: "Eller case during a brutal exam week. Writer delivered clean exhibits and a tight executive summary for D2L upload.",
  },
  {
    id: "UA-517",
    name: "Marco D.",
    ...
    quote: "Needed documentation beyond working code. TA rubric was satisfied on first submission.",
  },
  {
    id: "UA-339",
    name: "Hannah W.",
    ...
    semester: "Fall 2024",
    quote: "Literature review needed current APA sources. Structure was strong with only light edits.",
  }
];

export const uarizonaSampleFaq: FaqItem[] = [
  {
    question: "Do you support D2L rubrics at the University of Arizona?",
    answer: "Yes. Share your D2L prompt and we align format, citations, and length requirements.",
  },
  {
    question: "Can you help Eller team case projects?",
    answer: "We deliver memo sections and analyses your group can integrate into slides.",
  },
  {
    question: "Is work original for UA academic integrity?",
    answer: "All content is custom-written from your instructions with no recycled or AI-generated text.",
  },
  {
    question: "Do you cover optics and space-science coursework?",
    answer: "Yes. STEM specialists handle technical labs and research reports in those tracks.",
  }
];

export const uarizonaSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Tucson Crunch?",
  name: "Marcus",
...
export const uarizonaSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Arizona Semester Overwhelm You",
  subtitle: "Wildcats trust Essay Embassy when D2L deadlines and desert-semester workloads overlap. Stay on track through peak weeks.",
...
export default function UniversityArizona() {
  return (
    <>
      <title>University of Arizona Essay Help | UA Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for University of Arizona students. Support for Eller business cases, engineering labs, and COLLE research in Tucson."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-arizona/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={uarizonaCollegeData} />
          <Stats stats={uarizonaStats} />
          <Alert data={uarizonaAlert} />
          <CalendarSection
            eyebrow="Arizona academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Plan for Wildcat crunch weeks across Eller, Engineering, and liberal arts programs."
            periods={uarizonaCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Arizona's Academic Core"
            subtitle="From the Mall to STEM complexes, we align with UA faculty rubrics on D2L."
            departments={uarizonaDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Arizona Research Standards"
            subtitle="With a top-300 QS global rank, Arizona expects well-sourced, discipline-appropriate academic work."
            cards={uarizonaProfessorCards}
          />
          <Services
            ...
            cards={uarizonaServiceCards}
          />
          <Testimonials
            eyebrow="Wildcats succeeding"
            title="What Arizona Students Tell Us"
            subtitle="Feedback from Wildcats balancing Eller cases, engineering labs, and COLLE seminars."
            items={uarizonaSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Arizona coursework."
            items={uarizonaSampleFaq}
            support={uarizonaSampleFaqSupport}
          />
          <BottomCta data={uarizonaSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
