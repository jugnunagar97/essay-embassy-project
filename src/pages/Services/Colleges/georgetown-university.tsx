      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Hoya Semester Pace
          </span>
...
// ==========================================
// TAILORED DATA (GEORGETOWN UNIVERSITY)
// ==========================================

export const guCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "Georgetown is a private research university in Washington, D.C., anchored by Walsh School of Foreign Service, McDonough School of Business, and policy-heavy liberal arts on the Hilltop campus.",
  cta: {
    primary: { href: "/order-now", label: "Get help for Georgetown coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "McDonough & Walsh SFS Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const guStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=287",
    caption: "QS 2026; global policy, international relations, and business",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with McDonough, Walsh SFS, and College expectations",
  },
  {
    icon: "dollar",
...
export const guAlert: AlertBanner = {
  title: "DC Semester Pace Alert:",
  body: "Georgetown's policy-heavy workload stacks Walsh SFS briefs, McDonough cases, and seminar essays—especially when internships intensify in fall and spring. Reserve writers before midterm week on Canvas.",
};

export const guCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, College of Arts & Sciences assignments, and Walsh School of Foreign Service lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Hilltop campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and McDonough School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Walsh School of Foreign Service capstones, McDonough School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const guDepartments: Department[] = [
  {
    icon: "chart",
    name: "McDonough School of Business",
    courses: ["ACCT 101", "FIN 101", "MARK 220", "OPIM 360"],
  },
  {
    icon: "users",
    name: "Walsh School of Foreign Service",
    courses: ["GOVX 200", "INAF 100", "SFS 140", "IPOL 320"],
  },
  {
    icon: "book",
    name: "College of Arts & Sciences",
    courses: ["GOVT 020", "ECON 101", "PHIL 015", "HIST 109"],
  },
  {
    icon: "stethoscope",
    name: "School of Nursing",
    courses: ["NURS 100", "NURS 200", "NURS 300", "NURS 400"],
  }
];

export const guProfessorCards: ProfessorIntel[] = [
  {
    icon: "users",
    title: "Walsh SFS Policy Writing",
    subtitle: "Current, sourced international affairs analysis",
    bullets: [
      "Policy briefs citing credible international relations scholarship.",
      "GOVX essays linking institutions to contemporary global events.",
      "Clear recommendations appropriate to SFS rubrics.",
    ],
    footnote: "SFS faculty expect currency and credibility—we cite recent, authoritative sources.",
  },
  {
    icon: "chart",
    title: "McDonough Business Cases",
    subtitle: "Finance and marketing with executive clarity",
    bullets: [
      "Case memos with exhibits and quantified recommendations.",
      "Marketing plans with measurable KPIs.",
      "Professional tone for Hilltop presentation standards.",
    ],
    footnote: "McDonough cases must be concise and analytical—not descriptive overviews.",
  },
  {
    icon: "book",
    title: "College Seminars & Nursing",
    subtitle: "Evidence-based writing across disciplines",
    bullets: [
      "GOVT and ECON papers with thesis-led arguments.",
      "Nursing reflections with APA and privacy-aware clinical detail.",
      "Humanities citations in Chicago or MLA as required.",
    ],
    footnote: "Whether on the Hilltop or in clinical courses, evidence drives grades—we deliver it.",
  }
];

export const guServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const guSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "GU-204",
    name: "Victoria N.",
    ...
    semester: "Fall 2024",
    quote: "SFS brief due during internship week. Writer used current sources and structured recommendations exactly to the rubric.",
  },
  {
    id: "GU-517",
    name: "Michael B.",
    ...
    quote: "McDonough case needed clean exhibits. Delivered quantitative analysis we used directly in class.",
  },
  {
    id: "GU-339",
    name: "Sana K.",
    ...
    semester: "Fall 2024",
    quote: "Clinical reflection needed APA care and privacy awareness. Draft was thoughtful with only light personalization.",
  }
];

export const guSampleFaq: FaqItem[] = [
  {
    question: "Do you understand Walsh SFS policy brief standards?",
    answer: "Yes. We assign writers with international relations training who cite current, credible sources.",
  },
  {
    question: "Can you help McDonough cases during internship semesters?",
    answer: "We offer expedited turnarounds when DC internships compress your study time.",
  },
  {
    question: "Is work original for Georgetown academic integrity?",
    answer: "Every draft is custom-written from your prompt—no AI, banks, or recycled papers.",
  },
  {
    question: "Do you support nursing and pre-health writing?",
    answer: "Yes. Clinical and reflection papers follow APA and program-specific rubrics.",
  }
];

export const guSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the DC Crunch?",
  name: "Marcus",
...
export const guSampleBottomCta: BottomCtaData = {
  title: "Do not Let the Georgetown Semester Overwhelm You",
  subtitle: "Hoyas trust Essay Embassy when policy briefs, cases, and seminars collide with DC internships. Stay on track and original.",
...
export default function GeorgetownUniversity() {
  return (
    <>
      <title>Georgetown University Essay Help | Georgetown Assignment Writing Service</title>
      <meta
        name="description"
        content="Expert academic writing for Georgetown students. Support for Walsh SFS policy papers, McDonough business cases, and College of Arts & Sciences research."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/georgetown-university/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={guCollegeData} />
          <Stats stats={guStats} />
          <Alert data={guAlert} />
          <CalendarSection
            eyebrow="Georgetown academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Hilltop deadline peaks across McDonough, Walsh SFS, and arts & sciences."
            periods={guCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering Georgetown's Hilltop Core"
            subtitle="From Healy Hall to policy institutes, we match Hoya faculty standards."
            departments={guDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for Georgetown's Global Policy Bar"
            subtitle="With a top-290 QS global rank, Georgetown expects precise, current, and well-argued academic work."
            cards={guProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Hoyas"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={guServiceCards}
          />
          <Testimonials
            eyebrow="Hoyas succeeding"
            title="What Georgetown Students Tell Us"
            subtitle="Feedback from Hoyas balancing Walsh policy briefs, McDonough cases, and seminar research."
            items={guSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for Georgetown coursework."
            items={guSampleFaq}
            support={guSampleFaqSupport}
          />
          <BottomCta data={guSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
