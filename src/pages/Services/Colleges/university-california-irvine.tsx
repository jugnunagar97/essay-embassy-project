      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          >
            ...
            Keep up with the Anteater Quarter Pace
          </span>
...
// ==========================================
// TAILORED DATA (UNIVERSITY OF CALIFORNIA, IRVINE)
// ==========================================

export const uciCollegeData: CollegeData = {
  breadcrumb: {
    rootHref: "/",
  ...
  description:
    "UC Irvine is a University of California campus in Irvine on the quarter system—Paul Merage School of Business, Henry Samueli School of Engineering, and social sciences with fast 10-week deadlines.",
  cta: {
    primary: { href: "/order-now", label: "Get help for UCI coursework" },
  ...
  trustChips: [
    ...
    { icon: "star", label: "Merage & Samueli Alumni Writers" },
    { icon: "lock", label: "Fully Confidential" },
  ],
};

export const uciStats: StatCard[] = [
  {
    icon: "award",
  ...
  },
  {
    ...
    value: "=294",
    caption: "QS 2026 UC rank; computing and social sciences strength",
  },
  {
    icon: "users",
    label: "Specialized writers",
    value: "150+",
    caption: "Experts familiar with Merage, Samueli Engineering, and Social Sciences expectations",
  },
  {
    icon: "dollar",
...
export const uciAlert: AlertBanner = {
  title: "Irvine Quarter Pace Alert:",
  body: "UCI's quarter system compresses Merage cases, Samueli labs, and social science essays into fast 10-week arcs. Weeks 4 and 8 are peak demand—book writers before Canvas queues spike.",
};

export const uciCalendarPeriods: CalendarPeriod[] = [
  {
    accent: "red",
    range: "OCT WEEK 6-8",
    title: "Fall Midterms",
    body: "Core curriculum papers, School of Social Sciences assignments, and Henry Samueli School of Engineering lab milestones converge before Halloween.",
  ...
  },
  {
    ...
    title: "Fall Finals",
    body: "Cumulative exams, research papers, and final projects stack in early December across the Irvine campus.",
  ...
  },
  {
    ...
    body: "Spring pressure peaks with seminar essays, STEM problem sets, and Paul Merage School of Business group evaluations.",
  },
  {
    accent: "rose",
    range: "MAY WEEK 14-15",
    title: "Finals & Capstones",
    body: "Henry Samueli School of Engineering capstones, Paul Merage School of Business presentations, and comprehensive theses are due. Writer demand peaks.",
    tag: { tone: "rose", label: "Thesis Rush" },
  },
];

export const uciDepartments: Department[] = [
  {
    icon: "chart",
    name: "Paul Merage School of Business",
    courses: ["MGMT 30A", "ECON 20A", "IN4MATX 43", "MKT 7"],
  },
  {
    icon: "brain",
    name: "Henry Samueli School of Engineering",
    courses: ["ENGRMAE 10", "EECS 12", "BME 50A", "MAE 52"],
  },
  {
    icon: "users",
    name: "School of Social Sciences",
    courses: ["PSYCH 7A", "ECON 20B", "POL SCI 21A", "SOC SCI 3"],
  },
  {
    icon: "book",
    name: "School of Humanities",
    courses: ["HUMAN 1A", "HISTORY 20A", "PHILOS 1", "WRITING 39B"],
  }
];

export const uciProfessorCards: ProfessorIntel[] = [
  {
    icon: "chart",
    title: "Merage Cases & Analytics",
    subtitle: "Quarter-ready business writing",
    bullets: [
      "Case memos with financial logic and actionable recommendations.",
      "Marketing analytics aligned to Merage rubrics.",
      "Concise deliverables for 10-week turnarounds.",
    ],
    footnote: "Merage cases must be tight and quantified—quarters leave little room to revise.",
  },
  {
    icon: "brain",
    title: "Samueli & EECS",
    ...
    bullets: [
      "MAE and EECS lab reports with reproducible methods.",
      "ICS-style documentation explaining design and testing.",
      "Appropriate technical tone for UC engineering faculty.",
    ],
    footnote: "Samueli faculty expect clear technical communication—we match UC STEM standards.",
  },
  {
    icon: "users",
    title: "Social Sciences & Writing 39B",
    subtitle: "Argument-driven UC writing",
    bullets: [
      "POL SCI and ECON papers with thesis-led arguments.",
      "Writing 39B essays with revision-ready structure.",
      "APA or Chicago citations per course requirements.",
    ],
    footnote: "Social sciences at UCI grade evidence quality—we cite credible, current sources.",
  }
];

export const uciServiceCards: ServiceCard[] = [
  {
    id: "essay",
    icon: "doc",
...
export const uciSampleTestimonials: CollegeTestimonial[] = [
  {
    id: "UCI-204",
    name: "Kevin L.",
    ...
    semester: "Fall 2024",
    quote: "Merage case during week 4 crunch. Memo was quantitative and Canvas-ready with minimal edits.",
  },
  {
    id: "UCI-517",
    name: "Anika P.",
    ...
    quote: "Quarter moved too fast after project week. Documentation explained architecture clearly for the TA.",
  },
  {
    id: "UCI-339",
    name: "James H.",
    ...
    semester: "Fall 2024",
    quote: "Needed a sharper thesis on institutions. Draft gave me a structure I refined quickly before the deadline.",
  }
];

export const uciSampleFaq: FaqItem[] = [
  {
    question: "Do you understand UCI's 10-week quarter system?",
    answer: "Yes. We prioritize fast, high-quality turnarounds aligned to quarter midterms and finals.",
  },
  {
    question: "Can you help Merage and ICS combined workloads?",
    answer: "We assign business and computing specialists based on your course codes and rubrics.",
  },
  {
    question: "Is work original for UCI academic integrity?",
    answer: "Every paper is written from scratch from your prompt—no AI or essay banks.",
  },
  {
    question: "Do you support Writing 39B and humanities cores?",
    answer: "Yes. We help structure arguments and citations while preserving your voice.",
  }
];

export const uciSampleFaqSupport: FaqSupportCard = {
  heading: "Stuck in the Irvine Quarter Crunch?",
  name: "Marcus",
...
export const uciSampleBottomCta: BottomCtaData = {
  title: "Do not Let the UCI Quarter Overwhelm You",
  subtitle: "Anteaters trust Essay Embassy when quarter deadlines and group projects overlap. Protect your GPA through peak weeks.",
...
export default function UniversityCaliforniaIrvine() {
  return (
    <>
      <title>UC Irvine Essay Help | University of California Irvine Assignment Writing</title>
      <meta
        name="description"
        content="Expert academic writing for UC Irvine students. Support for Merage business cases, Samueli engineering labs, and social sciences research."
      />
      <link
        rel="canonical"
        href="https://essayembassy.com/colleges/university-california-irvine/"
      />
      ...
      <motion.div className="college-page min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-20 sm:pb-28">
          <Hero data={uciCollegeData} />
          <Stats stats={uciStats} />
          <Alert data={uciAlert} />
          <CalendarSection
            eyebrow="UC Irvine academic pulse"
            title="When the Semester Pressure Builds"
            subtitle="Navigate Anteater quarter peaks across Merage, engineering, and social sciences."
            periods={uciCalendarPeriods}
          />
          <Curriculum
            eyebrow="School-Specific Knowledge"
            title="Covering UCI's Core Schools"
            subtitle="From Aldrich Park to engineering plazas, we match UC-level faculty expectations."
            departments={uciDepartments}
          />
          <ProfessorIntelligence
            eyebrow="Faculty & TA expectations"
            title="Built for UC Irvine Standards"
            subtitle="With a top-300 QS global rank, Irvine expects rigorous, well-cited academic work on tight quarter timelines."
            cards={uciProfessorCards}
          />
          <Services
            eyebrow="Expert academic solutions"
            title="Custom Support Built for Anteaters"
            subtitle="Whatever your program demands, drop your prompt, set your deadline, and lock in your grade."
            cards={uciServiceCards}
          />
          <Testimonials
            eyebrow="Anteaters succeeding"
            title="What UCI Students Tell Us"
            subtitle="Feedback from Anteaters balancing Merage cases, Samueli projects, and social science research."
            items={uciSampleTestimonials}
          />
          <Faq
            eyebrow="Common questions"
            title="Trust & Safety Protocols"
            subtitle="Everything you need to know before placing your first order for UCI coursework."
            items={uciSampleFaq}
            support={uciSampleFaqSupport}
          />
          <BottomCta data={uciSampleBottomCta} />
        </div>
      </motion.div>
    </>
  );
