          ...
          <div className="md:col-span-1 flex flex-col justify-between">
            <div>
              ...
              <p className="text-base md:text-lg text-gray-400 leading-relaxed mt-2 mb-10 max-w-md" style={{fontFamily: 'Inter, sans-serif', letterSpacing: '0.01em'}}>
                Essay Embassy gives you a chance to cooperate with <span className="text-primary-500 font-medium">top humanities scholars</span> in different fields. Get your humanities assignments guided by a professional and be sure everything will be done on time.
              </p>
            </div>
  ...
  const testimonials = [
    {
      id: 'EE-24467',
      rating: 5,
      text: "My history research essay was perfectly done! The analysis was thorough and the historical context was well-researched. Really impressed with the quality.",
      date: '04/14/2025',
      level: 'Masters',
    },
    {
      id: 'EE-23901',
      rating: 5,
      text: 'Was struggling with my literature analysis paper. The expert provided excellent insights and helped me understand complex literary theories.',
      date: '03/16/2025',
      level: 'Bachelors',
    },
    {
      id: 'EE-57281',
      rating: 4,
      text: 'Needed help with my philosophy assignment and they delivered exactly what I needed. Great arguments, clear writing, and on-time delivery.',
      date: '06/16/2025',
      level: 'Bachelors',
    },
    {
      id: 'EE-19822',
      rating: 5,
      text: 'The humanities expert was very knowledgeable about cultural studies and art history. My assignment scored an A+!',
      date: '02/10/2025',
      level: 'PhD',
    },
    {
      id: 'EE-33412',
      rating: 5,
      text: 'Essay Embassy helped me with my religious studies assignment. The quality was outstanding and very professional.',
      date: '01/22/2025',
      level: 'Masters',
    },
    {
      id: 'EE-11234',
      rating: 4,
      text: 'Excellent help with my art history assignment. Clear explanations and well-structured content. Highly recommend!',
      date: '05/05/2025',
      level: 'College',
    },
  ];
...
export default function HumanitiesAssignmentHelp() {
  ...
  return (
    <>
      <Helmet>
        <title>Humanities Assignment Help | Expert Tutors</title>
        <meta
          name="description"
          content="Professional humanities assignment help. Expert tutors in history, philosophy, literature, and arts. Get help now."
        />
        <link rel="canonical" href="https://essayembassy.com/services/assignment-help/humanities" />
      </Helmet>
        ...
        <main className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600">
              Get expert help with your humanities assignments from qualified professionals. Our experienced humanities scholars deliver high-quality solutions across all humanities topics.
            </p>
            {/* Ratings */}
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Whenever you ask us for humanities assignment help and hire a professional writer, your paper will contain zero AI content.</div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">We're ready to prove that our papers are written from scratch with free reports for all "humanities assignment help" requests.</div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
            ...
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Our humanities assignment experts leverage their experience to deliver well-researched and carefully put-together papers with deadlines starting from three hours.</div>
            </div>
            {/* Card 6 */}
            <div className="flex flex-col items-center text-center bg-white/30 backdrop-blur-2xl shadow-2xl shadow-primary/10 rounded-3xl px-7 py-12 border border-white/40 transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/20">
              <span className="flex items-center justify-center w-16 h-16 rounded-full bg-primary-50 mb-6 ring-2 ring-primary/20 shadow-sm">
              ...
              <div className="text-gray-500 text-base leading-relaxed font-normal">Prices for our humanities assignment help services start at $10.80/page. You get all the essentials and even enjoy some freebies.</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              {
                title: "Philosophical Argument Analysis",
                pages: 10,
                level: "PhD",
      ...
      <section className="w-full bg-[#F7FAFC] py-12">
        <div className="max-w-md mx-auto px-4 relative flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col items-center relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-900">Your Humanities Assignment Help journey</h2>
            ...
            <div className="flex flex-col items-center text-center mb-3 animate-fade-in-up">
              ...
              <div className="text-gray-400 text-sm mb-2">Fill out our order form to be matched with the best humanities experts</div>
            ...
            <div className="flex flex-col items-center text-center animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <span className="text-2xl mb-1">📄</span>
              <div className="font-medium text-base md:text-lg text-gray-900 mb-0.5">3. Get your humanities assignment</div>
            ...
            <div className="flex-1 w-full">
              ...
              <div className="bg-white/80 rounded-3xl shadow-lg p-4 md:p-8">
                <div className="space-y-2">
                  {[
                    {
                      question: 'Is your humanities assignment help service confidential and safe?',
                    ...
                    {
                      question: 'Will my humanities assignment be handled by a real expert?',
                      answer: 'Yes! Every humanities assignment is handled by a qualified expert who has passed our rigorous selection and verification process to ensure top quality.'
                    },
                    {
                      question: 'How quickly can I receive help with my humanities assignment?',
                      answer: 'We offer deadlines starting from 3 hours. Choose your preferred deadline in the order form, and we\'ll ensure timely delivery by a humanities expert.'
                    },
                    {
                      question: 'What if I am not satisfied with the humanities assignment help?',
                    ...
                    {
                      question: 'How do I place an order for humanities assignment help?',
      ...
      <section className="w-full py-12 rounded-2xl border-t border-gray-100 shadow-sm" style={{background: '#F7FAFC'}}>
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-12 items-center md:items-start">
          ...
          <div className="flex-1 min-w-[320px] flex flex-col justify-center items-start mb-10 md:mb-0">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 leading-tight" style={{fontFamily: 'Inter, sans-serif'}}>Your #1 humanities assignment writing service</h2>
            <p className="text-lg text-gray-600 mb-8 max-w-md">Our expert humanities writers can tackle any academic task you entrust them with. Here are some of the services we offer.</p>
            <Link
              to="/writers"
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-5xl mx-auto py-14">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="text-gray-700 text-base md:text-lg mb-6 list-disc list-inside">
              <li className="flex items-center gap-3 mb-2"><span className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="16" height="16" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#6ee7b7"/><path d="M8 12.5l2.5 2.5L16 9.5" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span>20,000+ humanities assignments delivered with a 98% success rate</li>
              <li className="flex items-center gap-3 mb-2"><span className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center"><svg width="16" height="16" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#6ee7b7"/><path d="M8 12.5l2.5 2.5L16 9.5" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></span>Get original humanities papers written according to your instructions</li>
